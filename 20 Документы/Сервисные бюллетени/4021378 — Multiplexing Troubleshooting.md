...
> **Семейство:** 15N, A8.5, K38/K50 · QSK38, QSK50, QSK60, QSB6.7, QSK19, QSK23, QSK50, QSK60, QSM11, QSX15, QSZ13
...
2. Неисправности, показывающие параметры, которые в настоящее время установлены неправильно. Параметры, которые в настоящее время показаны как «Активные», имеют неправильную информацию об адресе источника или были неправильно установлены для включения или отключения.
