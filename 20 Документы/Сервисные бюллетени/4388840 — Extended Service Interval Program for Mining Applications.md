---
aliases:
  - "Программа увеличенных интервалов обслуживания для карьерной техники"
type: "Сервисный бюллетень"
doc: "4388840"
title_en: "Extended Service Interval Program for Mining Applications"
title_ru: "Программа увеличенных интервалов обслуживания для карьерной техники"
released: "2015-11-12"
modified: "2026-06-18"
...
# Extended Service Interval Program for Mining Applications
**Программа увеличенных интервалов обслуживания для карьерной техники**
...
- K50 (все версии)
- QSK23 CM500
- QSK23 CM2350 K127 MCRS
- QSK38 CM850 MCRS
- QSK38 CM2150 MCRS
- QSK38 CM2350 K125
- QSK45 CM500
- QSK50 CM2150 MCRS
- QSK50 CM2350 K108 MCRS
- QSK50 CM2350 K130 MCRS
- QSK50 CM850 MCRS
- QSK60 CM2150 MCRS
- QSK60 CM2350 K116 MCRS
- QSK60 CM2350 K121 MCRS
- QSK60 CM2350 K135 MCRS
- QSK60 CM2350 K136 MCRS
- QSK60 CM500
- QSK60 CM850 MCRS
- QSK78 CM2350 K126 MCRS
- QSK78 CM2350 K137 MCRS
- QSK78 CM2350 K154C MCRS
- QSK78 CM500
- QST30 CM2350 T101 MCRS

Пострадают следующие грузовики с минной погрузкой:

- Komatsu® 730E/830E/860E/930E/930-4SE/960E/980E/HD1500
- Hitachi® EH1100/EH1700/EH3500/EH4000/EH5000
- БелАЗ® 75131/75139/75180/75305/75306/75307/75310/75603

Поражаются следующие экскаваторы и лопаты:

- Hyundai R1200
- Komatsu® PC3000 / PC4000 / PC5500 / PC7000 / PC8000
- Hitachi® EX1200 / EX1900 / EX2500 / EX2600 / EX3600 / EX5500 / EX5600 / EX8000
...
Цель этого документа состоит в том, чтобы изложить шаги, необходимые для увеличения интервала обслуживания для внедорожных приложений для майнинга.
...
- Фильтры охлаждения
- Топливные фильтры
- Фильтры для вентиляционных отверстий топливных баков
...
- См. Service Bulletin, Oil Analysis Techniques for High Horsepower Diesel Engines, Bulletin.[[4022060 — Oil Analysis Techniques for High Horsepower Diesel Engines|4022060]].
- См. Service Bulletin, Statistical Analysis of Oil Sample Lead Readings on High Horsepower Engines, Bulletin.[[2883452 — Statistical Analysis of Oil Sample Lead Readings on High Horsepower Engines|2883452]].
...
|---|---|---|---|
| Жидкость | Интервал выборки | Предлагаемый метод и место | Цель и измерительный пакет |
| Моторное масло | 250 часов | Бюллетень за службу[[4022060 — Oil Analysis Techniques for High Horsepower Diesel Engines\|4022060]]: Собирайте образец масла из порта под давлением во время холостого хода двигателя или вакуумным насосом через измерительную трубку для измерения уровня масла в смазке. | Тест 1 на качество масла и загрязняющих веществ: Элементные металлы по индуктивно связанной плазме (ICP) Вязкость при 100°C \[212°F \] Процент воды Разбавление топлива Процент окисления сажи / Нитрата Общее базовое число (TBN) |
| охлаждающий | 4000 часов | Путем вакуумного насоса через крышку для заполнения радиатора или через порт быстрого заполнения / слива | Тест 2 на предельные значения замены охлаждающих жидкостей: Сульфат хлорид, фторид, бромид pH Масло и топливные загрязнители Смазка, цветение припоя, силикагель, ржавчина или чешуя |
| охлаждающий | каждые 6 месяцев | Путем вакуумного насоса через крышку для заполнения радиатора или через порт быстрого заполнения / слива | Тест на уровень гликола: Измерительный комплект для охлаждения, бортовой номер CC8997 |
| топливо | Как и требовалось: Образец топлива из оборудования для качества и чистоты, если топливные фильтры не достигают требуемого срока службы или срок службы топливного фильтра уменьшается от установленного базового уровня. | Используйте пробоотборный порт выше по течению от топливных фильтров 1-й ступени и внизу топливного бака оборудования через порт на топливном баке оборудования. | Ссылка на бюллетень по подключению топливного фильтра,[[5504538 — Fuel Filter Plugging\|5504538]]. |
| При использовании Cummins® Fleetguard® Monitor: 1 Справочный монитор CC36136, 2 Справочный монитор CC2700. |  |  |  |
...
| Насыпное хранение – моторное масло | Минимальный квартальный и при изменении марки или спецификации моторного масла | При помощи клапана отбора проб, установленного в цистерне для массовых грузов | Тест 1 на качество масла и загрязняющих веществ: Элементные металлы по индуктивно связанной плазме (ICP) вязкость при 100°C \[212°F \] Процент воды Растворительная сажа Процент окисления / Нитрата Общее базовое число (TBN) |
| Хранение навалом - охладитель | Минимальный ежеквартальный и при изменении на марку или спецификацию охлаждающей жидкости | При помощи клапана отбора проб, установленного в цистерне для массовых грузов | Тест 2 на качество и загрязняющие вещества: Визуальные эффекты (пена, цвет, масло, топливо, магнитные и немагнитные осадки и запах) 12 металлов по индуктивно соединенной плазме (ICP) Процент антифриза Замораживание Точка кипения Точка кипения Точка твердости SCA Количество нитритов Общее количество растворенных твердых веществ Специфическая проводимость |
| Навал, резервуарное и полевое оборудование - топливо | Ежемесячные или более частые, если топливные фильтры оборудования не достигают требуемого срока службы или срок службы фильтра уменьшается с установленного базового уровня. | Путем отбора проб клапана, установленного в резервуаре для массовых грузов, со счетчиком частиц на месте и бутылками для проб. На дне оборудования топливный бак через порт на оборудовании топливный бак с пробными бутылками | Тест 3 на качество топлива и загрязняющие вещества: 24 Металлы по индуктивно связанной плазменной вязкости при 40oC \[104°F \] Процентная дистилляция серы API Gravity Distillation Flash Point Cloud Point Pour Point Water and Sediment Bacteria, Fungi and Mold Calculated Cetane Index Thermal Stability Water by Karl Fischer titration method |
| Тест 4 для подсчета частиц топлива ISO и загрязняющих веществ: PPM ISO граф частиц |  |  |  |
| Тест на фильтрацию: Набор анализа чистоты переносного топлива Cummins Fleetguard, номер детали FK36000 или ASTM D2068 - Процедура А. |  |  |  |
| При использовании Cummins® Fleetguard® MonitorTM: 1 Справочный монитор CC36136, 2 Справочный монитор CC2700, 3 Справочный монитор CC2651, 4 Справочный монитор CC2719 |  |  |  |
...
> [!note] Примечание
> Любые отклонения от спецификаций на жидкость и фильтр, как определено в этом бюллетене, аннулируют использование этого бюллетеня расширенного обслуживания. Жидкость и фильтры, не соответствующие требованиям, перечисленным в настоящем документе, должны соответствовать стандартным интервалам технического обслуживания, определенным в соответствующем Руководстве по эксплуатации и техническому обслуживанию.
...
- Моторное масло: Фильтры смазки VenturiTM Combo и фильтрация моторного масла SpiratecTM

- Фильтрация воздуха: Нанофорс® фильтрация воздуха
...
> [!note] Примечание
> Ссылка на инструкцию по установке, включенную в коробку с удаленной центрифугой.

Для двигателей с EliminatorTM замените ротор EliminatorTM на цельный центробежный фильтр для моторного масла с технологией SpiraTecTM, как показано в таблице 5. Справочный технический бюллетень 160036.
...
Для двигателей с топливной системой модульной общей железнодорожной системы (MCRS) модернизируйте фильтрацию стадии 1 до топливных фильтров IndustrialPro. Справочные инструкции по установке, включенные в коробку с фильтрами.
...
| K50 (Все версии) QSK50 (Все версии) QSK60 (Все версии) | Этап 1 | Industrial Pro Unit, Dual Tall, Bracket, WIF, Clear Bowl с 5-микронным фильтром Nanonet. Вправо / Out Right | 1 | 4381962 | FH23907 | 2 | [[4328043]] | FS53014 |
...
| QSK78 (все версии) | Этап 1 | Industrial Pro Unit, Triple Tall, Bracket, WIF, Clear Bowl с 5-микронным фильтром Nanonet. Влево / вправо | 1 | 5374777 | FH23930 | 3 | [[4328043]] | FS53014 |
| QSK38 CM850 CM2150 CM2350 1 1 | Этап 2 | На головке фильтра конфигурации двигателя с 3 2-ми микронами NanoNet® | 1 | 4380732 | Неприменимые | 2 | 5375819 | FF63042NN |
| QSK50 CM850 CM2150 CM2350 1 1 | Этап 2 | На головке фильтра конфигурации двигателя с 3 2-ми микронами NanoNet® | 1 | 4380732 | Неприменимые | 2 | 5375819 | FF63042NN |
| QSK50 CM850 CM2150 CM2350 | Этап 2 | Дистанционная конфигурация 2 головка фильтра с 3-микронным фильтром NanoNet® | 1 | 4380859 | Неприменимые | 3 | 5375819 | FF63042NN |
| QSK60 CM850 CM2150 CM2350 1 1 | Этап 2 | На двигателе или удаленной конфигурационной головке фильтра с 3-микронным фильтром NanoNet® | 1 | 4380859 | Неприменимые | 3 | 5375819 | FF63042NN |
...
Для двигателей с модульной общей системой рельсового топлива (MCRS) (кроме CM2350) модернизация этапа 1 фильтрации до топливных фильтров IndustrialPro. Справочные инструкции по установке, включенные в коробку с фильтрами.

| Таблица 7, Ассоциированное оборудование |  |
|---|---|
...
Для всех двигателей заменить существующие первичные воздушные фильтры на модернизированные воздушные фильтры. См. таблицу 11 ниже для номеров частей.

Для двигателей без установленных индикаторов ограничения фильтра очистителя воздуха устанавливают индикаторы ограничения фильтра очистителя воздуха. Для получения информации об установке индикаторов ограничения фильтра воздухоочистителя обратитесь к производителю оборудования.
...
| вторичный | AF857 | Не меняет номер детали |  |
| Осевая печать | первичный | AF899 или AF899M | AF899NF |
| вторичный | AF880 | Не меняет номер детали |  |
| Радиальная печать | первичный | AF27696 | AF27993NF + SP1307 Обслуживание* |
| вторичный | AF27695 | AF27994 |  |
| Радиальная печать | первичный | AF27698 | AF25149NF + SP1307 Обслуживание* |
...
- Чистые воздушные оболочки. См. сервисную документацию изготовителя оборудования.
...
- Чистый воздухоочиститель фильтрует кожухи. См. сервисную документацию изготовителя оборудования.
- Тест на уровень гликоля с комплектом для испытаний охлаждающей жидкости, номер детали CC8997.
...
|---|---|
| Система | Указание на замену |
| Фильтры для топлива, этап 1 | Заменить на основании графика в таблицах 12 и 13 или с использованием визуальной индикации на устройствах Industrial ProTM или по указаниям FleetguardFITTM. |
| Фильтры для топлива, этап 2 | Заменить на основании расписания в таблицах 12 и 13 или по указанию FleetguardFITTM. |
| Топливный бак, вентилятор / дыхательные фильтры | Заменить на основе графика в таблицах 12 и 13. |
| Фильтры для моторного масла | Заменить на основании расписания в таблицах 12 и 13 или по указанию FleetguardFITTM. |
| Моторное масло, ЭлиминаторTM/удаленный ротор центрифуги | Заменить на основании графика в Таблицах 12 и 13 или одновременно с заменой моторного масла и фильтров для моторного масла. |
| Фильтры для охлаждения / воды | Заменить на основе графика в таблицах 12 и 13. |
| фильтр для очистки воздуха, первичный | Заменить на основании графика в таблицах 12 и 13 или когда дифференциал достигает 635 мм/ч 2 o \[25 in-h 2 o \] на индикаторе ограничения, в зависимости от того, что происходит первым или когда указано FleetguardFITTM. |
| фильтр для очистки воздуха, вторичный | Замените каждый третий первичный фильтр очистки воздуха. |

Флитгард Фитт

Технология фильтрации — это система мониторинга фильтрации в режиме реального времени, которая обеспечивает полную видимость фильтрации (топливо, люб и воздух) и жизни масла, что позволяет проактивно обнаруживать проблемы с помощью интеллектуального зондирования и расширенной аналитики данных. Чтобы узнать больше о FleetguardFIT и о том, как его включить в свой двигатель, свяжитесь с Cummins Filtration по адресу info@fleetguardfit.com.
...
**не** Продлевайте интервалы изменения фильтров моторного масла и моторного масла за пределы, указанные в графике технического обслуживания, если не выполнены все условия, требуемые настоящим бюллетенем:
...
Линейный пример тренда на рисунке 1 ниже:
...
2. Параметры анализа моторного масла находятся в пределах, определенных в таблице 16 ниже.

| Таблица 16, Пределы параметров анализа нефти |  |
|---|---|
...
| Для XW-30: |  |
| Мин: 9.3 MAX: 12.5 |  |
| Окисление abs/cm – прямой тренд | 15 1 |
| Нитратация abs/cm – прямой тренд | 25 |
| 1 Увеличение по сравнению с новым (неиспользованный образец масла) |  |

3. Повторите план образца для 3 различных интервалов слива моторного масла на каждом из 3 двигателей в одном сегменте.

4. Окончательный слив моторного масла будет представлять собой часы, в течение которых любой из образцов не соответствовал критериям испытаний на целостность моторного масла, сниженным на 20%.

1. 20% маржа добавляется к утвержденному интервалу слива моторного масла, чтобы учесть изменения скорости деградации моторного масла по мере старения двигателя.

| Таблица 17, Пример Плана отбора проб моторного масла для грузовых автомобилей на автомагистралях |  |  |
|---|---|---|
...
| 4 | 600 | Проверить целостность моторного масла с помощью вышеуказанных шагов. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 5 | 700 | Проверить целостность моторного масла с помощью вышеуказанных шагов. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 6 | 800 | Проверить целостность моторного масла с помощью вышеуказанных шагов. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 7 | 900 | Проверить целостность моторного масла с помощью вышеуказанных шагов. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 8 | 1000 | Проверить целостность моторного масла с помощью вышеуказанных шагов. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 9 | 1050 | Проверить целостность моторного масла с помощью вышеуказанных шагов. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 10 | 1100 | Проверить целостность моторного масла с помощью вышеуказанных шагов. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 11 | 1150 | Проверить целостность моторного масла с помощью вышеуказанных шагов. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 12 | 1200 | Конец теста. Соберите образец перед сливом моторного масла. |

| Таблица 18, Пример плана отбора проб моторного масла для экскаваторов и лопаток |  |  |
|---|---|---|
| Номер выборки | Часы моторного масла | Наименование |
| 0 | Базовая линия | Образец неиспользованного моторного масла из контейнера |
| 1 | 0 | Собрать образец после заполнения отстойника новым моторным маслом и дать двигателю простаивать в течение 5 минут |
| 2 | 200 | Проверить целостность моторного масла с помощью шагов выше. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 3 | 300 | Проверить целостность моторного масла с помощью шагов выше. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 4 | 400 | Проверить целостность моторного масла с помощью шагов выше. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
| 5 | 500 | Проверить целостность моторного масла с помощью шагов выше. Прекратить тестирование и изменить моторное масло, если требования не выполнены. |
...
- См. QSK60 CM2350 K135 (MCRS) Operation and Maintenance Manual, Bulletin 5504625.
- См. QSK60 CM2350 K136 (MCRS) Operation and Maintenance Manual, Bulletin 5504630.
- См. QSK78 CM2350 K126 (MCRS) Operation and Maintenance Manual, Bulletin 5504265.
- См. QSK78 CM2350 K137 (MCRS) Operation and Maintenance Manual, Bulletin 5504635.
- См. QSK78 CM2350 K154C (MCRS) Operation and Maintenance Manual, Bulletin 5676943.
- См. QST30 CM2350 T101 (MCRS) Operation and Maintenance Manual, Bulletin 5467180.
- См. QSK23 CM2350 K127 (MCRS) Operation and Maintenance Manual, Bulletin 5504159.
- См. QSK50 CM2350 K130 (MCRS) Operation and Maintenance Manual, Bulletin 5504179.
...
- См. QSK60 CM2350 K135 Service Manual, Bulletin 5504626.
- См. QSK60 CM2350 K136 Service Manual, Bulletin 5504631.
- См. QSK78 CM2350 K126 Service Manual, Bulletin 5504266.
- См. QSK78 CM2350 K137 Service Manual, Bulletin 5504636.
- См. QSK78 CM2350 K154C Service Manual, Bulletin 5676944.
- См. QST30 CM2350 T101 Service Manual, Bulletin 5467179.
- См. QSK23 CM2350 K127 Service Manual, Bulletin 5504160.
- См. QSK50 CM2350 K130 Service Manual, Bulletin, Bulletin 5504180.

Литература **not** найдена на сайте QuickServe® Online:

Бюллетень службы Hard Copy:
...
> - QST30 CM2350 T101 MCRS
>
> The following mine haul trucks are affected:
>
> - Komatsu® 730E / 830E / 860E/ 930E / 930-4SE / 960E / 980E / HD1500
> - Hitachi® EH1100 /EH1700 / EH3500 / EH4000 / EH5000
> - BelAZ® 75131 / 75139 / 75180 / 75305 / 75306 / 75307 / 75310 / 75603
>
> The following excavators and shovels are affected:
>
> - Hyundai™ R1200
> - Komatsu® PC3000 / PC4000 / PC5500 / PC7000 / PC8000
> - Hitachi® EX1200 / EX1900 / EX2500 / EX2600 / EX3600 / EX5500 / EX5600 / EX8000
...
> **Content Overview**
>
> The purpose of this document is to lay out the steps required to extend the service interval for off-highway mining applications.
>
...
>
> **Extended Service Interval for Off-highway Mining Applications Program RequirementsSection 1: Site Assessment**
>
...
> - Lubricating oil used **must** be registered in Cummins Oil Registration List. **Note:** [https://quickserve.cummins.com/qs3/qsol/service/serviceproducts/oil\_registration.html](https://quickserve.cummins.com/qs3/qsol/service/serviceproducts/oil_registration.html)
...
> - If sulfur content in fuel is higher than 15 parts per million (ppm), oil drain intervals oil drain intervals **must** be verified using the procedure in Section 6.
...
> - If biofuel is used:
> - If sulfur content in fuel is higher than 15 ppm, lubricating oil drain intervals oil drain intervals **must** be verified using the procedure in Section 6.
> - If sulfur content in fuel is higher than 500 ppm, extended drain intervals will **not** be supported.
>
...
> **Section 3: Fluid and Filter Monitoring**
>
> This section provides the guidelines and requirements to collect, monitor, flag, act, and analyze engine fluids and filters that provide information to guide the Extended Service Interval for Off-highway Mining Applications Program.
>
> Lubricating Oil Sampling and Analysis:
>
> - See Service Bulletin, Oil Analysis Techniques for High Horsepower Diesel Engines, Bulletin [[4022060 — Oil Analysis Techniques for High Horsepower Diesel Engines|4022060]].
> - See Service Bulletin, Statistical Analysis of Oil Sample Lead Readings on High Horsepower Engines, Bulletin [[2883452 — Statistical Analysis of Oil Sample Lead Readings on High Horsepower Engines|2883452]].
>
...
> - If freeze point is **not** within specification when measuring with 4-way additive/freeze point strips, Fleetguard® Part Number CC8997, verify the results with a refractometer. If freeze point is confirmed to be out of specification, replace coolant. See the corresponding Service Manual. Reference procedure 008-018 Cooling System.
>
...
> | Lubricating Oil | 250 hours | Per Service Bulletin [[4022060 — Oil Analysis Techniques for High Horsepower Diesel Engines\|4022060]]: Collect oil sample from pressurized port while engine idling or by vacuum pump through lubricating oil dipstick retaining tube. | Test 1 for Oil Quality and Contaminants: Elemental Metals by Inductively Coupled Plasma (ICP) Viscosity at 100°C \[ 212°F \] Water Percentage Fuel Dilution Soot Percentage Oxidation / Nitration Total Base Number (TBN) |
> | Coolant | 4000 hours | By vacuum pump through radiator fill cap or through quick fill / drain port | Test 2 for Coolant Replacement Limits: Sulfate Chloride, Fluoride, Bromide pH Oil and fuel contaminants Grease, solder bloom, silica gel, rust or scale |
> | Coolant | Every 6 months | By vacuum pump through radiator fill cap or through quick fill / drain port | Test for Glycol Levels: Coolant Test Kit, Fleetguard Part Number CC8997 |
> | Fuel | As Needed: Sample fuel from equipment for quality and cleanliness if fuel filters do not reach required life or fuel filter life decreases from established baseline. | Use sampling port upstream of Stage 1 fuel filters and at bottom of equipment fuel tank through port on equipment fuel tank. | Reference the Fuel Filter Plugging Bulletin, [[5504538 — Fuel Filter Plugging\|5504538]]. |
> | If using Cummins® Fleetguard® Monitor: 1 Reference Monitor™ CC36136, 2 Reference Monitor™ CC2700. |  |  |  |
>
...
> | Bulk Storage – Lubricating Oil | Minimum of quarterly and if change to lubricating oil brand or specification | By sampling valve installed in bulk tank | Test 1 for Oil Quality and Contaminants: Elemental Metals by Inductively Coupled Plasma (ICP) Viscosity at 100°C \[ 212°F \] Water Percent Fuel Dilution Soot Percent Oxidation / Nitration Total Base Number (TBN) |
> | Bulk Storage – Coolant | Minimum of quarterly and if change to coolant brand or specification | By sampling valve installed in bulk tank | Test 2 for Coolant Quality and Contaminants: Visuals (foam, color, oil, fuel, magnetic and non-magnetic precipitate and odor) 12 Metals by Inductively Coupled Plasma (ICP) Percent Antifreeze Freeze Point Boil Point pH Hardness SCA Number Nitrites Total Dissolved Solids Specific Conductance |
> | Bulk, Tank Storage and Field Service Equipment - Fuel | Monthly or more frequently if fuel filters of equipment do not reach required life or filter life decreases from established baseline | By sampling valve installed in bulk tank, with particle counter in place and sample bottles. At bottom of equipment fuel tank through port on equipment fuel tank with sample bottles | Test 3 for Fuel Quality and Contaminants: 24 Metals by Inductively Coupled Plasma (ICP) Viscosity at 40ºC \[ 104°F \] Percent Sulfur API Gravity Distillation Flash Point Cloud Point Pour Point Water and Sediment Bacteria, Fungi and Mold Calculated Cetane Index Thermal Stability Water by Karl Fischer titration method |
> | Test 4 for Fuel ISO Particle Counts and Contaminants: PPM ISO Particle Count |  |  |  |
> | Test for Filter Plugging: Cummins Fleetguard Portable Fuel Cleanliness Analysis Kit, part number FK36000 or ASTM D2068 - Procedure A. |  |  |  |
> | If using Cummins® Fleetguard® Monitor™: 1 Reference Monitor™ CC36136, 2 Reference Monitor™ CC2700, 3 Reference Monitor™ CC2651, 4 Reference Monitor™ CC2719 |  |  |  |
>
...
>
> - Lubricating Oil: Venturi™ Combo lube filters and Spiratec™ centrifuge lubricating oil filtration
>
> - Air Filtration: Nanoforce® air filtration
>
> - Coolant: Stratapore™ extended service coolant filtration
>
> **Lubricating Oil Filters**
>
> For engines with spin-on lubricating oil filters, add remote centrifuge and use a one-piece centrifugal oil filter with SpiraTec™ as shown in Tables 3 and 4.
>
> **Note · Примечание**
> Reference the installation instructions included in the box with the remote centrifuge.
>
> For engines with Eliminator™, replace Eliminator™ rotor with one-piece centrifugal lubricating oil filter with SpiraTec™ technology as shown in Table 5. Reference Technical Service Bulletin 160036.
>
> - Perform the following checks:
>
> | Table 3, On-Engine Lubricating Oil Filter Part Numbers |  |  |  |  |  |  |
> |---|---|---|---|---|---|---|
...
> | QSK78 C2350 | On-Engine Spin-On Lubricating Oil Filter | 4349561 | LF17562 | Not Applicable | Not Applicable | Not Applicable |
>
> | Table 4, Remote Centrifuge Housing Part Numbers |  |  |  |
> |---|---|---|---|
> | Engine Model | Description | Cummins® Part Number | Fleetguard® Part Number |
> | QSK23 CM500 | Remote Centrifuge | Not Applicable | CH41111 |
> | K38 (All Versions) QSK38 (All Versions) K50 (All Versions) QSK50 (All Versions) QSK60 (All Versions) QSK78 (All Versions) | Remote Centrifuge – side drain | 5373170 | CH44120 |
> | Remote Centrifuge – bottom drain | 5373171 | CH44105 |  |
>
> | Table 5, Centrifugal Oil Filter Part Numbers for Eliminator™ or Remote Centrifuge |  |  |  |
> |---|---|---|---|
> | Engine Model | Description | Cummins® Part Number | Fleetguard® Part Number |
...
> **Fuel Filters**
>
> For engines with a High Pressure Injection (HPI)® fuel system, remove the on-engine fuel filter head and install off engine IndustriaPro fuel filters. Reference installation instructions included in the box with the fuel filters.
>
> For engines with a Modular Common Rail System (MCRS) fuel system, upgrade stage 1 filtration to IndustrialPro fuel filters. Reference installation instructions included in the box with the filters.
>
> | Table 6, Fuel Filter Head and Fuel Filter Element Part Numbers |  |  |  |  |  |  |  |  |
> |---|---|---|---|---|---|---|---|---|
...
> | QSK78 (All Versions | Stage 1 | Industrial Pro Unit, Triple Tall, Bracket, WIF, Clear Bowl with 5 Micron Nanonet filter. In Left / Out Right | 1 | 5374777 | FH23930 | 3 | [[4328043]] | FS53014 |
> | QSK38 CM850 CM2150 CM2350 1 | Stage 2 | On Engine Configuration Filter Head with 3 2 Micron NanoNet® filter | 1 | 4380732 | Not Applicable | 2 | 5375819 | FF63042NN |
> | QSK50 CM850 CM2150 CM2350 1 | Stage 2 | On Engine Configuration Filter Head with 3 2 Micron NanoNet® filter | 1 | 4380732 | Not Applicable | 2 | 5375819 | FF63042NN |
> | QSK50 CM850 CM2150 CM2350 | Stage 2 | Remote Mount Configuration 2 Filter Head with 3 Micron NanoNet® filter | 1 | 4380859 | Not Applicable | 3 | 5375819 | FF63042NN |
> | QSK60 CM850 CM2150 CM2350 1 | Stage 2 | On Engine OR Remote Mount Configuration Filter Head with 3 Micron NanoNet® filter | 1 | 4380859 | Not Applicable | 3 | 5375819 | FF63042NN |
> | QSK78 CM2350 1 | Stage 2 | On Engine OR Remote Mount Configuration Filter Head with 3 Micron NanoNet® filter | 1 | 4380859 | Not Applicable | 3 | 5375819 | FF63042NN |
> | 1 Fuel filter head upgrade is not required on QSK50, QSK60, and QSK78 CM2350 engines. 2 Excavators and shovels using QSK50 engines with on engine stage 2 fuel filters (2 filter elements) may not reach extended maintenance intervals. Switch to remote mount filter head (3 filter elements) for this application to achieve extended maintenance intervals. |  |  |  |  |  |  |  |  |
>
> **Fuel Filters**
>
> For engines with a High Pressure Injection (HPI)® fuel system, remove the on-engine fuel filter head and install off engine IndustriaPro fuel filters. Reference installation instructions included in the box with the fuel filters.
>
> For engines with a Modular Common Rail System (MCRS) fuel system (except CM2350), upgrade stage 1 filtration to IndustrialPro fuel filters. Reference installation instructions included in the box with the filters.
>
> | Table 7, Associated Hardware |  |
> |---|---|
> | Description | Cummins® Part Number |
> | 2 Stage Air Bleed Valve | [[4379736]] |
>
> **Note · Примечание**
> Air bleed valve is only needed when upgrading fuel filter head. Fuel filter head upgrade is not required on QSK50, QSK60 and QSK78 CM2350 engines.
>
> **Fuel Tank Vent Filters**
>
> The equipment fuel tank is to have a filtration system fitted to the fuel tank vent to remove contaminants from the ingested air. A fuel tank vent filter prevents fine airborne particles from contaminating the fuel tank as air is drawn in. The fuel tank venting system **must** accommodate the fastest rate of fuel fill that the vehicle will experience. See equipment manufacturer service information.
>
> - For equipment with existing fuel tank vent filters, install upgraded fuel tank vent filter as defined in Table 8 below. See equipment manufacturer service information for installation information.
> - For equipment without existing fuel tank vent filters, install both a fuel tank vent system as defined in Table 9 below and the fuel tank vent filter as defined in Table 8 below. See equipment manufacturer service information for installation information.
>
> | **Table 8, Fuel Tank Vent Filter Part Number** |  |
> |---|---|
> | **Description** | **Fleetguard® Part Number** |
> | Fuel tank vent filter, 3 micron | HF30195 |
>
> | **Table 9, Fuel Tank Vent System Part Number** |  |
> |---|---|
> | **Description** | **Hydrau-Flo® Part Number** |
> | Fuel tank vent system suitable for 1000 liters per minute fast fill | HF1008Z0010 |
>
> **Coolant Filters**
>
> The upgraded coolant filtration options offer higher capacity and improved filtration performance. Remove existing coolant filters and replace with StrataPore™ coolant filters. See Table 10 below for part numbers.
>
> | Table 10, Coolant Filter Part Numbers |  |  |
> |---|---|---|
...
>
> For all engines, replace existing primary air filters with upgraded air filters. See Table 11 below for part numbers.
>
> For engines, without air filter restriction indicators installed, install air filter restriction indicators. For information on the installation of air filter restriction indicators, contact equipment manufacturer.
>
> To reach extended maintenance intervals, maximum allowable intake restriction with clean filter element is 253 mm H2O \[ 10 in H 2 O \].
>
> | **Table 11, Air Filter Part Numbers** |  |  |  |
> |---|---|---|---|
> | **Type** | **Description** | **Original Fleetguard® Part Numbers** | **Upgrade NanoForce® Fleetguard® Part Numbers** |
> | Axial Seal | Primary | AF1605 or AF1605M | AF1605NF |
> | Secondary | AF1604 | No change in part number |  |
> | Axial Seal | Primary | AF879 or AF879M | AF879NF |
> | Secondary | AF857 | No change in part number |  |
> | Axial Seal | Primary | AF899 or AF899M | AF899NF |
> | Secondary | AF880 | No change in part number |  |
> | Radial Seal | Primary | AF27696 | AF27993NF + SP1307 service cover\* |
> | Secondary | AF27695 | AF27994 |  |
> | Radial Seal | Primary | AF27698 | AF25149NF + SP1307 service cover\* |
> | Secondary | AF27697 | AF25150 |  |
> | \*One time installation of SP1307 is required to install AF27993NF |  |  |  |
>
> **Section 5: Extended Maintenance Intervals**
>
> **CAUTION · Осторожно**
> Never wash or clean air filters. Filter washing or cleaning may compromise the air filter media and engine damage can result.
>
> **Note · Примечание**
...
>
> - Clean air housings. See equipment manufacturer service information.
...
>
> - Clean air filter housings. See equipment manufacturer service information.
> - Test for Glycol Levels with Coolant Test Kit, Fleetguard Part Number CC8997.
> - Check coolant level / top off. See equipment manufacturer service information.
>
> Time and Condition Based Requirements:
>
> | Table 12, Time Based Maintenance Intervals for Haul Trucks |  |  |  |  |  |  |  |  |  |  |  |
> |---|---|---|---|---|---|---|---|---|---|---|---|
> | System | List of Maintenance Tasks | As Required | Daily and Weekly | 250 Hours | 500 Hours | 1000 Hours | 1500 Hours | 2000 Hours | 3000 Hours | 4000 Hours | 5000 Hours |
> | Air | Change primary air filter elements | X |  |  |  | X |  | X | X | X | X |
> | Air | Change secondary air filter elements | X |  |  |  |  |  |  | X |  |  |
> | Air | Inspect and clean air filter housings | X |  |  |  |  |  |  |  |  | X |
...
> | Fuel | Replace stage 1 fuel filters | X |  |  |  | X |  | X | X | X | X |
> | Fuel | Replace stage 2 fuel filters | X |  |  |  | X |  | X | X | X | X |
> | Fuel | Replace fuel tank breather filters | X |  |  |  | X |  | X | X | X | X |
...
> | Lubricating Oil | Change rotor in Eliminator™ / Centrifuge |  |  |  |  | X |  | X | X | X | X |
> | Lubricating Oil | Change lubricating oil filters (if installed) |  |  |  |  | X |  | X | X | X | X |
>
> | Table 13, Time Based Maintenance Intervals for Excavators and Loaders |  |  |  |  |  |  |  |  |  |  |  |
> |---|---|---|---|---|---|---|---|---|---|---|---|
> | System | List of Maintenance Tasks | As Required | Daily and Weekly | 250 Hours | 500 Hours | 1000 Hours | 1500 Hours | 2000 Hours | 3000 Hours | 4000 Hours | 5000 Hours |
> | Air | Change primary air filter elements | X |  |  | X | X | X | X | X | X | X |
> | Air | Change secondary air filter elements | X |  |  | X | X | X |  | X |  |  |
> | Air | Inspect and clean air filter housings | X |  |  |  |  |  |  |  |  | X |
> | Coolant | Test coolant for replacement limits | X |  |  |  |  |  |  |  | X |  |
> | Coolant | Change coolant filters |  |  |  |  |  |  |  |  | X |  |
> | Coolant | Top off coolant | X |  |  | X | X | X | X | X | X | X |
> | Fuel | Drain water and sediment from lower bowl of Industrial Pro™ fuel filters | X | X | X | X | X | X | X | X | X | X |
> | Fuel | Replace stage 1 fuel filters | X |  |  | X | X | X | X | X | X | X |
> | Fuel | Replace stage 2 fuel filters | X |  |  | X | X | X | X | X | X | X |
> | Fuel | Replace fuel tank breather filters | X |  |  | X | X | X | X | X | X | X |
> | Lubricating Oil | Collect lubricating oil sample and perform lubricating oil analysis | X |  | X | X | X | X | X | X | X | X |
> | Lubricating Oil | Change engine lubricating oil | According to Operation and Maintenance Manual or Lubricating Oil Drain Interval Established Per Section 6. |  |  |  |  |  |  |  |  |  |
> | Lubricating Oil | Change rotor in Eliminator™ / Centrifuge |  |  |  |  | X | X | X | X | X | X |
> | Lubricating Oil | Change lubricating oil filters (if installed) |  |  |  |  | X | X | X | X | X | X |
>
> | Table 14, Condition Based Filter Maintenance Intervals |  |
> |---|---|
> | System | Replacement Indication |
> | Fuel Filters, Stage 1 | Replace based on schedule in Tables 12 and 13 or using visual indication on Industrial Pro™ units or when indicated by FleetguardFIT™. |
> | Fuel Filters, Stage 2 | Replace based on schedule in Tables 12 and 13 or when indicated by FleetguardFIT™. |
> | Fuel Tank, Vent / Breather Filters | Replace based on schedule in Tables 12 and 13. |
> | Lubricating Oil Filters | Replace based on schedule in Tables 12 and 13 or when indicated by FleetguardFIT™. |
> | Lubricating Oil, Eliminator™ / remote centrifuge rotor | Replace based on schedule in Tables 12 and 13 or at the same time as lubricating oil and lubricating oil filters are replaced. |
> | Coolant / Water filters | Replace based on schedule in Tables 12 and 13. |
> | Air filter, Primary | Replace based on schedule in Tables 12 and 13 or when the differential reaches 635 mm-h 2 o \[ 25 in- h 2 o \] on the restriction indicator, whichever occurs first or when indicated by FleetguardFIT™. |
> | Air filter, Secondary | Replace every third primary air filter change. |
>
> FleetguardFIT™
>
> Filtration Intelligence Technology—is a real-time filtration monitoring system that provides full visibility to filter (Fuel, Lube and Air) and oil life enabling proactive problem detection using intelligent sensing and advanced data analytics. To learn more about FleetguardFIT and how to get it onto your engine, contact Cummins Filtration at info@fleetguardfit.com.
>
> **Note · Примечание**
...
>
> Do **not** extend lubricating oil and lubricating oil filter change intervals beyond the limits specified in the maintenance schedule, unless all of the conditions required by this service bulletin are met:
>
...
>
> Lubricating oil samples **must** be sent to a lab capable of testing the parameters in Table 14 using the specified test method.
>
> | Table 15, Oil Analysis Test Parameters |  |  |
> |---|---|---|
...
>
> Samples **must** be taken at the intervals specified in Table 17 or 18 below. For sampling procedure, See Service Bulletin, Oil Analysis Techniques for High Horsepower Diesel Engines, Bulletin [[4022060 — Oil Analysis Techniques for High Horsepower Diesel Engines|4022060]].
>
...
>
> 1. Linear trending throughout each lubricating oil drain interval of:
>
...
> - Copper
>
> Linear Trending Example Key for Figure 1 Below:
>
...
>
> 2. Lubricating Oil Analysis Parameters are within limits defined in Table 16 below.
>
> | Table 16, Oil Analysis Parameter Limits |  |
> |---|---|
...
> | For XW-30: |  |
> | MIN: 9.3 MAX: 12.5 |  |
> | Oxidation abs/cm – direct trending | 15 1 |
> | Nitration abs/cm – direct trending | 25 |
> | 1 Increase over new (unused oil sample) |  |
>
> 3. Repeat sample plan for 3 different lubricating oil drain intervals on each of the 3 engines in the same segment.
>
> 4. Final lubricating oil drain will be the hours at which any of the samples did **not** meet the lubricating oil integrity test criteria reduced by 20%.
>
> 1. 20% margin is added to the approved lubricating oil drain interval to account for changes in rate of lubricating oil degradation as the engine ages.
>
> | Table 17, Example Lubricating Oil Sampling Plan for Haul Trucks |  |  |
> |---|---|---|
...
> | 4 | 600 | Verify Lubricating Oil Integrity using the steps above. Stop test and change lubricating oil if requirements are not met. |
> | 5 | 700 | Verify Lubricating Oil Integrity using the steps above. Stop test and change lubricating oil if requirements are not met. |
> | 6 | 800 | Verify Lubricating Oil Integrity using the steps above. Stop test and change lubricating oil if requirements are not met. |
> | 7 | 900 | Verify Lubricating Oil Integrity using the steps above. Stop test and change lubricating oil if requirements are not met. |
> | 8 | 1000 | Verify Lubricating Oil Integrity using the steps above. Stop test and change lubricating oil if requirements are not met. |
> | 9 | 1050 | Verify Lubricating Oil Integrity using the steps above. Stop test and change lubricating oil if requirements are not met. |
> | 10 | 1100 | Verify Lubricating Oil Integrity using the steps above. Stop test and change lubricating oil if requirements are not met. |
> | 11 | 1150 | Verify Lubricating Oil Integrity using the steps above. Stop test and change lubricating oil if requirements are not met. |
> | 12 | 1200 | End of test. Collect sample before draining lubricating oil. |
>
> | Table 18, Example Lubricating Oil Sampling Plan for Excavators and Shovels |  |  |
> |---|---|---|
> | Sample Number | Lubricating Oil Hours | Description |
> | 0 | Baseline | Sample unused lubricating oil from container |
> | 1 | 0 | Collect sample after filling sump with new lubricating oil and letting engine idle for 5 minutes |
> | 2 | 200 | Verify Lubricating Oil Integrity using steps above. Stop test and change lubricating oil if requirements are not met. |
> | 3 | 300 | Verify Lubricating Oil Integrity using steps above. Stop test and change lubricating oil if requirements are not met. |
> | 4 | 400 | Verify Lubricating Oil Integrity using steps above. Stop test and change lubricating oil if requirements are not met. |
> | 5 | 500 | Verify Lubricating Oil Integrity using steps above. Stop test and change lubricating oil if requirements are not met. |
> | 6 | 550 | Verify Lubricating Oil Integrity using steps above. Stop test and change lubricating oil if requirements are not met. |
> | 7 | 600 | End of test. Collect sample before draining lubricating oil. |
>
> **Section 7: Additional Service Literature**
>
...
> - See QSK60 CM2350 K135 (MCRS) Operation and Maintenance Manual, Bulletin 5504625.
> - See QSK60 CM2350 K136 (MCRS) Operation and Maintenance Manual, Bulletin 5504630.
> - See QSK78 CM2350 K126 (MCRS) Operation and Maintenance Manual, Bulletin 5504265.
> - See QSK78 CM2350 K137 (MCRS) Operation and Maintenance Manual, Bulletin 5504635.
> - See QSK78 CM2350 K154C (MCRS) Operation and Maintenance Manual, Bulletin 5676943.
> - See QST30 CM2350 T101 (MCRS) Operation and Maintenance Manual, Bulletin 5467180.
> - See QSK23 CM2350 K127 (MCRS) Operation and Maintenance Manual, Bulletin 5504159.
> - See QSK50 CM2350 K130 (MCRS) Operation and Maintenance Manual, Bulletin 5504179.
>
> Service Manuals:
>
...
> - See QSK60 CM2350 K135 Service Manual, Bulletin 5504626.
> - See QSK60 CM2350 K136 Service Manual, Bulletin 5504631.
> - See QSK78 CM2350 K126 Service Manual, Bulletin 5504266.
> - See QSK78 CM2350 K137 Service Manual, Bulletin 5504636.
> - See QSK78 CM2350 K154C Service Manual, Bulletin 5676944.
> - See QST30 CM2350 T101 Service Manual, Bulletin 5467179.
> - See QSK23 CM2350 K127 Service Manual, Bulletin 5504160.
> - See QSK50 CM2350 K130 Service Manual, Bulletin, Bulletin 5504180.
>
> Literature **not** found on QuickServe® Online:
>
> Hard Copy Service Bulletin:
>
> - Service Bulletin, Fuel Quality for High Horsepower Engines with Modular Common Rail Fuel Systems (MCRS), Bulletin 4091849.
>
> ### Document History
