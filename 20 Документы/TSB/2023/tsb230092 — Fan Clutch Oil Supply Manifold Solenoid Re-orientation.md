...
- Удалите соленоидную проводку из общего P-клипа, удерживая соленоидную проводку и электропроводку двигателя, к крышке скалолаза (окруженной желтым). Разрежьте кабельный стяжка, обеспечивающий соленоидную проводку, к существующей проводах двигателя. На рисунке 3 показан существующий маршрут для двигателей Tier 2.
...
| Манифольд, масло | [[3640889]] | Да | Да | [[6414133]] | 1 |
...
Новый масляной коллектор распространен на QSK50 Tier 2 и Tier 4, как и существующая конструкция. Новые и существующие масляные коллекторы обратно совместимы. Новый коллектор рекомендуется для ожидаемой работы соленоида вентилятора и срока службы.

**Идентификация детали**

Новый масляной коллектор отличается по форме от существующей части, что позволяет соленоиду управления маслом сидеть с ног на голову. Новый номер детали проштампован в месте, показанном на рисунке 6 Существующий номер детали проштампован ровно на 180° напротив этого на нижней стороне. Оба номера деталей проштампованы на лице, противоположном соленоиду, если смотреть как установлено.
