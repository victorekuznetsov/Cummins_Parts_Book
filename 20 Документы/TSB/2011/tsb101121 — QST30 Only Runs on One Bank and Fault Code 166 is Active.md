...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/tsb/tsb101121.pdf"
tags:
  - "документ/tsb"
  - "двигатель/QST30"
  - "год/2011"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/tsb/2010/tsb101121.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/tsb/tsb101121.pdf)
...
| **QST30 CM552 Промышленные одноплитовые электропроводные упряжки Двигатели** | ** Часть номера** | ** Дата начала или начала реализации проекта** |
|---|---|---|
| Один резистор Ом 2,2k (только правый берег) | 4975508 | 3 августа 2009 года |
| Два резистора 2,2k Ohm | 4975755 | 37247268 |

| ** Интерфейс QST30 CM850 для генерации электроэнергии** | ** Часть номера** | ** Дата начала или начала реализации проекта** |
|---|---|---|
