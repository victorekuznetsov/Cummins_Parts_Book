---
aliases:
  - "Новые перепускные крышки и прокладки K38/50 и QSK38/50"
type: "TSB"
doc: "tsb101122"
title_en: "New K38/50 and QSK38/50 Jumper Covers and Jumper Cover Gasket"
title_ru: "Новые перепускные крышки и прокладки K38/50 и QSK38/50"
released: "2011-01-17"
modified: "2011-01-17"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/tsb/2010/tsb101122.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/tsb/tsb101122.pdf"
tags:
  - "документ/tsb"
  - "двигатель/K38/K50"
  - "год/2011"
...
# New K38/50 and QSK38/50 Jumper Covers and Jumper Cover Gasket
**Новые перепускные крышки и прокладки K38/50 и QSK38/50**

> [!abstract] TSB · `tsb101122`
> **Раздел Cummins:** 07 - Lubricating Oil Systems
> **Двигатели:** [[33239746 — QSK60 CM2150 MCRS CPL 3451|33239746]], [[33239899 — QSK50 CM2150 MCRS CPL 3379|33239899]]
> **Семейство:** K38/K50 · QSK38, QSK50, QSK60
> **Даты:** выпущен 2011-01-17 · изменён 2011-01-17
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/tsb/2010/tsb101122.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/tsb/tsb101122.pdf)
...
Рисунок 1: Jumper Место на обложке

В этом документе представлены новые прокладки крышки и крышки перемычки для использования на всех двигателях K38, K50, QSK38 и QSK50.

Обложка перемычки также называется соединением передачи масла, и ее расположение на двигателе показано на рисунке 1.

Материал прокладки крышки прыгуна был изменен с стального сердечника на кромочный формованный, чтобы повысить долговечность и уменьшить потенциал утечек.

Из-за того, что новая прокладка крышки прыгуна немного толще, крышки перемычки были пересмотрены, чтобы предотвратить возможные помехи между крышкой перемычки и стартером двигателя.

Новые крышки и прокладка прыгунов были выпущены 20 декабря 2010 года для использования во всех двигателях K38, K50, QSK38 и QSK50 с ESN 33184438.

#### Если новая, граневая прокладка установлена на двигатель, оснащенный старой крышкой перемычки, существует вероятность того, что между крышкой перемычки и стартером могут быть помехи. Если есть условие помехи, есть два возможных варианта:

- Обшивка прыгуна может быть обработана таким образом, чтобы 1,1 мм \[0,043 дюйма\] материала обрабатывался с спаривающейся поверхности крышки. См. рисунок 4. После обработки поверхность должна иметь плоскость 0,25 отклонения и поверхность отделки 3,2 шероховатости средней, максимальной.
- Старую крышку можно заменить на новую.

Если нет помех, можно использовать старую обложку с прокладкой нового стиля.

Не удаляйте материал с внешней поверхности крышки, так как уменьшенная толщина стенки может привести к неисправности крышки.

#### Покрытие перемычки может быть идентифицировано как старое или новое либо по номеру детали, показанному в таблице 1, либо путем измерения толщины крышки следующим образом:

- Есть шесть противоскучных отверстий, используемых для крепления крышки к блоку цилиндра.
- Измерьте толщину материала между дном противоскучного отверстия и обработанной поверхностью крышки. См. рисунок 3.
- Старая крышка будет иметь толщину (размер Х на рисунке 4) 12 ± 0,38 мм \[0,472 ± 0,0149 в\]
- Новая крышка будет иметь толщину (размер Х на рисунке 4) 10,9 ± 0,38 мм \[0,429 ± 0,0149 в\]
...
Рисунок 2: Гаскет (1) и джампер-ковер (2 и 3)

Рисунок 3: Jumper покрывает измерение толщины

Рисунок 4: Материал, который будет удален из спаривающейся поверхности крышки

Таблица 1 содержит старые и новые номера прокладок и перемычек.

| Таблица 1: Гаскет и джампер покрывают номера частей |  |  |  |  |  |
|---|---|---|---|---|---|
| Номер позиции | Наименование | Прежний номер детали | Материал | Новый номер детали | Материал |
| 1 | Гаскет | 3627938 | стальное ядро | 3642342 | Сформированный край |
