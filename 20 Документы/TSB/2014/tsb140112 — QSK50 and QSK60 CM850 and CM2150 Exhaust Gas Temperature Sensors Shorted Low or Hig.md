...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/tsb/tsb140112.pdf"
tags:
  - "документ/tsb"
  - "двигатель/K38/K50"
  - "двигатель/QSK50"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/tsb/2014/tsb140112.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/tsb/tsb140112.pdf)
...
В этом документе подчеркивается контрмера, которая была разработана для сокращения простоев клиентов. На датчиках QSK50 и QSK60 CM850 и CM2150 температуры выхлопных газов (EGT) были запущены два серьезных проекта по проблеме качества (SQP) для выявления первопричин неисправностей. Есть две различные неисправности, хотя они сообщают о похожих кодах неисправностей. Коды ошибок: «Voltage Below Normal or Shorted to Low Source» или «Voltage Above Normal or Shorted to High Source». Существует две различные первопричины, перечисленные ниже.
