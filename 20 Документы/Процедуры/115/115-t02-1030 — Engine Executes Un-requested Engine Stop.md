...
| **Условия:** Откройте окно клиентского интерфейса Отключить зажигание (остановка двигателя) подводящие провода от переключателя остановки двигателя Отключить окно клиентского интерфейса к проводах двигателя кабель жгута проводов на разъеме C1 от окна клиентского интерфейса. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
