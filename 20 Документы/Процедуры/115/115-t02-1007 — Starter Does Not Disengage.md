...
- Двигатель продолжает сворачивать после того, как оператор нажал кнопку запуска на панели машинного отделения или удаленной панели.
...
> ### Symptoms
>
> - The engine continues to crank after the operator pushed the start button on the engine room panel or remote panel.
>
