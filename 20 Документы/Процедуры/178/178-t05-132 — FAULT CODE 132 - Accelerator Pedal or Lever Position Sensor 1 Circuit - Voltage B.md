...
|  | **STEP 1A.** Проверить коды неисправностей датчиков. | Код ошибки 2185 или 2186 активен? |
|  | **STEP 1B.** Проверить наличие кода сбоя. | Код 132 ошибки активен? |
...
|  | **STEP 2B.** Проверьте напряжение питания и обратную цепь датчика положения педали акселератора. | 4,75 VDC и 5,25 VDC? |
|  | **STEP 2C.** Проверьте реакцию цепи. | Код 131 активен, а Код 132 неактивен? |
...
|  | **STEP 3F.** Проверить неактивный код ошибки. | Код 132 неактивен? |
...
| Проверьте коды неисправностей датчика. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код ошибки 2185 или 2186 активен? *Да | Соответствующий код неисправности дерево |
| Код ошибки 2185 или 2186 активен? **НЕТ** | 1В |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте отклик цепи. Поместите провод перемычки между положением педали акселератора +5 вольт контакта питания и контактом сигнала педали акселератора на разъеме датчика проводов OEM. См. схему или схему проводов для идентификации контакта с разъемом. Проверьте соответствующий ответ на ECM через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 131 активен, а Код 132 неактивен? *Да | 2D |
| Код 131 активен, а Код 132 неактивен? **НЕТ** | 3А |  |

#### ШАГ 2D. Проверьте коды неисправностей и состояние педали акселератора.

| **Условия:** Выключите замок зажигания. Подключите педаль акселератора к электропроводке OEM. Включите зажигание. Подключите инструмент электронного сервиса INSITETM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте соответствующую реакцию цепи через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 132 ошибки активен? Ремонт: обнаружена поврежденная педаль акселератора. См. информацию об услугах производителя оборудования для инструкций по ремонту. Замените педаль акселератора. См. сервисную документацию изготовителя оборудования. | 4А |
| Код 132 ошибки активен? **Норвегия: **Нет. Удаление и установка разъема исправили неисправность. | 4А |  |
...
| **Условия:** Выключите замок зажигания. Отсоедините проводку OEM от разъема ECM. Отсоедините педаль акселератора от электропроводки OEM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте цепь на обрыв. Измерить сопротивление между OEM проводкой жгута разъема ECM педалью или рычагом сигнала контакта и OEM проводкой жгута педали разъема контакта. Используйте схему проводов для идентификации штифта и следующую процедуру для общих методов измерения сопротивления.[[99-019-360 — Resistance Measurement Using a Multimeter\|См. процедуру 019-360 в разделе 19.]] | Менее 10 Ом? *Да | 3D |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте, не хватает липкой крошки. Измерьте сопротивление между контактом педали акселератора в проводах OEM-подключателя ECM и землей. Используйте схему проводов для идентификации штифта и следующую процедуру для общих методов измерения сопротивления.[[99-019-360 — Resistance Measurement Using a Multimeter\|См. процедуру 019-360 в разделе 19.]] | Больше 100 тысяч ом? *Да | 3F |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте соответствующую реакцию цепи через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 132 неактивен? **Ремонт:** Удаление и установка разъема исправили неисправность. | 4А |
| Код 132 неактивен? **Норепайр:** Заменить ECM. См. процедуру 019-031 в Таблице ассоциированных процедур. | 4А |  |
