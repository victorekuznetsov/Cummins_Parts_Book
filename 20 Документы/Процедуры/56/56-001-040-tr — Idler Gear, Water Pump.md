...
type: "Процедура"
doc: "56-001-040-tr"
title_en: "Idler Gear, Water Pump"
title_ru: "Промежуточная шестерня водяного насоса"
modified: "2023-08-30"
engines:
  - "33210083"
  - "33219033"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/56/56-001-040-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/56-001-040-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK60"
  - "группа/56"
...
> [!abstract] Процедура · `56-001-040-tr`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/56/56-001-040-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/56-001-040-tr.pdf)
...
| Водяной насос Idler Gear внутри диаметра |  |  |
|---|---|---|
| мм |  | в |
| 73.035 | Мин | 2.8753 |
| 73.065 | Макс | 2.8765 |
...
| Водяной насос Idler Gear Shaft Outside Diameter |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| (1) | 88.75 | Мин | 3.494 |
|  | 89.05 | Макс | 3.506 |
...
| Водяной насос Idler Gear Thrust Bearing Thickness |  |  |
|---|---|---|
| мм |  | в |
| 2.337 | Мин | 0.092 |
| 2.387 | Макс | 0.094 |
...
> [!warning] ОСТОРОЖНО
> Все отверстия на внешнем диаметре вала должны быть в правильном положении или в результате несрабатывания не будет получена смазка.

Для целей сборки рекомендуется, чтобы номер детали переключения передач водяного насоса был обращен в сторону от блока цилиндров.

Водный насос холостого вала (1) должен быть установлен таким образом, чтобы отверстия на внешнем диаметре вала располагались в 3-х и 9-ти часовых положениях.

![[01k00037.png]]

Канавки в шайбе должны быть повернуты к шестеренок.

Используйте LubriplateTM 105 или эквивалент. Смазать втулку передач, вал холостого хода и шайбу.

Поверните вал холостого хода, если это необходимо, чтобы выровнять отверстия крепежных болтов.

Смазать три болта чистым моторным маслом.

Соберите части, как показано.

![[01600148.png]]

Используйте три болта, чтобы втянуть вал в цилиндрический отсек.

Затягивайте болты в последовательности, показанной на иллюстрации.

Уплотните все три болта равномерно на каждый шаг значения крутящего момента.
...
| Водяной насос Idler Gear - End Clearance |  |  |
|---|---|---|
| мм |  | в |
| 0.15 | Мин | 0.006 |
| 0.33 | Макс | 0.013 |
