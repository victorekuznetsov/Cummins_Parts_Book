...
Из-за износа плунжера с топливным форсункой более прочный материал D4 заменил материал 4140 на 9,5 мм \[0,37 дюйма \] плунжере в ноябре 1987 года (серийный номер двигателя первый 33113265).
...
Пересмотренный масляный кормовой каштан и верхний винт были выпущены для форсунки K STC. Пересмотренный масляный кормовой локон имеет соответствующие общие настройки проезда, проштампованные на нем. Пересмотренный винт верхнего предела составляет 1,78 мм \[0,070 дюйма \] длиннее, чем предыдущий винт верхнего предела.
...
Эти компоненты крана работают вместе с плунжером форсунки для контроля времени впрыска. Сборка крана может использоваться с любым гайкой верхнего уровня STC, потому что они **не **совпадают.
...
Если знак 204°C \[400°F\] не плавится (2), цвет знака остается присутствующим. Это указывает на то, что цилиндр не работает при температуре 204 ° C или выше [400° F], что указывает на возможную неисправность впрыска.
...
Удалите шланг потока форсунки из блока коллектора топливного стока, расположенного на левом берегу двигателя. Удалите шланг из конца блока сливного коллектора (1) **только. **[[28-006-013 — Fuel Drain Lines|См. процедуру 006-013 в разделе 6.]]
...
Охлаждение системы LTA.[[28-008-018-tr — Cooling System|См. процедуру 008-018 в разделе 8.]]

Удалите коллекторы для впуска.[[28-010-002-tr — Aftercooler Assembly|См. процедуру 010-002 в разделе 10.]]
...
Удалите шланг для слива топлива и соберите линии слива топлива.[[28-006-013 — Fuel Drain Lines|См. процедуру 006-013 в разделе 6.]].

Установите впускные коллекторы.[[28-010-002-tr — Aftercooler Assembly|См. процедуру 010-002 в разделе 10.]]
...
- Удалите крышку рычага клапанного клапана и все связанные с ней части.[[28-003-011-tr — Rocker Lever Cover|См. процедуру 003-011 в разделе 3.]]
...
- Снимите двухсекционную крышку рычага клапана.[[28-003-011-tr — Rocker Lever Cover|См. процедуру 003-011 в разделе 3.]]
...
Угол крутящего момента 60 градусов может быть достигнут путем маркировки местоположения одного угла болтов к местоположению на зажиме удерживания форсунки.
...
- Для форсунки STC отрегулируйте накладные расходы.[[28-003-007-tr — Overhead Set (Travel Method)|См. процедуру 003-007 в разделе 3.]]
- Установите крышку рычага клапанного клапана и все связанные с ней части.[[28-003-011-tr — Rocker Lever Cover|См. процедуру 003-011 в разделе 3.]]
...
- Установите двухсекционную крышку рычага клапанного качалки.[[28-003-011-tr — Rocker Lever Cover|См. процедуру 003-011 в разделе 3.]]
- Удалите защитные заглушки форсунки, часть номер[[4918767]].
- Установите линии подачи топлива форсунки.[[28-006-051-tr — Injector Supply Lines (High Pressure)|См. процедуру 006-051 в разделе 6.]]
- Запустите двигатель и проверьте на отсутствие утечек.
