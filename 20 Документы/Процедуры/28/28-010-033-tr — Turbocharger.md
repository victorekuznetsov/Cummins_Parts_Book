...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/28-010-033-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K38/K50"
  - "группа/28"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/28/28-010-033-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/28-010-033-tr.pdf)
...
Пересмотренный шланг сливает масло на бурение на верхней палубе в передней части правого берега и левой части задней части блока цилиндров. Используемые отверстия частично покрыты опорой турбокомпрессора. Эта поддержка требует модификации или замены.
...
Более длинные шпильки, гайки и спейсеры были выпущены для импульсного выхлопного коллектора K50 в мае 1989 года, ESN First 33115948.
...
- Охлаждение системы сливается до точки ниже турбокомпрессоров.[[28-008-018-tr — Cooling System|См. процедуру 008-018 в разделе 8.]]
- Удалите линии подачи и возврата охлаждающей жидкости. См. процедуру 010-041 в разделе 10.
- Удалите линии поставок масла. См. процедуру 010-046 в разделе 10.
- Удалите линии отвода масла. См. процедуру 010-045 в разделе 10.
...
Устранить зажимы шланга (12). Вытащите трубу (15) впускного соединения из турбокомпрессора высокого давления. Удалите и отбросьте уплотнения (13) и шланг (11). Удалите пылевую уплотнение.
...
Удалите восемь гаек, простые шайбы, гайки, болты и p-клипы из соединений переноса воздуха.
...
Удалите восемь гаек, простые шайбы и болты, и удалите трубопроводы для переноса воздуха. Отбросьте прокладки.
...
> [!warning] ОСТОРОЖНО
> Заклейте или заглуните все отверстия, чтобы предотвратить попадание растворителя или пара в масляные полости в турбокомпрессоре.
...
Заменить центральный корпус вращающейся сборки, если радиальный зазор **не** в пределах спецификаций.
...
Во время установки турбокомпрессора часто необходимо регулировать угол слива масла подшипниковой оболочки и угол выхода корпуса компрессора. Инструкции по этим регулировкам описаны в соответствии с процедурой для турбокомпрессора KTTA50 с низким давлением.
...
Используйте растительное масло. Смазать уплотнение.
...
> [!note] Примечание
> Турбокомпрессоры для двигателя К50 с выхлопными коллекторами импульсного типа должны быть установлены с четырьмя шпильками и гайками, болтами и гайками **не**. Момент затяжки одинаково. Некоторые двигатели K38 не требуют гаек.
...
Установите тяжелые плоские шайбы (13), шайбы (17) и гайки (18).
...
Установите тяжелые плоские шайбы (32), запирайте шайбы (33) и гайки (34).
...
Установите тяжелые плоские шайбы (36), шайбы замка (37) и гайки (38).
...
Установите два болта (31), скобка (32), тяжелую плоскую шайбу (23), шайбы блокировки (24) и гайки (25) на подключение воздухозаборника.
...
Установите болты (43) через тяжелую плоскую шайбу (44) и обе скобки (32 и 4). Установите тяжелые плоские шайбы (44), запирайте шайбы (33) и гайки (34).

![[tb6bkwa.png]]

Используйте анти-захват соединения для покрытия резьбы болтов (35).

Установите два болта (35) через соединение (17) выпускного отверстия и скобку (4). Установите тяжелые плоские шайбы (36), запирайте шайбы (37) и гайки (38).
...
Поместите впускную трубу (47) между турбокомпрессорами и вставьте прокладку (48). Закрепите фланцы четырьмя болтами (49), плоскими шайбами (50), шайбами блокировки (51) и гайками (52).
...
> [!tip] Момент затяжки
> Низкопрессорный турбокомпрессорный масляной впуск 25 Н·м [18 футов-лб]
...
Установите болты, шайбы и гайки и затяните.
...
Установите болты, шайбы и гайки пальцами, чтобы обеспечить выравнивание.
...
Добавьте p-клип к верхним правым болтам. Не затягивайте этот болт до тех пор, пока не будет установлена линия подачи масла.

После проверки выравнивания затяните болты.

> [!tip] Момент затяжки
> Воздушный впуск болтов и гаек 48 Н·м [35 футов-lb]
...
- Установите линии отвода масла. См. процедуру 010-045 в разделе 10.
