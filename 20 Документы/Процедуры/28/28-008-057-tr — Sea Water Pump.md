...
> [!abstract] Процедура · `28-008-057-tr`
...
Насос морской воды на двигателях морской серии K38 и K50 содержит гребной гребной колесный колесо, которое позволяет насосу функционировать либо в повороте по часовой стрелке **или против часовой стрелки**. При взгляде спереди двигателя, морской водяной насос на правом берегу вращается в направлении **против часовой стрелки**. На левом берегу морской водяной насос вращается в направлении **часовой стрелки**. Входной отсек для насоса морской воды - это порт, ближайший к передней крышке передач.
...
При повороте вала поместите чистое моторное масло 15W-40 в масляной проход, чтобы смазать подшипники.
...
Удалите булавку (5), щелевой гайка (6) и шайбу (7).
...
> [!note] Примечание
> Кольцо прокладки может быть плотно прилегать к телу. При необходимости используйте две стержни для удаления кольца.

Удалить кольцо с пробелом (3).

![[sw600ff.png]]

Сгибайте локоны. Удалите четыре гайки (12) и локоны (13).
...
> [!note] Примечание
> Самый большой диаметр уплотнения **должен** касаться контактного кольца.
...
> [!warning] ОСТОРОЖНО
> Используйте эту иллюстрацию для определения спецификации крутящего момента для устанавливаемого гайки. Если старый, меньший гайка привинчен к более высокой спецификации, гайка выйдет из строя.
...
Рекомендуется более крупный гайка.

![[sw6nuga.png]]

> [!warning] ОСТОРОЖНО
> Не ослабляйте гайку, чтобы выровнять щели в гайке с отверстием в валу. Затянуть гайку не более чем на 10 градусов, чтобы выровнять отверстия. Если щели и отверстия не находятся в выравнивании, измените шайбу или немного уменьшите толщину шайбы, чтобы щель и отверстие были в выравнивании при правильном крутящем моменте.

Установите булавку для коттера (5). Сгибайте концы булавки над гайкой.
...
Подгоните воротник уплотнения (19) над валом.
...
Нанесите фиксатор Loctite® 641 на вал, где будет установлен воротник уплотнения (20). Нажмите на воротник уплотнения в положение.
...
> [!note] Примечание
> Лица уплотнения должны быть чистыми и сухими, чтобы эффективно работать.
