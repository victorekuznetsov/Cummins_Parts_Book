...
> [!note] Примечание
> Показано устройство 2-го этапа фильтрации для двигателя QSK38. Хотя по внешнему виду процедура остается прежней для двигателей серии QSK.

Удалите датчик давления и замените его на фитинг Compuchek®, резьбу M14 x 1.5, номер детали[[3638767]].

![[05600293.png]]

Подключите адаптер давления, Часть Номер 3164491 или эквивалент, и цифровой мультиметр, Часть Номер 3164488, 3164489 или эквивалент, к фитингу Compuchek®.
...
> [!note] Примечание
> В этой процедуре показаны фильтры стадии 1 морского применения. Хотя по внешнему виду они отличаются, процедура накачки остается одинаковой для двигателей серии QSK.
...
|---|---|---|
| [[3638767]] | COUPLING NIPPLE | Соединительный ниппель |
...
>
> **Note · Примечание**
> Shown is the stage 2 filter head for the QSK38 engine. Although different in appearance the procedure remains the same for the QSK series engines.
>
> Remove the pressure sensor and replace it with a Compuchek® fitting, M14 x 1.5 thread, Part Number [[3638767]].
>
...
>
> **Note · Примечание**
> Shown in this procedure are the marine application stage 1 filters. Although different in appearance, the pump procedure remains the same for the QSK series engines.
>
...
> with Electronically Actuated Injector
>
> Install vibration isolators at each end of the fuel lift pump.
>
