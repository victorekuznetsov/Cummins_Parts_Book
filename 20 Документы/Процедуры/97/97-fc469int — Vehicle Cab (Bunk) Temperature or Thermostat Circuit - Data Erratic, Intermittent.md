...
### Код неисправности: 469 (интегрированный)
...
|---|---|---|
| Код неисправности: 469 PID(P): S215 SPN: ФМИ: 2/2 лампы: Нет, не srt: | Температура колпачка транспортного средства (банк) или схема термостата - данные нестабильные, прерывистые или неправильные. Термостат ICONTM кабины зафиксировал неисправность (E3 на термостате кабины), или сигнал кабины термостата к электронному модулю управления (ECM) теряется. | E3 будет циклировать двигатель от 20 минут работы до 15 минут выключения или до достижения желаемой заданной точки. (Это выборочный ответ на неисправность E3 в настройках отделки термостата.) Система ICONTM будет отключена. Режим двигателя будет оставаться активным. |
...
- Двигатель работает более 60 минут, и точка установки охлаждения или тепла не достигается, а температура внешней среды находится в пределах от -18 ° до 43 ° C \[0 до 110° F \] (термостат-регулируемая отделка 01 и 02, см. настройки отделки термостата в разделе F)

- Запрос на запуск двигателя был запрошен четыре раза за 1 час, а температура окружающей среды находится в пределах от -18 ° до 43 ° C \[0 до 110° F \].

E3 может указывать на потенциальное вмешательство термостата. Например, оператор выбрал холодный режим, но включил нагреватель или открыл окна. Система кондиционирования воздуха будет пытаться охладить грузовик ниже точки охлаждения в течение 60 минут. В это время будет зарегистрирована ошибка E3 (код ошибки 469). Аналогичная ситуация может возникнуть и в тепловом режиме. После того, как E3 будет отображаться на термостате, двигатель будет работать в течение 20 минут и выключаться в течение 15 минут. Если желаемая заданная температура достигается в режиме работы с подделкой (20 минут включения и 15 минут выключения), она возвращается к нормальной работе в режиме кабины. Чтобы очистить E3, отключите систему ICONTM, отключите ключ примерно на 30 секунд, а затем активируйте систему ICONTM.

**Примечание: **Неисправность термостата E1 (датчик температуры кабины), E2 (датчик температуры наружного окружающего воздуха) и E3 (режим включения) не мелькают на лампе ICONTM, а просто отображаются на экране дисплея термостата. INSITETM будет регистрировать активный код 469 ошибки до тех пор, пока не будет очищен. См. Cab Thermostat Отображает дерево симптомов устранения неисправностей кода ошибки в разделе TS. Исследуйте связанные коды ошибок, которые также могут быть активными.
...
| Степс | Спецификации |  |
|---|---|---|
| ШАГ 1. | Проведите собеседование с водителем, чтобы выяснить работу системы температуры кабины, когда произошел код неисправности, и определить режим термостата кабины, температуру и параметры диапазона кабины, а также температуру наружного воздуха. |  |
|  | **STEP 1A.** Проверьте настройки термостата кабины и настройки контроля температуры кабины. | Кабина термостат установлен правильно; кабины температурные элементы управления работают надлежащим образом |
| ШАГ 2. | Прочитайте все коды ошибок. |  |
|  | **STEP 2A.** Считывать коды неисправностей с помощью инструментария электронного обслуживания INSITETM. | Коды неактивны |
|  | **STEP 2B.** Проверьте термостат кабины на наличие кода неисправности. | Активные коды ошибок |
| ШАГ 3. | Проверьте датчик температуры окружающего воздуха (при появлении неисправности термостата E2). |  |
...
|  | **STEP 3B** Проверьте сопротивление датчика температуры окружающего воздуха. | Технические характеристики сопротивления при соответствующей температуре окружающего воздуха: 0°C \[32°F\] = 29 до 36k ом, 25°C \[77°F\] = 9 до 11k ом, 50°C \[122°F\] = 3 до 4k ом, 75°C \[167°F\] = 1300 до 1600 ом, 100°C \[212°F\] = 600 до 750 ом |
|  | **STEP 3C.** Проверить наличие открытой цепи. | Менее 10 Ом |
|  | **STEP 3D.** Проверьте короткое замыкание на землю. | Более 100 тыс. ом |
| ШАГ 4. | Проверьте термостат кабины (когда выводится неисправность термостата кабины Е1). |  |
|  | **STEP 4A.** Проверьте наличие открытой цепи. | Менее 10 Ом |
|  | **STEP 4B.** Проверьте короткое замыкание на землю в выходном сигнале термостата кабины. | Более 100 тыс. ом |
|  | **STEP 4C** Проверьте связь термостата с ECM. | Подтверждена связь термостата кабины с ECM |
| ШАГ 5. | Сбросьте коды неисправностей. |  |
|  | **STEP 5A.** Отключить код ошибки. | Код 469 неактивен |

### ШАГ 1. Проведите собеседование с водителем, чтобы выяснить работу системы температуры кабины, когда произошел код неисправности, и определить режим термостата кабины, температуру и параметры диапазона кабины, а также температуру наружного воздуха.

#### ШАГ 1A. Проверьте настройки термостата кабины и настройки контроля температуры кабины.

| **Условия:** Включить переключатель зажигания. Включите термостат кабины. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Убедитесь, что режим термостата кабины установлен соответствующим образом (тепло или прохлада) для настоящих условий температуры окружающего воздуха и что как точки установки теплового, так и холодного режима (диапазон) запрограммированы в термостат должным образом. (См. процедуру 209-017.) Проверить регуляторы температуры кабины (кондиционирование тепла и воздуха), чтобы убедиться, что регуляторы установлены надлежащим образом в режиме термостата кабины. | Кабина термостат установлен правильно; кабина температурных контролей работает должным образом. | 5а |
| Установите термостат кабины в соответствующий режим и температурные настройки; установите соответствующие регуляторы температуры кабины для координации с настройками термостата кабины. См. процедуру[[97-209-017 — ICON™ Idle Control System\|209-017]]и или процедур[[97-019-300 — Cab Thermostat\|019-300]]. | 2А |  |

### ШАГ 2. Прочитайте все коды ошибок.

#### ШАГ 2A. Прочитайте коды неисправностей с помощью инструментария электронного обслуживания INSITETM.

| **Условия:** Включить переключатель зажигания. Включите термостат кабины. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Прочитайте коды неисправностей с помощью инструментария электронного обслуживания INSITETM. | Коды неактивны | 5а |
| Активные коды ошибок | 2В |  |

#### ШАГ 2B. Проверьте дисплей термостата кабины на наличие кода неисправности.

| **Условия:** Включить переключатель зажигания. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| **Примечание:** Если этот сбой произошел по истечении 60 минут, и точки установки режима охлаждения или нагрева установлены должным образом, а окна и двери транспортного средства закрыты, это указывает на то, что нагреватель или кондиционер работают плохо и требуют ремонта, или изоляция в кабине **не** позволит кабине поддерживать температуру. Плохая изоляция может привести к тому, что кабина слишком быстро потеряет температуру, что приводит к перезапуску двигателя четыре раза за 1 час. Может потребоваться уменьшение экстремальной жаркой температуры (трим 1) или экстремальной холодной температуры (трим 2). Настройка отделки позволяет системе ICONTM переходить в режим непрерывного пробега, когда кабина **не** способна поддерживать температуру. | Нет активных кодов неисправностей | 3А |
| Проверьте установленные точки термостата и отрегулируйте, если это необходимо. См. процедуру[[97-019-300 — Cab Thermostat\|019-300]]или[[97-209-017 — ICON™ Idle Control System\|209-017]]. | 5а |  |
...
| Ремонт поврежденных контактов Смой грязь, мусор и влагу из контактов разъема с помощью электрического контактного очистителя, Номер детали 3824510. Ремонт контактов разъема. См. процедуру 019-202 или 019-206. | 5а |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Измерьте сопротивление от контакта 1 до контакта 2 датчика температуры окружающего воздуха. См. схему проводов или описание схемы в начале этого кода неисправности для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Технические характеристики сопротивления при соответствующей температуре окружающего воздуха: 0°C \[32°F\] = 29-36k Ом 25°C \[77°F\] = 9-11k Ом 50°C \[122°F\] = 3-4k Ом 75°C \[167°F\] = 1300-1600 Ом 100°C \[212°F\] = 600-750 Ом | 3C |
| Замените датчик температуры окружающего воздуха. См. процедуру[[97-019-134 — Ambient Air Temperature Sensor\|019-134]]. | 5а |  |
...
| Ремонт или замена проводов датчика температуры OEM. Ремонт проводов датчика температуры OEM. См. процедуру 019-202 или 019-206. Замените проводку датчика температуры OEM. См. руководство изготовителя машины по диагностике и ремонту. | 5а |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Измерьте сопротивление от контакта 1 датчика температуры проводов ремня разъема, конца датчика, к заземлению блока двигателя. Измерьте сопротивление от контакта 2 датчика температуры проводов ремня разъема, конца датчика, к блоку двигателя. См. схему проводов или описание схемы в начале этого кода неисправности для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Более 100 тыс. ом | 4А |
| Ремонт или замена проводов датчика температуры OEM. Ремонт проводов датчика температуры OEM. См. процедуру 019-202 019-206. Замените проводку датчика температуры OEM. См. руководство по устранению неполадок и ремонту OEM. | 5а |  |

### ШАГ 4. Проверьте термостат кабины (когда выводится неисправность термостата кабины Е1).

#### ШАГ 4A. Проверьте цепь на обрыв.

| **Условия:** Выключите замок зажигания. Отсоедините термостат кабины от электропроводки OEM. Отсоедините проводку OEM от ECM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Измерить сопротивление от контакта 3 проводов OEM жгута, кончика термостата кабины, до контакта 32 проводов OEM жгута, конца ECM. См. схему проводов или описание схемы в начале этого кода неисправности для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Менее 10 Ом | 4B |
| Ремонт или замена OEM проводов жгута. См. сервисное руководство изготовителя машины. | 5а |  |

#### ШАГ 4B. Проверьте короткое замыкание, чтобы заземлить в выходном сигнале термостата кабины.

| **Условия:** Выключите замок зажигания. Отсоедините термостат кабины от электропроводки OEM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Измерьте сопротивление от контакта 3 кабины термостата проводов ремня к заземлению блока двигателя. См. схему проводов или описание схемы в начале этого кода неисправности для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Более 100 тыс. ом | 4C |
| Ремонт или замена термостата кабины. Ремонт коннектора кабины термостата. См. процедуру 019-202 или 019-206. Замените термостат кабины. См. процедуру 019-300. | 5а |  |

#### ШАГ 4C. Проверьте связь термостата кабины с ECM.

| **Условия:** Включить переключатель зажигания. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| **Примечание: **Когда двухъярусный термостат запрашивает перезапуск двигателя или двигатель работает из-за перезапуска, сгенерированного в режиме комфорта кабины, на дисплее термостата вспыхнет слово «тепло» или «холод», в зависимости от режима термостата. Это мигание указывает на то, что термостат обнаружил температуру кабины, которая требует перезапуска двигателя и отправляет команду перезапустить двигатель на ECM. | Подтверждена связь термостата кабины с ECM | 5а |
| Замените термостат кабины. См. процедуру[[97-019-300 — Cab Thermostat\|019-300]]. | 5а |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Используйте INSITETM для проверки неактивности кода 469. Стирайте неактивные коды неисправностей с помощью инструментария электронного обслуживания INSITETM. | Код 469 неактивен | Ремонт завершён |
