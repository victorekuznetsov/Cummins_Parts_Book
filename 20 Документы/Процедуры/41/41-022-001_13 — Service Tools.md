...
> | **Tool Number** 3377161 | **Digital Multimeter** Used to measure voltage and resistance (ohms) in a circuit. |  |
> |---|---|---|
> | **Tool Number** CC-2800 | **Refractometer** The Fleetguard® refractometer is used to measure the charge condition of a conventional battery. |  |
> | **Tool Number** 3377193 | **Systems Analyzer/Battery Tester** Used to test the output amperage of the charging system and of the batteries. |  |
