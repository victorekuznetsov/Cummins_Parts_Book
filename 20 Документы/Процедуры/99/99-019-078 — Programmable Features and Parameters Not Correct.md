...
| Вентилятор **не **выключается. | Функция управления вентилятором не установлена должным образом. | Проверьте, все параметры функции управления вентилятором правильно установлены для автомобиля. |
