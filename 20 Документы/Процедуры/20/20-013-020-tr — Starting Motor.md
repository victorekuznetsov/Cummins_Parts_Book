...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/20/20-013-020-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/20-013-020-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/20"
...
> [!abstract] Процедура · `20-013-020-tr`
> **Двигатели:** [[41349633 — QSK19 CM2150 MCRS CPL 3666|41349633]]
> **Семейство:** QSK19
> **Входит в руководства:** [[4021592 — QSK19, QSK19 CM850 MCRS, and QSK19 CM2150 MCRS Service Manual|4021592]]
> **Секции:** Section 13 - Electrical Equipment - Group 13
> **Даты:** изменён 2016-01-07
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/20/20-013-020-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/20-013-020-tr.pdf)
...
- Отключите электрические соединения от стартового двигателя.
...
Используйте сжатый воздух, чтобы высушить стартер.

![[st800wa.png]]

Осмотрите передачу, вал и втулку на предмет износа или повреждения.

Смазать втулку моторным маслом.

> [!note] Примечание
> Трубная пробка ** должна быть удалена для смазки втулки на некоторых стартерных двигателях.
...
> [!note] Примечание
> Корпус маховика мокрого типа требует прокладок для запуска двигателя.

Установите любой прокладки или прокладки.

Установите пусковой двигатель и болты.

Используйте следующие значения крутящего момента, чтобы затянуть болты.

Момент затяжки:

Закладка Iron Flywheel

Момент затяжки:

Алюминиевый корпус Flywheel
...
>
> Use compressed air to dry the starter.
>
...
>
> **Note · Примечание**
> The pipe plug **must** be removed to lubricate the bushing on some starter motors.
>
> ### Install
>
> **WARNING · Опасно**
...
>
> **Note · Примечание**
> The wet type flywheel housing requires gaskets for the starting motor.
>
> Install any spacer or gaskets.
>
> Install the starting motor and capscrews.
>
> Use the following torque values to tighten the capscrews.
>
> Torque Value:
>
