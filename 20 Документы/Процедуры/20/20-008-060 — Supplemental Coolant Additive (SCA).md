...
> [!note] Примечание
> DCA4 совместим со всеми антифризами постоянного типа, кроме Метоксипропанола. Если используется антифриз Метокси Пропанол, уменьшите количество DCA4 на одну треть. Это позволит предотвратить потерю ингибитора из-за осадков, вызванных химической несовместимостью.
...
>
> **Note · Примечание**
> The cooling system **must** be clean before adding SCA or equivalent. Refer to Procedure [[20-008-018-tr — Cooling System|008-018]].
>
> **Note · Примечание**
