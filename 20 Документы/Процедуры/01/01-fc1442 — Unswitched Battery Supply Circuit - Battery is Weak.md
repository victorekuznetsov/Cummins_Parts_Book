...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/01-fc1442.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/01"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/01/01-fc1442.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/01-fc1442.pdf)
...
|---|---|---|
| Код неисправности: 1442 P(P): СПН: ФМИ: Лампа: Предупреждение СТО: | Аккумулятор слабый. | Никаких действий со стороны ЕКМ не предпринимается. |
...
См. Код устранения неполадок t05-1442.
