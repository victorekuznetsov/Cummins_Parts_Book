...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/01-fc1422.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/01"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/01/01-fc1422.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/01-fc1422.pdf)
...
|---|---|---|
| Код неисправности: 1422 PID(P): СПН: ФМИ: Лампа: Предупреждение СТО: | Диагностика водителя No2 выявила ошибку. | Никаких действий со стороны ЕКМ не предпринимается. Возможная потеря производительности. |

![[19803582.png]]

Железнодорожный маршрут No2 Actuator Circuit

### Описание цепи

ECM проверяет время работы рельса № 2 привода для поддержания правильной работы. Рельсовый привод № 2 приводится в действие электронным модулем управления (ECM) для управления замером топлива. Каждый топливный привод соединен с ECM посредством подачи и обратной проволоки. Электрический импульс отправляется в топливный привод от ECM на подаче провода и возвращается в ECM на обратном проводе. Каждый соленоидный клапан обычно закрыт, и он открыт только электрическим импульсом от ECM во время измерения. ECM контролирует напряжение, никакое напряжение не будет срабатывать с кодом 1422 по умолчанию и может быть вызвано шортами, открываниями или неисправным приводом привода топливного насоса в ECM.

### Расположение компонента

Водитель синхронизирующего рельса № 2 находится в ECM.
...
См. Код устранения неисправностей t05-1422
