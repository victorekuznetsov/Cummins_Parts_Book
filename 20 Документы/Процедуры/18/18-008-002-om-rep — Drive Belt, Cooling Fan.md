...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/18/18-008-002-om-rep.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/18-008-002-om-rep.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K19"
  - "двигатель/K38/K50"
...
> [!abstract] Процедура · `18-008-002-om-rep`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/18/18-008-002-om-rep.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/18-008-002-om-rep.pdf)
...
См. Процедуру[[99-018-005 — Drive Belt Tension|018-005]](напряжение диаграммы приводного ремня) в разделе V.
...
Натяжение ремня вентилятора не нужно измерять. Применяемый на этой конструкции пружинный бездельник поддерживает правильное натяжение ремня. См. процедуру[[18-100-002 — Engine Diagrams|100-002]](Диаграммы двигателя) в разделе Е для определения местоположения этого компонента.
...
>
> Refer to the Procedure [[99-018-005 — Drive Belt Tension|018-005]] (Drive Belt Tension Chart) in Section V.
>
...
>
> The tension of the fan belt does **not** need measured. The spring loaded idler used on this design maintains the correct belt tension. Refer to Procedure [[18-100-002 — Engine Diagrams|100-002]] (Engine Diagrams) in Section E for location of this component.
