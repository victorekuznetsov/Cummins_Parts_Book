...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/87-t05-773.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/87"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/87/87-t05-773.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/87-t05-773.pdf)
...
| ШАГ 4. | Проверьте калибровку. |  |
|  | **STEP 4A.** Проверить существующую калибровку. | Является ли нынешняя калибровка самой последней редакцией? |
...
|  | **STEP 5B.** Проверьте время работы топливного насоса. | Соответствует ли указанное время коду топливного насоса на табличке с данными? |
| ШАГ 6. | Очистите код ошибки. |  |
|  | **STEP 6A.** Отключить коды неисправностей. | Код 773 неактивен? |
...
#### ШАГ 4A. Проверить существующий этап калибровки программного обеспечения.

| **Условия:** Включить переключатель зажигания. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Подтвердите существующую фазу калибровки программного обеспечения. Используйте инструмент электронного обслуживания INSITETM для проверки существующего программного обеспечения для калибровки. | Представляемая калибровочная программная фаза 5.1.0.5 (0501005) или более? *Да** | 5а |
| Представляемая калибровочная программная фаза 5.1.0.5 (0501005) или более? ** НЕТ** | 6А |  |
...
| Является ли нынешняя калибровка самой последней редакцией? **NORepair:** При необходимости откалибровать ECM.[[87-019-032 — ECM Calibration Code\|См. процедуру 019-032 в разделе 19.]] | 6А |  |

### ШАГ 5. Проверьте топливный насос.

#### ШАГ 5A. Проверить топливную линию
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте время работы топливного насоса. Используйте следующую процедуру в руководстве по обслуживанию QST30, в бюллетене 4021539. См. процедуру 005-012 в разделе 5. | Указанный срок соответствует коду топливного насоса на табличке с данными? *Да** | 6А |
| Указанный срок соответствует коду топливного насоса на табличке с данными? **NORepair:** Установить время работы топливного насоса, как указано в следующем руководстве по эксплуатации QST30, Bulletin 4021539.[[57-005-012-tr — Fuel Injection Pumps, In-Line\|См. процедуру 005-012 в разделе 5.]] | 6А |  |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Отключите код неисправности. Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. С 5.1.0.5 фаза программного обеспечения, работа двигателя выше 1000 об/мин в течение 1 минуты. Проверить код 773 неактивен. | Код ошибки 773 неактивен? *Да** | 6B |
| Код ошибки 773 неактивен? **NORepair:** Возврат к шагам устранения неполадок или свяжитесь с авторизованным местом ремонта Cummins®, если все шаги были завершены и проверены снова. | 1А |  |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Inspect the fuel pump timing. Use the following procedure in QST30 Service Manual, Bulletin 4021539. Refer to Procedure 005-012 in Section 5. | Timing specified match the fuel pump code on the dataplate? **YES** | 6A |
> | Timing specified match the fuel pump code on the dataplate? **NORepair:** Set the fuel pump timing as specified in the following procedure in QST30 Service Manual, Bulletin 4021539. [[57-005-012-tr — Fuel Injection Pumps, In-Line\|Refer to Procedure 005-012 in Section 5.]] | 6A |  |
>
