...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/87-fc212.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/87"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/87/87-fc212.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/87-fc212.pdf)
...
|---|---|---|
| Код неисправности: 212 P(P): P175 SPN: 175 ФМИ: 3 лампы: Желтая СТО: | Высокое напряжение, обнаруженное при температурном масляном сигнале, контактирует 35 проводов двигателя с ремнем. | Электронный модуль управления (ECM) не выполняет никаких действий. |
...
Датчик температуры масла расположен в масляной панели на левой стороне двигателя. Датчик температуры масла только на двигателях с CENSETM.
