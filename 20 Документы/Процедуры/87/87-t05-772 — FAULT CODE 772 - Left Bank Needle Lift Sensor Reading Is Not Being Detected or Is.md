...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/87-t05-772.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/87"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/87/87-t05-772.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/87-t05-772.pdf)
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте время работы топливного насоса. Используйте следующую процедуру в руководстве по обслуживанию QST30, в бюллетене 4021539. См. процедуру 005-012 в разделе 5. | Соответствует ли указанное время коду топливного насоса на табличке с данными? *Да** | 6А |
| Соответствует ли указанное время коду топливного насоса на табличке с данными? **NORepair:** Установить время работы топливного насоса, как указано в следующем руководстве по эксплуатации QST30, Bulletin 4021539.[[57-005-012-tr — Fuel Injection Pumps, In-Line\|См. процедуру 005-012 в разделе 5.]] | 6А |  |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Inspect the fuel pump timing. Use the following procedure in QST30 Service Manual, Bulletin 4021539. Refer to Procedure 005-012 in Section 5. | Does the timing specified match the fuel pump code on the dataplate? **YES** | 6A |
> | Does the timing specified match the fuel pump code on the dataplate? **NORepair:** Set the fuel pump timing as specified in the following procedure in QST30 Service Manual, Bulletin 4021539. [[57-005-012-tr — Fuel Injection Pumps, In-Line\|Refer to Procedure 005-012 in Section 5.]] | 6A |  |
>
