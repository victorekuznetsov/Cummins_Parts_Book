...
Прикосновение к одному из мультиметров приводит к проводу питания датчика, контакту 1 (или A), к разъему разъёма проводов датчика температуры на конце датчика температуры окружающего воздуха проводов.
