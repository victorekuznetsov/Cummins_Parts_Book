---
aliases:
  - "Цепь электромагнита форсунки цилиндра 1 — ток ниже нормы или обрыв"
type: "Процедура"
doc: "82-fc322"
title_en: "Injector Solenoid Driver Cylinder 1 Circuit - Current Below Normal or Open Circuit"
title_ru: "Цепь электромагнита форсунки цилиндра 1 — ток ниже нормы или обрыв"
modified: "2015-05-20"
engines:
  - "41343322"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/82/82-fc322.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/82-fc322.pdf"
tags:
  - "документ/процедура"
  - "двигатель/NT/NTA855"
  - "группа/82"
...
> [!abstract] Процедура · `82-fc322`
> **Двигатели:** [[41343322 — NH NT 855 CPL 3362|41343322]]
> **Семейство:** NT/NTA855 · ISM/QSM11
> **Входит в руководства:** [[3666266 — ISM and QSM11 Electronic Control System Troubleshooting and Repair Manual|3666266]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2015-05-20
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/82/82-fc322.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/82-fc322.pdf)
...
|---|---|---|
| Код неисправности: 322 P(P): S006 SPN: 656 FMI: 5/5 лампы: Янтарная СРТ: | Цепь электромагнита форсунки цилиндра 1 — ток ниже нормы или обрыв. Ток, обнаруживаемый на топливной форсунке № 1, при выключенном напряжении. | Ток к топливному форсунке отключается. Двигатель может неправильно работать или работать грубо. |

![[19r00284.png]]

форсунка Solenoid Driver Cylinder 1 Circuit

### Описание цепи

Соленоидные клапаны форсунки приводятся в действие модулем управления двигателем (ECM) для управления замером и временем расхода топлива. Каждый соленоид форсунки соединен с ECM проводом SUPPLY и RETURN. Электрический импульс отправляется в форсунка из ECM на проводе SUPPLY и возвращается на провод RETURN после приведения в действие соленоида. Каждый соленоидный клапан обычно открыт, и он закрыт только электрическим импульсом от ECM во время впрыска топлива и измерения. Спецификация соленоидного сопротивления составляет от 0,5 до 1,5 Ом.
...
См. Код устранения неполадок t05-322
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 322 PID(P): S006 SPN: 656 FMI: 5/5 Lamp: Amber SRT: | Injector Solenoid Driver Cylinder 1 Circuit - Current Below Normal or Open Circuit. Current detected at injector number 1 when voltage is turned off. | The current to the injector is shut off. The engine can possibly misfire or run rough. |
>
> Injector Solenoid Driver Cylinder 1 Circuit
>
> ### Circuit Description
>
> The injector solenoid valves are actuated by the engine control module (ECM) to control fuel metering and timing. Each injector solenoid is connected to the ECM by a SUPPLY and a RETURN wire. An electrical pulse is sent to the injector from the ECM on the SUPPLY wire and it returns on the RETURN wire after actuating the solenoid. Each solenoid valve is normally open, and it is **only** closed by an electrical pulse from the ECM during fuel injection and metering. The solenoid resistance specification is between 0.5 and 1.5 ohms.
>
> ### Component Location
>
...
>
> The ECM detects that the injector circuit is shorted to ground, high injector solenoid resistance, or an open circuit.
>
...
>
> Refer to Troubleshooting Fault Code t05-322
