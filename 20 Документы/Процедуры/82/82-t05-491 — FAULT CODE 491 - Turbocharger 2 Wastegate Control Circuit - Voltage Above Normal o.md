---
aliases:
  - "Код 491 — цепь управления перепускным клапаном турбины 2 — напряжение выше нормы"
type: "Процедура"
doc: "82-t05-491"
title_en: "FAULT CODE 491 - Turbocharger 2 Wastegate Control Circuit - Voltage Above Normal or Shorted to High Source"
title_ru: "Код 491 — цепь управления перепускным клапаном турбины 2 — напряжение выше нормы"
modified: "2012-09-27"
engines:
  - "41343322"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/82/82-t05-491.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/82-t05-491.pdf"
tags:
  - "документ/процедура"
  - "двигатель/NT/NTA855"
  - "группа/82"
...
# FAULT CODE 491 - Turbocharger 2 Wastegate Control Circuit - Voltage Above Normal or Shorted to High Source
**Код 491 — цепь управления перепускным клапаном турбины 2 — напряжение выше нормы**

> [!abstract] Процедура · `82-t05-491`
> **Двигатели:** [[41343322 — NH NT 855 CPL 3362|41343322]]
> **Семейство:** NT/NTA855 · ISM/QSM11
> **Входит в руководства:** [[3666266 — ISM and QSM11 Electronic Control System Troubleshooting and Repair Manual|3666266]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2012-09-27
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/82/82-t05-491.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/82-t05-491.pdf)
...
|  | **ШАГ 1В.** Проверьте короткое замыкание при контакте. | Больше 100 тысяч ом? |
...
|  | **STEP 3A.** Отключить код ошибки. | Код 491 неактивен? |
...
| **Условия:** Выключите замок зажигания. Отсоедините электропроводку двигателя от привода 2 обходного клапана турбины. Отсоедините разъем электропроводки привода от ECM. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Осмотрите контактные линзы электропроводки привода и разъема ECM на предмет: Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема разъема или разбитые штифты Разъем или разъем разъема разъема разъема или разъема разъема контактной оболочки разбитого провода Повреждение блокировки вкладки разъема. Используйте соответствующую схему или схему проводов для идентификации контакта с разъемом. Используйте следующую процедуру для общих методов проверки.[[99-019-361 — Component Connector and Pin Inspection\|См. процедуру 019-361 в разделе 19.]] | Грязные или поврежденные контакты? *** Ремонт:** Ремонт или замена ремня электропроводки двигателя или замена ECM, в зависимости от того, какие контакты повреждены. Смой грязь, мусор или влагу из контактов разъема. Используйте электрическую контактную очистку, номер детали 3824510. Установите соответствующий уплотнитель разъема, если он поврежден или отсутствует. Ремонт ремня электропроводки двигателя. См. процедуру 019-204 в разделе 19. Замените жгут проводов двигателя. См. процедуру 019-043 в разделе 19. Заменить ECM. См. процедуру 019-031 в разделе 19. | 3А |
| Грязные или поврежденные контакты? ** НЕТ** | 1В |  |

#### ШАГ 1B. Проверьте короткое замыкание контакт-контакт.

| **Условия:** Выключите замок зажигания. Отсоедините разъем электропроводки привода от ECM. Отсоедините электропроводку двигателя от привода 2 обходного клапана турбины. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте короткое замыкание контакт-контакт. Измерьте сопротивление от контакта 23 в разъёме проводов привода к другим штифтам в разъёме. Используйте следующую процедуру для общих методов измерения сопротивления.[[99-019-359 — Multimeter Usage\|См. процедуру 019-359 в разделе 19.]] | Больше 100 тысяч ом? *Да** | 1С |
...
| **Условия:** Включить переключатель зажигания. Отсоедините разъем электропроводки привода от ECM. Отсоедините электропроводку двигателя от привода 2 обходного клапана турбины. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте короткое замыкание на аккумуляторе. Измерьте напряжение от контакта 2 (или B) на разъеме привода газотурбинного клапана с блоком двигателя. Используйте следующую процедуру для общих методов измерения сопротивления.[[99-019-359 — Multimeter Usage\|См. процедуру 019-359 в разделе 19.]] | Меньше (+) 1,5-VDC? *Да** | 2А |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте разъем привода привода турбинного обходного клапана на предмет: Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема разъема или разбитые штифты Разъем или разъем разъема разъема разъема или разъема разъема контактной оболочки разбитого провода Повреждение блокировки вкладки разъема. Используйте соответствующую схему или схему проводов для идентификации контакта с разъемом. Используйте следующую процедуру для общих методов проверки.[[99-019-361 — Component Connector and Pin Inspection\|См. процедуру 019-361 в разделе 19.]] | Грязные или поврежденные контакты? *** Ремонт:** Ремонт терминала разъема привода. Смой грязь, мусор или влагу из контактов разъема. Используйте электрическую контактную очистку, номер детали 3824510. Установите соответствующее уплотнение разъема, если оно повреждено или отсутствует. Ремонт разъема привода. См. процедуру 019-197 в разделе 19. | 3А |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте соленоидный пост на коррозию. | Коррозия обнаружена на соленоидном посту? *** Ремонт:** Очистить соленоидный пост. | 3А |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Отключите код неисправности. Использование инструментария электронного сервиса INSITETM для проверки неактивности кода 491 по умолчанию. | Код 491 неактивен? *Да** | 3B |
| Код 491 неактивен? **NORepair:** Возврат к шагам устранения неполадок или свяжитесь с авторизованным местом ремонта Cummins®, если все шаги были завершены и проверены снова. | 1А |  |
...
| Все коды неисправностей очищены? ** НЕТ** | Устранение неполадок с оставшимися активными кодами неисправностей. |  |
...
> |  | **STEP 3A.** Disable the fault code. | Fault Code 491 inactive? |
...
>
> | **Conditions:** Turn keyswitch OFF. Disconnect the engine harness from the wastegate actuator number 2. Disconnect the actuator harness connector from the ECM. |  |  |
> |---|---|---|
...
>
> | **Conditions:** Turn keyswitch OFF. Disconnect the actuator harness connector from the ECM. Disconnect the engine harness from the wastegate actuator 2. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for a pin-to-pin short circuit. Measure the resistance from pin 23 in the actuator harness connector to all other pins in the connector. Use the following procedure for general resistance measurement techniques. [[99-019-359 — Multimeter Usage\|Refer to Procedure 019-359 in Section 19.]] | Greater than 100k ohms? **YES** | 1C |
...
>
> | **Conditions:** Turn keyswitch ON. Disconnect the actuator harness connector from the ECM. Disconnect the engine harness from the wastegate actuator 2. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for a short circuit to the battery. Measure the voltage from pin 2 (or B) on the wastegate actuator connector to engine block ground. Use the following procedure for general resistance measurement techniques. [[99-019-359 — Multimeter Usage\|Refer to Procedure 019-359 in Section 19.]] | Less than (+) 1.5-VDC? **YES** | 2A |
...
>
> | **Conditions:** Turn keyswitch OFF. Disconnect the engine harness from the wastegate actuator 2. Disconnect the actuator harness connector from the ECM. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the wastegate actuator connector for the following: Loose connector Corroded pins Bent or broken pins Pushed back or expanded pins Moisture in or on the connector Missing or damaged connector seals Dirt or debris in or on the connector pin Connector shell broken Wire insulation damage Damaged locking tab connector. Use the appropriate circuit or wiring diagram for connector pin identification. Use the following procedure for general inspection techniques. [[99-019-361 — Component Connector and Pin Inspection\|Refer to Procedure 019-361 in Section 19.]] | Dirty or damaged pins? **YESRepair:** Repair the actuator connector terminal. Flush the dirt, debris, or moisture from the connector pins. Use electrical contact cleaner, Part Number 3824510. Install the appropriate connector seal if is is damaged or missing. Repair the actuator connector. Refer to Procedure 019-197 in Section 19. | 3A |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the solenoid post for corrosion. | Corrosion found on solenoid post? **YESRepair:** Clean the solenoid post. | 3A |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Disable the fault code. Use INSITE™ electronic service tool to verify Fault Code 491 is inactive. | Fault Code 491 inactive? **YES** | 3B |
> | Fault Code 491 inactive? **NORepair:** Return to the troubleshooting steps or contact a Cummins® Authorized Repair Location if all steps have been completed and checked again. | 1A |  |
>
