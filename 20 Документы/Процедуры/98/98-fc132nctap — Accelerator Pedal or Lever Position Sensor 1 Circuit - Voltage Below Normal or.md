...
type: "Процедура"
doc: "98-fc132nctap"
title_en: "Accelerator Pedal or Lever Position Sensor 1 Circuit - Voltage Below Normal or Shorted to Low Source"
modified: "2021-09-15"
engines:
  - "37269910"
  - "37280605"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/98/98-fc132nctap.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/98-fc132nctap.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K19"
  - "группа/98"
...
> [!abstract] Процедура · `98-fc132nctap`
> **Двигатели:** [[37269910 — K19 CPL 1253|37269910]], [[37280605 — K19 CPL 447|37280605]]
> **Семейство:** K19
> **Входит в руководства:** [[3666070 — CENTRY™ Electronic Control System Troubleshooting and Repair Manual|3666070]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2021-09-15
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/98/98-fc132nctap.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/98-fc132nctap.pdf)
...
### Код неисправности: 132-nctap

### Педаль ускорителя или датчик положения рычага 1 - напряжение ниже нормального или короткое до низкого источника
...
|---|---|---|
| Код неисправности: 132-nctap PID(P): P91 SPN: ФМИ: 7 ламп: Флешинг SRT: 00-622 | Низкое напряжение, обнаруженное в цепи сигнала положения дроссельной заслонки. | Возможно снижение производительности двигателя. |

![[19802318.png]]

Сенсорная схема положения дроссельной заслонки (Non-CELECTTM Type Accelerator Pedal)

### Описание цепи

Датчик положения дроссельной заслонки представляет собой датчик переменного сопротивления, используемый ECM для мониторинга команды дроссельной заслонки. Этот датчик имеет три схемы: 5-вольтная цепь подачи, возврата и сигнала. Напряжение цепи сигнала указывает положение датчика положения дроссельной заслонки.
...
Модуль управления двигателем (ECM) обнаружил, что напряжение сигнала на цепи датчика положения дроссельной заслонки находится вне диапазона низкого.
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 132-nctap PID(P): P91 SPN: FMI: 7 Lamp: Flashing SRT: 00-622 | Low voltage detected at throttle position signal circuit. | Possible reduced engine performance. |
>
...
>
> The Engine Control Module (ECM) detected the signal voltage on the throttle position sensor circuit is out of range low.
>
