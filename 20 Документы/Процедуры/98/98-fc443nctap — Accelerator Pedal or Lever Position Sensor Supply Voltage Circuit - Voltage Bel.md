...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/98/98-fc443nctap.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/98-fc443nctap.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K19"
  - "группа/98"
...
> [!abstract] Процедура · `98-fc443nctap`
> **Двигатели:** [[37269910 — K19 CPL 1253|37269910]], [[37280605 — K19 CPL 447|37280605]]
> **Семейство:** K19
> **Входит в руководства:** [[3666070 — CENTRY™ Electronic Control System Troubleshooting and Repair Manual|3666070]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2021-09-15
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/98/98-fc443nctap.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/98-fc443nctap.pdf)
...
|---|---|---|
| Код неисправности: 443-nctap PID(P): S254 SPN: ФМИ: 4 лампы: Флешинг SRT: 00-637 | Низкое напряжение, обнаруженное на подаче датчика для схемы датчика положения дроссельной заслонки. | Возможно снижение производительности двигателя. |
...
Расположение датчика положения дроссельной заслонки варьируется в зависимости от каждого OEM.
...
Модуль управления двигателем (ECM) обнаружил, что подачу датчика к датчику положения дроссельной заслонки было за пределами диапазона.
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 443-nctap PID(P): S254 SPN: FMI: 4 Lamp: Flashing SRT: 00-637 | Low voltage detected at the sensor supply for the throttle position sensor circuit. | Possible reduced engine performance. |
>
