...
### Код неисправности: 633

### Отклонение температуры выхлопных газов от низкого для цилиндра 6 - данные действительны, но ниже нормального диапазона работы - наименее тяжелый уровень
...
|---|---|---|
| Код неисправности: 633 P(P): СПН: 1328 FMI: 0/17 Лампа: Обслуживание SRT: | Отклонение температуры выхлопного газа для цилиндра 6 - данные действительны, но ниже нормального рабочего диапазона - наименее тяжелый уровень. | Возможно, низкая мощность. Отсутствие защиты двигателя от температуры выхлопных газов. |

![[19903744.png]]

Цилиндр 6 для датчиков температуры выхлопных газов - двигатели QSK45 и QSK60

### Описание цепи

Цилиндр 6 схемы датчика температуры выхлопных газов контролирует температуру выхлопных газов и передает информацию модулю управления двигателем (ECM) через электропроводку двигателя.

### Расположение компонента

Цилиндр 6 схемы датчика температуры выхлопных газов для этого кода неисправности расположен в выпускном коллекторе на головке 6 цилиндра к интерфейсу выхлопного коллектора.
...
Схема цилиндра 6 датчика температуры выхлопных газов измеряет температуру выхлопных газов цилиндра 6. ECM контролирует температуру и сравнивает ее с температурой выхлопных газов других цилиндров.
...
- Повреждены, клапаны, кольца или поршень.

- Повреждение форсунки.

См. Код устранения неполадок t05-633.
