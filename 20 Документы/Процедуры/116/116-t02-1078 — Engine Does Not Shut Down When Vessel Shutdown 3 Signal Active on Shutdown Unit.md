...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1078.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1078.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1078.pdf)
...
- SDU410 не отключает двигатель с сигналом 3, активным при подключении OEM X6.
...
|  | **STEP 2A.** Проверить сигнал 3 и возврат проводов на наличие открытого соединения X6. | Менее 10 Ом? |
...
#### ШАГ 2A. Проверьте сигнал 3 и верните провода для открытия соединения X6.

| **Условия: ** Откройте окно интерфейса клиента Отключите сигнал 3 сигнала и верните провода на OEM X6 соединение. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте сигнал 3 и верните провода для открытия соединения X6. Поместите один испытательный щуп на сигнальный провод 3 в разъем X6. Поместите другой испытательный щуп на сигнальный провод 3 сигнала в OEM-соединение. Поместите один испытательный щуп на провод возврата сигнала 3 на разъем X6. Поместите другой испытательный щуп на провод возврата сигнала 3 в OEM-соединение. См. соответствующую схему или схему проводов для идентификации соединительного штифта. | Менее 10 Ом? *Да** | Ремонт завершён |
