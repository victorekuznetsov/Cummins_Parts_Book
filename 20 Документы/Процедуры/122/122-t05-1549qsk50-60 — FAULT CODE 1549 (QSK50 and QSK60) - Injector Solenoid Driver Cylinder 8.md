...
> [!warning] ОСТОРОЖНО
> Чтобы уменьшить вероятность повреждения нового модуля витка двигателя (ECM), все другие активные коды неисправностей должны быть исследованы до замены ECM.

> [!warning] ОСТОРОЖНО
> Чтобы не повредить контакты и жгут, при измерениях пользуйтесь следующими измерительными проводами: Номер детали 3824811 - пробник типа plug-type DeutschTMtest, номер детали 3824812 - пробный щуп типа socket DeutschTM, номер детали 3822758 - пробный щуп типа plug-type DeutschTM/AMPTM/Metri-PackTM, а номер детали 3822917 - пробный щуп типа socket DeutschTM/AMPTM/Metri-PackTM.
...
|  | **ШАГ 1А.** Прочитайте коды неисправностей с помощью инструментария электронного обслуживания INSITETM. | Код ошибки 1557, 323 или 1549 активен? |
...
| Управляйте двигателем и соблюдайте коды неисправностей. Используйте инструмент электронного сервиса INSITETM для очистки кодов неисправностей. Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Используйте инструмент электронного сервиса INSITETM для очистки кодов неисправностей. | Код ошибки 1549, 1557 или 323 активен? *Да** | 1В |
| Код ошибки 1549, 1557 или 323 активен? ** НЕТ** | Используйте следующую процедуру для неактивного или прерывистого кода неисправности.[[99-019-362 — Inactive or Intermittent Fault Code\|См. процедуру 019-362 в разделе 19.]] |  |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Управляйте двигателем и соблюдайте коды неисправностей. Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | *** Действует только код 1549 ошибки. *** Заменить ЭКМ. См. процедуру 019-031 в разделе 19. | 4А |
...
| **Условия:** Выключите замок зажигания. Отсоедините разъёмы жгута проводов двигателя от топливных форсунок соленоидного цилиндра водителя 8, 16 и 5 разъемов. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Осмотрите проводку двигателя и форсунка соленоидного цилиндра водителя 8, 16 и 5 соединительных контактов для следующих целей: Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема разъема или разбитые штифты Разъем или изоляция Поврежденные штифты блокировки разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема или изоляции Разъем разъема разъема разъема разъема разъема разъема разъема разъема разъема разъема разъ Используйте следующую процедуру для общих методов проверки.[[99-019-361 — Component Connector and Pin Inspection\|См. процедуру 019-361 в разделе 19.]] | Грязные или поврежденные контакты? *** Ремонт:** Очистить разъем и штифты. Заменить поврежденный участок проводов ремня или поврежденный форсунка (форсунки). См. схему или схему проводов для всех соединений проводов. Ремонт ремня электропроводки двигателя. См. процедуру 019-043 в разделе 19. Заменить поврежденный форсунка. Используйте следующие процедуры из руководства по обслуживанию K38, K50, QSK38 и QSK50, вестник 4021528. См. процедуру 006-026 в разделе 6. Используйте следующую процедуру из руководства по обслуживанию QSK45 и QSK60, Бюллетень 4021530. См. процедуру 006-026 в разделе 6. | 4А |
...
| **Условия:** Выключите замок зажигания. Отсоедините форсунка соленоидного драйвера 8, 16 и 5 разъемов от разъемов жгута электропроводки двигателя. Отсоедините разъем жгута проводов двигателя от разъема цоколя ECM 60. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
...
| **Условия:** Выключите замок зажигания. Отсоедините разъем жгута проводов двигателя от разъема цоколя ECM 60. Отсоедините форсунка соленоидный цилиндр 8, 16 и 5 от разъемов жгута электропроводки двигателя. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте короткое замыкание на землю. Измерить сопротивление от форсунки соленоидного цилиндра водителя 8 сигнального контакта на ЭКМ 60 штифтового разъёма проводов двигателя упряжка к блоку двигателя грунт. Повторите проверку на цилиндре 16 SIGNAL для водителя соленоида форсунки и на цилиндре 5 SIGNAL для водителя соленоида форсунки. Измерить сопротивление от форсунки соленоидного цилиндра водителя 8 обратного контакта на ЭКМ 60 штифтового разъёма проводов двигателя упряжка к блоку двигателя грунт. Повторите проверку для форсунки соленоидного цилиндра 16 ВПЕРЕД и форсунки соленоидного цилиндра 5 ВПЕРЕД. См. схему или схему проводов для идентификации контакта с разъемом. Используйте следующую процедуру для общих методов измерения сопротивления.[[99-019-360 — Resistance Measurement Using a Multimeter\|См. процедуру 019-360 в разделе 19.]] | Больше 100 тысяч ом? *Да** | 3С-2 |
