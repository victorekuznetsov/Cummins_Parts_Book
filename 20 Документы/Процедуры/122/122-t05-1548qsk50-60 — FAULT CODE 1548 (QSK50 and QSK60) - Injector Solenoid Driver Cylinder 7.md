---
aliases:
  - "Код 1548 (QSK50/QSK60) — цепь электромагнита форсунки цилиндра 7 — ток ниже нормы или обрыв"
type: "Процедура"
doc: "122-t05-1548qsk50-60"
title_en: "FAULT CODE 1548 (QSK50 and QSK60) - Injector Solenoid Driver Cylinder 7 Circuit - Current Below Normal or Open Circuit"
title_ru: "Код 1548 (QSK50/QSK60) — цепь электромагнита форсунки цилиндра 7 — ток ниже нормы или обрыв"
modified: "2019-06-04"
engines:
  - "33239746"
  - "33239899"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/122/122-t05-1548qsk50-60.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/122-t05-1548qsk50-60.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K38/K50"
  - "группа/122"
...
> [!abstract] Процедура · `122-t05-1548qsk50-60`
> **Двигатели:** [[33239746 — QSK60 CM2150 MCRS CPL 3451|33239746]], [[33239899 — QSK50 CM2150 MCRS CPL 3379|33239899]]
> **Семейство:** K38/K50 · QSK38, QSK50, QSK60
> **Входит в руководства:** [[4022102 — QSK38, QSK50, and QSK60 CM2150 Electronic Control System Troubleshooting and Repair M|4022102]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2019-06-04
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/122/122-t05-1548qsk50-60.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/122-t05-1548qsk50-60.pdf)
...
> [!warning] ОСТОРОЖНО
> Чтобы не повредить контакты и жгут, при измерениях пользуйтесь следующими измерительными проводами: Номер детали 3824811 - пробный щуп типа вилки DeutschTM, номер детали 3824812 - пробный щуп типа вилки DeutschTM, номер детали 3822758 - пробный щуп типа вилки DeutschTM/AMPTM/Metri-PackTM и номер детали 3822917 - пробный щуп типа вилки DeutschTM/AMPTM/Metri-PackTM.
...
|  | **ШАГ 1А.** Прочитайте коды неисправностей с помощью инструментария электронного обслуживания INSITETM. | Код ошибки 1548, 325 или 1555 активен? |
|  | **ШАГ 1В.** Прочитайте коды неисправностей с помощью инструментария электронного обслуживания INSITETM. | *** Код 1548 неисправности активен. |
...
|  | **ШАГ 2Е.** Прочитайте коды ошибок. | *** Код 1548 неисправности активен. |
...
| Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Используйте инструмент электронного сервиса INSITETM для очистки кодов неисправностей. | Код ошибки 1548, 325 или 1555 активен? *Да** | 1В |
| Код ошибки 1548, 325 или 1555 активен? ** НЕТ** | Используйте следующую процедуру для неактивного или прерывистого кода неисправности.[[99-019-362 — Inactive or Intermittent Fault Code\|См. процедуру 019-362 в разделе 19.]] |  |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | *** Код ошибки 1548 активен. *Да** | 2А |
| *** Код ошибки 1548 активен. ** НЕТ** | 1С |  |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Активны коды разломов топливных форсунок? *Да** | 3А |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Убедитесь, что следующие соединения жгутов проводов для проводов двигателя правильно сделаны: Упряжка для проводов двигателя, подключенная к электропроводке двигателя ECM, подключенная к топливному форсунке соленоидного цилиндра 7 водителя. | Подключатели правильно подключены? *Да** | 2А-1-1 |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Управляйте двигателем и соблюдайте коды неисправностей. Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Используйте инструмент электронного сервиса INSITETM для очистки кодов неисправностей. | *** Код 1548 неисправности активен. *** Заменить ЭКМ. См. процедуру 019-031 в разделе 19. | 4А |
| *** Код 1548 неисправности активен. ** НЕТ** | 4А |  |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Осмотрите проводку двигателя и форсунка соленоидного цилиндра 7, 6 и 14 разъемных контактов для следующих целей: Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема разъема или разбитые штифты Отталкивание или разъем разъема Разъема разъема или изоляция Повреждение разъема блокировки вкладки. Используйте следующую процедуру для общих методов проверки.[[99-019-361 — Component Connector and Pin Inspection\|См. процедуру 019-361 в разделе 19.]] | Грязные или поврежденные контакты? *** Ремонт:** Очистить разъем и штифты. Заменить поврежденный участок проводов ремня или поврежденный форсунка (форсунки). См. схему или схему проводов для всех соединений проводов. Ремонт ремня электропроводки двигателя.[[122-019-043 — Engine Wiring Harness\|См. процедуру 019-043 в разделе 19.]]Заменить поврежденный форсунка. Используйте следующую процедуру из руководства по обслуживанию K38, K50, QSK38 и QSK50, Вестник 4021528.[[28-006-026-tr — Injector\|См. процедуру 006-026 в разделе 6.]]Используйте следующую процедуру из руководства по обслуживанию QSK45 и QSK60, Бюллетень 4021530. См. процедуру 006-026 в разделе 6. | 4А |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте короткое замыкание на землю. Измерить сопротивление от форсунки соленоидного цилиндра 7 водителя сигнальному контакту на ЭКМ 60 штифтового разъёма проводов двигателя упряжка к блоку двигателя грунт. Повторите проверку на топливном форсунке соленоидного цилиндра водителя 6 SIGNAL и топливном форсунке соленоидного цилиндра водителя 14 SIGNAL штифтов. Измерить сопротивление от форсунки соленоидного цилиндра 7 водителя обратному контакту на ЭКМ 60 штифтового разъёма проводов двигателя упряжка к блоку двигателя грунт. Повторите проверку для форсунки соленоидного цилиндра водителя 6 ВПЕРЕД и форсунки соленоидного цилиндра водителя 14 ВПЕРЕД. См. схему или схему проводов для идентификации контакта с разъемом. Используйте следующую процедуру для общих методов измерения сопротивления.[[99-019-360 — Resistance Measurement Using a Multimeter\|См. процедуру 019-360 в разделе 19.]] | Больше 100 тысяч ом? *Да** | 3С-2 |
...
| Все коды неисправностей очищены? ** НЕТ** | 1А |  |
...
> | Fault Code 1548, 325, or 1555 active? **NO** | Use the following procedure for inactive or intermittent fault code. [[99-019-362 — Inactive or Intermittent Fault Code\|Refer to Procedure 019-362 in Section 19.]] |  |
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Operate the engine and observe the fault codes. Start the engine and let it idle for 1 minute. Use INSITE™ electronic service tool to clear the fault codes. | **Only** Fault Code 1548 is active? **YESRepair:** Replace the ECM. Refer to Procedure 019-031 in Section 19. | 4A |
...
>
> | **Conditions:** Turn the keyswitch OFF. Disconnect the injector solenoid driver cylinder 7, 6, and 14 connectors from the engine harness connectors. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
...
>
> | **Conditions:** Turn the keyswitch OFF. Disconnect the engine harness connector from the ECM 60 pin connector. Disconnect the injector solenoid driver cylinder 7, 6, and 14 connectors from the engine harness connectors. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
