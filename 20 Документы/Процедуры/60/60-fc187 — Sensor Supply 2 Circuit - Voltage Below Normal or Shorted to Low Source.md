...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc187.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/60"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/60/60-fc187.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc187.pdf)
...
|---|---|---|
| Код неисправности: 187 PID(P): S211 SPN: 3510 FMI: 4/4 лампы: Янтарная СРТ: | Низкое напряжение, обнаруженное на цепи питания датчика 2. | Возможные снижение производительности двигателя, выключение или потеря защиты двигателя. |
...
Модуль управления двигателем (ECM) обнаружил, что напряжение сигнала датчика питания 2 было вне диапазона низкого.
...
См. Код 187 устранения неполадок.
