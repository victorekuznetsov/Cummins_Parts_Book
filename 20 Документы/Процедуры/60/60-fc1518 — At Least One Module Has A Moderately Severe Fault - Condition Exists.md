...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc1518.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/60"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/60/60-fc1518.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc1518.pdf)
...
|---|---|---|
| Код неисправности: 1518 P(P): S254 SPN: 1484 FMI: 11/31 лампа: Янтарная СРТ: | Умеренно серьезный код неисправности был обнаружен по меньшей мере одним модулем. | Возможно снижение производительности двигателя. |
...
Модуль управления двигателем (ECM) - это компьютер, который отвечает за управление двигателем, диагностику и функции пользователя. Код с умеренно серьезными ошибками был обнаружен в сети шины данных J1939 CAN.
...
Модуль управления двигателем (ECM) обнаружил один или несколько умеренно серьезных дефектов.
...
- Умеренно тяжелый код неисправности, обнаруженный на другой ECM

См. Код 1518 устранения неполадок.
