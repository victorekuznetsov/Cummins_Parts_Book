---
aliases:
  - "Цепь датчика давления коллектора 1 — напряжение ниже нормы"
type: "Процедура"
doc: "60-fc1384"
title_en: "Intake Manifold 1 Pressure Sensor Circuit - Voltage Below Normal or Shorted to Low Source"
title_ru: "Цепь датчика давления коллектора 1 — напряжение ниже нормы"
modified: "2020-09-28"
engines:
  - "37292556"
  - "37295879"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/60/60-fc1384.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc1384.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/60"
...
> [!abstract] Процедура · `60-fc1384`
> **Двигатели:** [[37292556 — QST30 CM552 CPL 1244|37292556]], [[37295879 — QST30 CM552 CPL 2139|37295879]]
> **Семейство:** QST30
> **Входит в руководства:** [[4021674 — QST30 CM850 Power Generation Interface Engine Electronic Control System Troubleshooti|4021674]]
> **Секции:** Section TF — Troubleshooting Fault Codes
> **Даты:** изменён 2020-09-28
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/60/60-fc1384.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc1384.pdf)
...
|---|---|---|
| Код неисправности: 1384 PID(P): P102 SPN: 102 FMI: 4/4 лампы: Обслуживание SRT: | Низкое напряжение сигнала, обнаруженное на цепи датчика давления впускного коллектора 1. | Возможно снижение производительности двигателя. |
...
Модуль управления двигателем (ECM) обнаружил, что напряжение сигнала датчика давления 1 впускного коллектора находится вне диапазона низкого.
...
См. Troubleshooting Fault Code 1384.
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 1384 PID(P): P102 SPN: 102 FMI: 4/4 Lamp: Maintenance SRT: | Low signal voltage detected at the intake manifold 1 pressure sensor circuit. | Possible reduced engine performance. |
>
...
>
> The Engine Control Module (ECM) detected the intake manifold 1 pressure sensor signal voltage is out of range low.
>
...
>
> Refer to Troubleshooting Fault Code 1384.
