...
9. Запорный клапан охлаждающей жидкости
10. Стартер
11. Картер маховика
12. Маслоохладитель
...
1. Датчик температуры коллектора
...
8. Исполнительный механизм топливного насоса
9. Датчик давления аккумулятора
...
QSK19 CM2150 Модульная система общего доступа к железнодорожным системам Морские датчики
...
8. Датчик индикатора "вода в топливе"
9. Датчик температуры топлива 1
10. рельс измерения давления форсунки 1
11. Датчик скорости/положения вала двигателя
12. Датчик температуры охлаждающей жидкости двигателя 1.


> [!quote]- Original (English) · английский оригинал
> ### Engine Views
>
> The following illustrations provide the locations of the major external engine components, filters, and other service and maintenance points. Some external components will be at different locations for different engine models.
>
> **Note · Примечание**
> The illustrations are **only** a reference to show a typical engine.
>
> QSK19 CM2150 Modular Common Rail System Industrial and Power Generation, Exhaust Side View
>
...
> 7. Coolant inlet
> 8. Coolant filter
> 9. Coolant shutoff valve
> 10. Starting motor
> 11. Flywheel housing
> 12. Oil cooler
> 13. Coolant supply to turbocharger.
>
> QSK19 CM2150 Modular Common Rail System Industrial and Power Generation, Intake Side View
>
> 1. Five bar air bleed check valve
> 2. Oil fill location
> 3. Engine control module (ECM)
> 4. Oil filters
> 5. Dipstick
> 6. Fuel filter 2nd stage
...
> 9. Accumulator pressure sensor
> 10. Camshaft position sensor
> 11. Coolant temperature sensor
> 12. Intake manifold port.
>
> QSK19 CM2150 Modular Common Rail System Marine Sensor Locations
>
