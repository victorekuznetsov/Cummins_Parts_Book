...
figures: 30
lang: "en"
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/40/40-006-051-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/40-006-051-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/6B5.9"
  - "группа/40"
...
> [!abstract] Процедура · `40-006-051-tr`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/40/40-006-051-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/40-006-051-tr.pdf)
...
> Keep hands and body parts away from the high-pressure fuel lines. Fuel coming from the high-pressure fuel lines is under extreme pressure and can cause serious injury by penetrating the skin.
...
If the air can **not** be removed, check the pump and supply line for suction leaks. Refer to [[40-006-003-tr — Air in Fuel|Procedure 006-003]], Air In Fuel.
...
> [!note] Note · Примечание
> If individual fuel lines are to be replaced, remove the support clamp from the set of fuel lines containing the line to be replaced.
...
> [!note] Note · Примечание
> Make sure that all paint chips are removed.
...
> [!note] Note · Примечание
> If individual fuel lines have been replaced, install the support clamp to the set of fuel lines containing the line that has been replaced.
...
Refer to [[40-006-015-tr — Fuel Filter (Spin-On Type)|Procedure 006-015]] Fuel Filter (Spin-On) for proper venting of the low pressure side of the fuel system.

Refer to the [[40-005-012-tr — Fuel Injection Pumps, In-Line|Procedure 005-012]], Fuel Injection Pumps, In-Line, or [[40-005-014-tr — Fuel Injection Pump, Rotary|Procedure 005-014]], Fuel Injection Pumps, Rotary to determine if venting the fuel pump is necessary.
