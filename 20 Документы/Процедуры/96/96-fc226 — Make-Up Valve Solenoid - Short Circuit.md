---
aliases:
  - "Электромагнит клапана подпитки — короткое замыкание"
type: "Процедура"
doc: "96-fc226"
title_en: "Make-Up Valve Solenoid - Short Circuit"
title_ru: "Электромагнит клапана подпитки — короткое замыкание"
modified: "2004-03-03"
engines:
  - "37292556"
  - "37295879"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/96/96-fc226.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/96-fc226.pdf"
tags:
  - "документ/процедура"
  - "двигатель/NT/NTA855"
  - "двигатель/QST30"
...
# Make-Up Valve Solenoid - Short Circuit
**Электромагнит клапана подпитки — короткое замыкание**

> [!abstract] Процедура · `96-fc226`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/96/96-fc226.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/96-fc226.pdf)
...
|---|---|---|
| Код неисправности: 226 PID(P): СПН: ФМИ: Лампа: Красная СТО: | Электромагнит клапана подпитки — короткое замыкание. Соленоид макияжа сокращен. | Система CentinelTM будет работать **не**. |
...
|  | **STEP 3A.** Отключить код ошибки. | Код ошибки 226 неактивен |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Цикл питания. Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Используйте сервисный плагин для проверки вывода. Убедитесь, что код 226 неактивен. | Код ошибки 226 неактивен | Полный комплект |
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 226 PID(P): SPN: FMI: Lamp: Red SRT: | Make-Up Valve Solenoid - Short Circuit. The make-up solenoid is shorted. | The Centinel™ system will **not** operate. |
>
> ### Circuit Description
>
...
> |  | **STEP 3A.** Disable the fault code. | Fault Code 226 inactive |
>
> ### STEP 1. Check the make-up valve solenoid.
>
...
> | **Repair the damaged pins** Repair or replace the Centinel™ harness or the make-up valve solenoid, whichever has damaged pins. Repair the Centinel™ harness. Refer to Procedure 019-202. Replace the Centinel™ harness. Refer to Procedure 019-131. Replace the make-up valve solenoid. Refer to Procedure 007-077. Install the appropriate connector seal if damaged or missing. | 3A |  |
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Cycle power. Start the engine and let it idle for 1 minute. Use a service plug to check output. Verify that Fault Code 226 is inactive. | Fault Code 226 inactive | Complete |
