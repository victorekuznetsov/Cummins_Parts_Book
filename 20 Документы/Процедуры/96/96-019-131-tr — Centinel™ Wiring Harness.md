...
> [!danger] ОПАСНО
> Аккумуляторные батареи выделяют взрывоопасные газы. Чтобы уменьшить вероятность получения травмы, всегда проветривайте моторное отделение перед началом обслуживания батарей. Чтобы снизить риск искрения, минусовой (-) провод аккумуляторной батареи снимайте первым, а подсоединяйте последним.
...
3. Блок управления Centinel™
4. Узел предупреждающей лампы (высокосильный **только**)
5. Стартовый позитивный пост
6. кольцевая
7. Шина данных CAN
8. Датчик уровня масла в масляном резервуаре
9. Топливный соленоид
10. Датчик давления на топливных рельсах (высокосильный **только**).

![[nobox.png]]

Перережьте стяжки, удерживающие проводную упряжку.
