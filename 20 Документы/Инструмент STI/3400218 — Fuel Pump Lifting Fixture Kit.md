...
doc: "3400218"
title_en: "Fuel Pump Lifting Fixture Kit"
title_ru: "Комплект подъёмного приспособления топливного насоса"
released: "2014-05-20"
modified: "2014-07-24"
revision: "02"
engines:
...
В этом документе представлена информация для комплекта для установки топливных насосов, номер детали 5299015. Набор используется для удаления и установки топливного насоса на двигателях QSK38, QSK50 и QSK60 с модульной системой топлива общего рельса (MCRS).
...
Дополнительную информацию о двигателе QSK60 можно найти в руководстве по обслуживанию QSK45 и QSK60, Bulletin [[4021530 — QSK45 and QSK60 Service Manual\|4021530]]. См. процедуру 005-016 в разделе 5.
...
Набор для поднятия топливного насоса, номер детали 5299015

| Номер позиции | Номер детали | Наименование | Количество | Доступно для покупки |
|---|---|---|---|---|
| 1 | 4918597 | Горячая пластина | 1 | Нет |
| 2 | 4918601 | Spacer \[37,08 мм\] 1,46 дюйма (промышленный QSK38) | 2 | Нет |
| 3 | 4918614 | Spacer \[40,64 мм\] 1,60 дюйма (промышленный QSK60) | 2 | Нет |
| 4 | 4918615 | Spacer \[52.07 мм\] 2,05 дюйма (QSK38 морской и QSK50 промышленный) | 2 | Нет |
...
> ### Purpose
>
> This document provides information for Fuel Pump Lifting Fixture Kit, Part Number 5299015. The kit is used to remove and install the fuel pump on the QSK38, QSK50, and QSK60 engines with the modular common rail fuel (MCRS) system.
>
...
>
> **Note · Примечание**
> The spring and retaining nut are required for proper winch operation and can **not** be altered or permanently removed.
>
> Fuel Pump Lifting Fixture Kit, Part Number 5299015
>
> | Item Number | Part Number | Description | Quantity | Available to Purchase |
> |---|---|---|---|---|
> | 1 | 4918597 | Mounting plate | 1 | No |
> | 2 | 4918601 | Spacer \[37.08 mm\] 1.46 inch (QSK38 industrial) | 2 | No |
> | 3 | 4918614 | Spacer \[40.64 mm\] 1.60 inch (QSK60 industrial) | 2 | No |
> | 4 | 4918615 | Spacer \[52.07 mm\] 2.05 inch (QSK38 marine and QSK50 industrial) | 2 | No |
...
> | 8 | 4918662 | Winch drive adapter | 1 | No |
