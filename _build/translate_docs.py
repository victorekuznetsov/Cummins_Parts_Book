...
NOUN_FIX = {
    "орех": "гайка", "ореха": "гайки", "ореху": "гайке", "орехом": "гайкой",
    "орехе": "гайке", "орехи": "гайки", "орехов": "гаек", "орехам": "гайкам",
    "орехами": "гайками", "орехах": "гайках",
    "весна": "пружина", "весны": "пружины", "весне": "пружине",
    "весну": "пружину", "весной": "пружиной", "весен": "пружин",
    "нефть": "масло", "нефти": "масла", "нефтью": "маслом", "нефтей": "масел",
    "тюлень": "уплотнение", "тюленя": "уплотнения", "тюленю": "уплотнению",
    "тюленем": "уплотнением", "тюлени": "уплотнения", "тюленей": "уплотнений",
    "пломба": "уплотнение", "пломбы": "уплотнения", "пломбу": "уплотнение",
    "пломбой": "уплотнением", "пломб": "уплотнений",
    "печать": "уплотнение", "печати": "уплотнения", "печатью": "уплотнением",
    "печатей": "уплотнений", "печатям": "уплотнениям", "печатями": "уплотнениями",
    "лайнер": "гильза", "лайнера": "гильзы", "лайнеру": "гильзе",
    "лайнером": "гильзой", "лайнере": "гильзе", "лайнеры": "гильзы",
    "лайнеров": "гильз", "лайнерам": "гильзам", "лайнерами": "гильзами",
    "лайнерах": "гильзах",
    "шапка": "крышка", "шапки": "крышки", "шапке": "крышке", "шапку": "крышку",
    "шапкой": "крышкой", "шапок": "крышек", "шапках": "крышках",
    "автобус": "шина", "автобуса": "шины", "автобусу": "шине",
    "автобусом": "шиной", "автобусе": "шине", "автобусы": "шины",
    "автобусов": "шин", "автобусам": "шинам", "автобусами": "шинами",
    "винтовка": "винт", "винтовки": "винты", "винтовке": "винте",
    "винтовку": "винт", "винтовкой": "винтом", "винтовок": "винтов",
    "галстук": "стяжка", "галстука": "стяжки", "галстуку": "стяжке",
    "галстуком": "стяжкой", "галстуки": "стяжки", "галстуков": "стяжек",
    "галстуками": "стяжками",
    "торк": "момент", "торка": "момента", "торку": "моменту", "торке": "моменте",
    "тюбик": "трубка", "тюбика": "трубки", "тюбике": "трубке",
    "власть": "питание", "власти": "питания",
...
STEM_FIX = [
    ("нефтян", "маслян"),          # oil -> «нефтяной»
    ("стиральн", "шайб"),          # остатки washer -> «стиральный»
    ("инжекторн", "форсуночн"),
...
PHRASE_FIX = [
    # частые промахи модели на технических словах: washer -> «стиральная
    # машина», nut -> «орех», spring -> «весна», oil -> «нефть», seal ->
    # «печать», liner -> «лайнер», cap -> «шапка», bus -> «автобус»,
    # screw -> «винтовка», tie -> «галстук»
    ("стиральную машину", "шайбу"), ("стиральной машины", "шайбы"),
    ("стиральная машина", "шайба"), ("стиральные машины", "шайбы"),
    ("стиральных машин", "шайб"), ("стиральными машинами", "шайбами"),
    ("стиральной машине", "шайбе"), ("стиральных машинах", "шайбах"),
    ("стиральную машинку", "шайбу"), ("стиральная машинка", "шайба"),
    ("банк цилиндров", "ряд цилиндров"), ("банка цилиндров", "ряда цилиндров"),
    ("банки цилиндров", "ряды цилиндров"),
...
ACC_FORM = {"гильза": "гильзу", "шина": "шину", "шайба": "шайбу", "гайка": "гайку",
            "пружина": "пружину", "крышка": "крышку", "стяжка": "стяжку",
            "трубка": "трубку", "форсунка": "форсунку", "прокладка": "прокладку"}
ACC_AFTER_VERB = re.compile(
    r"\b(снимите|установите|замените|отсоедините|подсоедините|очистите|осмотрите|"
    r"извлеките|вставьте|затяните|ослабьте|смажьте|проверьте)\s+(" +
    "|".join(ACC_FORM) + r")\b", re.I)
...
def post_edit(ru):
    ...
    # «Версия для печати» — служебная строка QuickServe, seal-правку к ней
    # применять нельзя
    ru = ru.replace("для печати", "\x00PRINTVER\x00")
    words = dict(NOUN_FIX)
    ...
    # после повелительного глагола существительное должно стоять в винительном
    # падеже: «снимите гильза» -> «снимите гильзу»
    ru = ACC_AFTER_VERB.sub(lambda m: m.group(1) + " " + ACC_FORM[m.group(2).lower()], ru)
    ru = ru.replace("\x00PRINTVER\x00", "для печати")
