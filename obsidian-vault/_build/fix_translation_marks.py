...
TERMS = [
    ...
    (re.compile(r"\bтюлень\b", re.I), "уплотнение"),
    (re.compile(r"\bтюлен(я|ю|ем|и|ей|ям|ями|ях)\b", re.I), "уплотнения"),
    (re.compile(r"\bтюлен\w*", re.I), "уплотнение"),
    (re.compile(r"\bпломб(а|ы|у|ой|е)?\b", re.I), "уплотнение"),
