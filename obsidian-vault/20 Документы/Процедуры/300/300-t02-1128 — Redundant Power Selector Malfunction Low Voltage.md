...
type: "Процедура"
doc: "300-t02-1128"
title_en: "Redundant Power Selector Malfunction Low Voltage"
modified: "2019-10-17"
engines:
  - "35354607"
  - "35373113"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/300/300-t02-1128.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/300-t02-1128.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSM11"
  - "группа/300"
...
> [!abstract] Процедура · `300-t02-1128`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/300/300-t02-1128.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/300-t02-1128.pdf)
...
- Сообщение об ошибке первичного источника питания.
...
Сообщение об ошибке первичного питания.
...
|  | **ШАГ 2А.** Проверить избыточный селектор питания первичного входа питания Провода SUPPLY на напряжение +18 ВДК. | Менее +18±0,2-VDC? |
|  | **STEP 2B.** Проверить избыточный селектор мощности вторичного входа мощности Провода SUPPLY на напряжение +18 ВДК. | Меньше +18±0,2 VDC? |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте напряжение при контакте 6 избыточного селектора питания. Поместите один испытательный щуп на провод вторичной мощности SUPPLY при контакте 6 с избыточным селектором мощности. Поместите другой испытательный щуп на землю панели. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Меньше +18±0,2 VDC? *Да | Ремонт завершён. |
| Меньше +18±0,2 VDC? **НЕТ** | 3А |  |

### ШАГ 3. Проверьте избыточный выходной выход силового селектора SUPPLY.

#### ШАГ 3A. Проверьте избыточный селектор мощности выходного провода для напряжения.

| **Условия: **Открыть ЦБ. Испытать избыточный селектор мощности выходной мощности SUPPLY провода. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте выходное напряжение при контакте 17 избыточного селектора питания. Поместите один испытательный щуп на выходной провод при контакте 17 избыточного селектора питания. Поместите другой испытательный щуп на землю панели. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Вторичный вход мощности SUPPLY равен избыточному выходу селектора мощности ± 0,5 VDC? *Да | Ремонт завершён. |
| Вторичный вход мощности SUPPLY равен избыточному выходу селектора мощности ± 0,5 VDC? **NORepair:** Заменить избыточный селектор питания. | 1А |  |
...
>
> | **Conditions:** Open the C.I.B. Test the redundant power selector power output SUPPLY wire. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the output voltage at pin 17 of the redundant power selector. Place one test lead at the power output wire at pin 17 of the redundant power selector. Place the other test lead on the panel ground. Refer to the appropriate circuit diagram or wiring diagram for pin and wire identification. | Secondary power input SUPPLY equals the redundant power selector output ± 0.5 VDC? **YES** | Repair complete. |
> | Secondary power input SUPPLY equals the redundant power selector output ± 0.5 VDC? **NORepair:** Replace redundant power selector. | 1A |  |
