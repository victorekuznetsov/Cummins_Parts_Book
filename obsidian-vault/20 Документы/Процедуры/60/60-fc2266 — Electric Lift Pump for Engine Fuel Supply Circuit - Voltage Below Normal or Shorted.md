...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/60/60-fc2266.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc2266.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/60"
...
> [!abstract] Процедура · `60-fc2266`
> **Двигатели:** [[37292556 — QST30 CM552 CPL 1244|37292556]], [[37295879 — QST30 CM552 CPL 2139|37295879]]
> **Семейство:** QST30
> **Входит в руководства:** [[4021674 — QST30 CM850 Power Generation Interface Engine Electronic Control System Troubleshooti|4021674]]
> **Секции:** Section TF — Troubleshooting Fault Codes
> **Даты:** изменён 2020-09-28
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/60/60-fc2266.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc2266.pdf)
...
|---|---|---|
| Код неисправности: 2266 PID(P): S126 SPN: 1075 FMI: 4/4 лампы: Янтарная СРТ: | Низкое напряжение сигнала, обнаруженное на реле ретранслятора насоса топливного подъема. | Двигатель может ** не** запускаться или может быть трудно запустить. |
...
Модуль управления двигателем (ECM) обнаружил, что цепь ретрансляции сигнала подъемного насоса находится вне диапазона низкого.
...
См. код 2266 устранения неполадок.
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 2266 PID(P): S126 SPN: 1075 FMI: 4/4 Lamp: Amber SRT: | Low signal voltage detected at the fuel lift pump relay circuit. | Engine may **not** start or may be difficult to start. |
>
...
>
> The Engine Control Module (ECM) detected the lift pump relay signal circuit is out of range low.
>
...
>
> Refer to Troubleshooting Fault Code 2266.
