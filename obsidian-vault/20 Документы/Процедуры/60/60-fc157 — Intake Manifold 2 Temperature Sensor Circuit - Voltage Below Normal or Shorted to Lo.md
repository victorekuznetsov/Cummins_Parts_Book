...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/60/60-fc157.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc157.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/60"
...
> [!abstract] Процедура · `60-fc157`
> **Двигатели:** [[37292556 — QST30 CM552 CPL 1244|37292556]], [[37295879 — QST30 CM552 CPL 2139|37295879]]
> **Семейство:** QST30
> **Входит в руководства:** [[4021674 — QST30 CM850 Power Generation Interface Engine Electronic Control System Troubleshooti|4021674]]
> **Секции:** Section TF — Troubleshooting Fault Codes
> **Даты:** изменён 2020-09-28
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/60/60-fc157.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/60-fc157.pdf)
...
|---|---|---|
| Код неисправности: 157 PID (P): СПН: 1131 FMI: 4/4 лампы: Янтарная СРТ: | Низкое напряжение сигнала, обнаруженное в цепи датчика температуры впускного коллектора 2. | Ни одного на выступление. |
...
Модуль управления двигателем (ECM) обнаружил, что напряжение сигнала датчика температуры 2 впускного коллектора находится вне диапазона низкого.
...
См. Код 157 устранения неполадок.
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 157 PID(P): SPN: 1131 FMI: 4/4 Lamp: Amber SRT: | Low signal voltage detected at intake manifold 2 temperature sensor circuit. | None on performance. |
>
...
>
> The Engine Control Module (ECM) detected the intake manifold 2 temperature sensor signal voltage is out of range low.
>
...
>
> Refer to Troubleshooting Fault Code 157.
