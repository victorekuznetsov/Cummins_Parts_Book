...
|  | **STEP 1C** Проверьте устройство OEM. | Код тревоги 7415 активен? |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Подожди 30 секунд. Прочитайте дисплеи ED-4. | Код тревоги 7415 активен? **См. раздел TT в разделе «OEM-дисплей делает **не** данные для отображения» - NMEA 2000 и/или J1939 делает **не дерево устранения неполадок. | Ремонт завершён. |
| Код тревоги 7415 активен? **NORepair:** Проверить, что адрес источника OEM-устройства установлен неправильно. См. сервисную документацию изготовителя оборудования. | Ремонт завершён. |  |
