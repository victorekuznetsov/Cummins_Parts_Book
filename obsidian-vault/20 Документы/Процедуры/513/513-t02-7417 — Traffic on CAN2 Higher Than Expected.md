...
type: "Процедура"
doc: "513-t02-7417"
title_en: "Traffic on CAN2 Higher Than Expected"
modified: "2019-10-25"
engines:
  - "35354607"
  - "35373113"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/513/513-t02-7417.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/513-t02-7417.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSM11"
  - "группа/513"
...
# Traffic on CAN2 Higher Than Expected

> [!abstract] Процедура · `513-t02-7417`
> **Двигатели:** [[35354607 — QSM11 CM570 CPL 8608|35354607]], [[35373113 — QSM11 CM570 CPL 8471|35373113]], [[71156161 — QSM11 CM570 CPL 8543|71156161]]
> **Семейство:** QSM11
> **Входит в руководства:** [[5411480 — C Command Connect and Connect Premier Marine Panel Systems PS102, PS103 and PS108 Mas|5411480]]
> **Секции:** Section TT - Troubleshooting Symptoms (New Format)
> **Даты:** изменён 2019-10-25
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/513/513-t02-7417.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/513-t02-7417.pdf)
...
|  | **STEP 1C** Проверьте устройство OEM. | Код тревоги 7417 активен? |
...
| Проверьте, что последняя версия VPF загружена на дисплее. См. процедуру 015-044 в разделе 15. Проверьте, что новейшее программное обеспечение отображения загружается на дисплей ED-4. См. процедуру 015-107 в разделе 15. | Последний файл личности судна и программное обеспечение установлены? *Да | 1В |
| Последний файл личности судна и программное обеспечение установлены? **NORepair:** Скачать корректный VPF на дисплей из Cummins QuickServe® Online.[[513-015-044 — Managing Vessel Personalities\|См. процедуру 015-044 в разделе 15.]]Скачайте последнюю версию программного обеспечения для отображения из Cummins QuickServe® Online.[[513-015-107 — Display Software\|См. процедуру 015-107 в разделе 15.]] | Ремонт завершён. |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Подожди 30 секунд. Прочитайте дисплеи ED-4. | Код тревоги 7417 активен? **См. раздел TT в разделе «OEM-дисплей делает **не** данные для отображения» - NMEA 2000 и/или J1939 делает **не дерево устранения неполадок. | Ремонт завершён. |
| Код тревоги 7417 активен? **NORepair:** Проверить, что адрес источника OEM-устройства установлен неправильно. См. сервисную документацию изготовителя оборудования. | Ремонт завершён. |  |
...
> |  | **STEP 1C.** Check the OEM device. | Alarm Code 7417 active? |
>
> ### STEP 1. Check the ED-4 display.
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Wait 30 seconds. Read the ED-4 display. | Alarm Code 7417 active? **YESRepair:** Refer to the OEM Display Does **Not** Display Data - NMEA 2000 and/or J1939 Does **Not** Work troubleshooting tree in Section TT. | Repair complete. |
> | Alarm Code 7417 active? **NORepair:** Verify the OEM device source address is setup incorrectly. See equipment manufacturer service information. | Repair complete. |  |
