...
|  | **STEP 1A.** Проверка активных кодов неисправностей, отличных от кода 514. | Активные коды ошибок? |
|  | **ШАГ 1В.** Интервью с водителем по поводу симптомов, присутствующих в двигателе. | Присутствуют симптомы? |
|  | **STEP 1C** Контроль параметров рельсов для перенапряжения рельсового топлива. | Чрезмерное давление на железнодорожное топливо? |
...
|  | **ШАГ 2Е.** Проверить соленоид отключения топлива на предмет чрезмерного износа. | Чрезмерная одежда? |
...
|  | **STEP 4A.** Отключить код ошибки. | Код 514 неактивен? |
|  | **STEP 4B.** Очистить коды неактивных ошибок. | Коды неисправностей очищены? |

### ШАГ 1. Проверьте жалобу.

#### ШАГ 1A. Проверка активных кодов неисправностей, отличных от кода 514.

| **Условия:** Включить переключатель зажигания. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверка активных кодов неисправностей, отличных от кода 514. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Активные коды ошибок? В первую очередь исследуйте другие коды ошибок. | Соответствующая процедура кодирования неисправностей |
...
#### ШАГ 1C. Контроль параметров рельсов для перенапряжения рельсового топлива.

| **Условия:** Включить переключатель зажигания. Подключите инструмент электронного сервиса INSITETM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Контроль параметров рельсов для перенапряжения рельсового топлива. Используйте инструмент электронного обслуживания INSITETM для мониторинга желаемого времени заправки и расчетных параметров заправки рельсов. Является ли предполагаемое заправка рельсами последовательно выше, чем желаемое заправка рельсами? Если он выше, он чрезмерно давит на заправку рельсов. | Железнодорожное топливо под избыточным давлением? **Ремонт:** Заменить привод рельса.[[19-019-339 — Timing Actuator\|См. процедуру 019-339 в разделе 19.]] | 2А |
| Железнодорожное топливо под избыточным давлением? **НЕТ** | 4А |  |
...
#### ШАГ 2E. Осмотрите соленоид отключения топлива на предмет чрезмерного износа.

| **Условия:** Выключите замок зажигания. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Осмотрите соленоид отключения топлива на предмет чрезмерного износа. Удалите соленоид отключения топлива и проверьте прокладку на предмет чрезмерного износа. См. процедуру 019-050 в разделе 19. | Чрезмерная одежда? **Ремонт:** Ремонт или замена запорного клапана.[[19-019-050 — Fuel Shutoff Valve\|См. процедуру 019-050 в разделе 19.]] | 4А |
| Чрезмерная одежда? **НЕТ** | 4А |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте наличие топлива в масле или охлаждающей жидкости. Исследуйте топливо или масло в охлаждающей жидкости. | Топливо в масле или хладагенте? **Ремонт:** Заменить привод рельса.[[19-019-339 — Timing Actuator\|См. процедуру 019-339 в разделе 19.]] | Соответствующее дерево симптомов устранения неполадок |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Осмотрите экран привода на предмет наличия мусора Удалите исполнительный механизм рельса, чтобы осмотреть экран на предмет наличия мусора. См. процедуру 019-339 в разделе 19. | Отбеливатели на входном экране привода? **Ремонт:** Заменить экран привода рельса. См. процедуру 019-112 в разделе 19. | 4А |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте привод на коррозию. Удалите привод рельса для проверки на коррозию. См. процедуру 019-339 в разделе 19. | Коррозия на приводе? **Ремонт:** Заменить привод рельса. См. процедуру 019-112 в разделе 19. | 4А |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Отключите код неисправности. Запустите двигатель и пройдите весь рабочий диапазон, чтобы убедиться, что код 514 неактивен. | Код 514 неактивен? *Да | 4B |
| Код 514 неактивен? **NORepair:** Возврат к шагам устранения неполадок или свяжитесь с авторизованным местом ремонта Cummins®, если все шаги были завершены и проверены снова. | 1А |  |
