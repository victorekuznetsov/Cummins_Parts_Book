...
|---|---|---|
| Код неисправности: 431 PID(P): P91 SPN: 091 ФМИ: 2 лампы: Желтая СТО: 00-370 | Напряжение, обнаруженное одновременно как на контактах 12 и 13 проводов OEM, так и на контактах бездействия и бездействия, или на напряжении, обнаруженном на любом штифте. | Ни одного на выступление. |
...
Сигнал неработающей валидации является функцией безопасности, которая отключает управление ускорителем, в то время как неправильный сигнал валидации обнаруживается ECM. Переключатель проверки бездействия обеспечивает сигналы проверки на холостом ходу и вне холостого хода для ECM через OEM-проводник и OEM-интерфейс.
