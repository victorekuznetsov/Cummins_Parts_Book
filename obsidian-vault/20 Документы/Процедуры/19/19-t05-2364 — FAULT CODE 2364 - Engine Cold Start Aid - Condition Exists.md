...
| Степс | Спецификации |  |
|---|---|---|
| ШАГ 1. | Проверьте инъекцию эфира соленоида. |  |
|  | **STEP 1A.** Осмотрите форсунку соленоидного соединительного поста и соединительный узел OEM-проводов. | Отсутствие повреждений столба или разъема |
|  | **STEP 1B.** Проверьте напряжение питания на соленоиде, инъецируемом эфиром. | Более 17.0 VDC |
|  | **STEP 1C** Проверить сопротивление форсуночного соленоида эфира. | См. руководство по OEM для спецификации |
| ШАГ 2. | Проверьте жгут проводов изготовителя машины. |  |
|  | **STEP 2A.** Проверить контакты разъема OEM-проводов и OEM-интерфейса. | Никаких поврежденных контактов |
...
|  | **STEP 3A.** Проверить разъём ремней электропроводки двигателя и контакты разъема ECM. | Никаких поврежденных контактов |
|  | **STEP 3B.** Проверьте короткое замыкание на блокировке двигателя. | Более 100 тыс. ом |
|  | **STEP 3C.** Проверьте короткое замыкание от пин-кодов до пин-кодов. | Более 100 тыс. ом |
|  | **STEP 3D** Проверить наличие открытой схемы. | Менее 10 Ом |
| ШАГ 4. | Проверьте напряжение питания в ECM. |  |
|  | **STEP 4A.** Проверьте напряжение питания в ECM. | Более 17.0 VDC |
| ШАГ 5. | Сбросьте коды неисправностей. |  |
|  | **STEP 5A.** Отключить код ошибки. | Код 2364 неактивен |

### ШАГ 1. Проверьте инъекцию эфира соленоида.

#### ШАГ 1A. Осмотрите форсунку соленоидного соединительного поста и OEM проводов ремня разъема.

| **Условия:** Выключите замок зажигания. Отсоедините соленоид для инъекции эфира от проводной упряжки OEM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Осмотрите форсунку соленоидного соединительного поста и OEM проводной ремень разъёма для следующего: Сдвинутый или сломанный OEM-коннектор соединительного упряжка Корродированный терминальный пост на соленоиде Несколько проводов на терминальном посту Влага в или на разъёме. | Отсутствие повреждений столба или разъема | 1В |
| Ремонт поврежденного соединения. Смой грязь, мусор или влагу с соединительного поста и кольцевого терминала. Ремонт или замена эфира инъекцией соленоида или OEM проводов жгута, в зависимости от того, что имеет поврежденную часть. Смывать грязь, мусор или влагу с соединительного поста и кольцевого терминала с помощью электронного контактного очистителя, номер детали 3824510. Удалите любые дополнительные провода, подключенные к соленоидному терминальному посту. Замените поврежденный соленоид. См. руководство по процедуре OEM. Ремонт OEM проводов жгута кольцевой терминал. См. процедуру 019-197 в разделе 19. Замените проводку OEM. См. процедуру 019-071 в разделе 19. | 5а |  |

#### ШАГ 1B. Проверьте напряжение питания на соленоиде для инъекции эфира.

| **Условия: **Отсоедините соленоид для инъекций эфира от электропроводки OEM. Включите зажигание. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте напряжение питания на соленоиде для инъекции эфира. Измерьте напряжение от разъёма проводов OEM-системы до заземления блока двигателя. | Более 17.0 VDC. Замените инъекцию эфира соленоидом. См. сервисное руководство изготовителя машины. | 5а |
|  | 1С |  |

#### ШАГ 1C. Проверьте сопротивление инъекции эфира соленоида.

| **Условия:** Выключите замок зажигания. Отсоедините соленоид для инъекции эфира от проводной упряжки OEM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте сопротивление инъекции эфира соленоида. Измерьте сопротивление от соединительного столба до заземления блока двигателя. | См. руководство по OEM для спецификации | 2А |
| Замените инъекцию эфира соленоидом. См. сервисное руководство изготовителя машины. | 5а |  |

### ШАГ 2. Проверьте OEM проводку.

#### ШАГ 2A. Осмотрите контакты разъёма OEM-проводов и OEM-интерфейса.

| **Условия:** Выключите замок зажигания. Отсоедините проводку OEM от соленоида для инъекции эфира. Отсоедините проводку OEM от электропроводки двигателя на 31-контактном разъеме. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Осмотрите разъёмы OEM-проводов и OEM-интерфейса для подключения жгутов проводов для следующего: Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема разъема или разбитые штифты Разъем разъема разъема или разъема или разъема разъема разъема оболочки разбитого изоляционного повреждения Проволоки Поврежденный разъем блокировки вкладки. Используйте следующую процедуру для общих методов проверки.[[99-019-361 — Component Connector and Pin Inspection\|См. процедуру 019-361 в разделе 19.]] | Никаких поврежденных контактов | 2В |
| Ремонт поврежденных контактов. Смой грязь, мусор или влагу из контактов разъема. Ремонт или замена OEM-проводов или OEM-проводов интерфейса проводов жгута, в зависимости от того, что имеет поврежденные контакты. Смывать грязь, мусор или влагу с контактов разъема с помощью электронного контактного очистителя, номер детали 3824510. Установите соответствующий уплотнитель разъема, если он поврежден или отсутствует. Ремонт проводной упряжки OEM. См. процедуру 019-208 в разделе 19. Замените проводку OEM. См. процедуру 019-071 в разделе 19. Ремонт OEM интерфейса проводов жгут. См. процедуру 019-208 в разделе 19. Замените OEM-проводку интерфейсом проводов. См. процедуру 019-072 в разделе 19. | 5а |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте, чтобы короткое время приземлилось в электропроводке OEM. Измерьте сопротивление от эфирного соленоидного разъёма жгута (кольцевого терминала) к заземлению блока двигателя. | Более 100 тыс. ом | 2C |
| Замените проводку OEM.[[99-019-071 — OEM Wiring Harness\|См. процедуру 019-071 в разделе 19.]]. | 5а |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте короткое замыкание от пин-кодов до пин-кодов. Измерьте сопротивление от контакта 26 OEM 31-контактного разъема, стороны проводов двигателя, ко всем другим штифтам в разъеме. | Более 100 тыс. ом | 2D |
| Замените проводку OEM.[[99-019-071 — OEM Wiring Harness\|См. процедуру 019-071 в разделе 19.]]. | 5а |  |

#### ШАГ 2D. Проверьте наличие открытой цепи в OEM-проводах.

| **Условия:** Выключите замок зажигания. Отсоедините проводку OEM от соленоида для инъекции эфира. Отсоедините проводку OEM от электропроводки двигателя на 31-контактном разъеме. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте цепь на обрыв. Измерьте сопротивление от OEM-проводов упряжки соленоидного разъема (кольцевого терминала) контактировать с 26 OEM-проводов упряжки 31-контактного разъема, OEM-стороны. | Менее 10 Ом | 3А |
| Замените проводку OEM.[[99-019-071 — OEM Wiring Harness\|См. процедуру 019-071 в разделе 19.]]. | 5а |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте короткое замыкание на блокировку двигателя. Измерьте сопротивление от контакта 2 проводов двигателя с помощью разъема ECM к заземлению блока двигателя. | Более 100 тыс. ом | 3C |
| Замените жгут электропроводки двигателя.[[19-019-043 — Engine Wiring Harness\|См. процедуру 019-043 в разделе 19.]]. | 5а |  |

#### ШАГ 3C. Проверьте короткое замыкание от пин-кодов до пин-кодов.

| **Условия:** Выключите замок зажигания. Отсоедините жгут проводов двигателя от OEM-проводов на 31-контактном разъеме. Отсоедините электропроводку двигателя от ECM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте короткое замыкание от пин-кодов до пин-кодов. Измерьте сопротивление от контакта 2 проводов двигателя с помощью разъема ECM ко всем другим штифтам в разъеме. | Более 100 тыс. ом | 3D |
| Замените жгут электропроводки двигателя.[[19-019-043 — Engine Wiring Harness\|См. процедуру 019-043 в разделе 19.]]. | 5а |  |

#### ШАГ 3D. Проверьте наличие открытой цепи в ремне электропроводки двигателя.

| **Условия:** Выключите замок зажигания. Отсоедините жгут проводов двигателя от OEM-проводов на 31-контактном разъеме. Отсоедините электропроводку двигателя от ECM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте наличие открытой цепи в ремне электропроводки двигателя. Измерьте сопротивление от контакта 26 31-контактного OEM-разъема для подключения к контакту 2 разъема ECM для проводов двигателя. | Менее 10 Ом | 4А |
| Замените жгут электропроводки двигателя.[[19-019-043 — Engine Wiring Harness\|См. процедуру 019-043 в разделе 19.]]. | 5а |  |

### ШАГ 4. Проверьте напряжение питания в ECM.

#### ШАГ 4A. Проверьте напряжение питания в ECM.

| **Условия: **Включена система впрыска эфира. Температура охлаждающей жидкости ниже порога, калиброванного ECM. Отсоедините электропроводку двигателя от ECM. Включите зажигание. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте напряжение питания в ECM. Измерьте напряжение питания от контакта 2 порта разъема электропроводки двигателя ECM до заземления блока двигателя. | Более 17.0 VDC | 5а |
| Заменить ECM.[[19-019-031 — Engine Control Module\|См. процедуру 019-031 в разделе 19.]]. | 5а |  |

### ШАГ 5. Отключите коды неисправностей.
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Отключите код неисправности. Запускай двигатель. Это должно быть холодным началом. Используйте инструмент электронного сервиса INSITETM для проверки неактивности кода ошибки. | Код 2364 неактивен | Ремонт завершён |
| Убедитесь, что все шаги были завершены. Если все шаги были выполнены, то следуйте своему техническому процессу эскалации. | Эскалация или призыв к помощи |  |
