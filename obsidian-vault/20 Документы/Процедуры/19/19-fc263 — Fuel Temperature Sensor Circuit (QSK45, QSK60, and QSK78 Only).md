...
### Схема датчика температуры топлива (QSK45, QSK60 и QSK78)
...
|---|---|---|
| Код неисправности: 263 PID(P): P174 SPN: 174 ФМИ: 3 лампы: Желтая СТО: 00-398 | Более 4,95 ВДК обнаружено при температурном контакте топлива 26 проводов двигателя жгута проводов. | Отсутствие защиты двигателя от температуры топлива. |
...
Датчик температуры топлива используется ECM для мониторинга температуры топлива. Температура топлива используется ECM для системы защиты двигателя, управления временем и заправкой. ECM контролирует напряжение на контакте 26. ECM ожидает, что напряжение будет варьироваться от 0,5 до 4,5 VDC. Если напряжение выше 4,95 ВДК, то ECM регистрирует код 263 ошибки. Напряжение выше 4,95 VDC на контакте 26 может быть вызвано открытым в сигнале или возвратных проводах, или напряжения шорты на сигнал или возвратных проводах, или неисправный открытый датчик.
