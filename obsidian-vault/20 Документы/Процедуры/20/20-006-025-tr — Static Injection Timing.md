...
Если предположить, что все метки индекса передач были выровнены при запуске процесса впрыска, коленчатый вал должен быть повернут примерно на три четверти оборота, чтобы получить ход сжатия для цилиндра № 3.
...
- Установите форсунку из цилиндра № 3.[[20-006-026-tr — Injector|См. процедуру 006-026 в разделе 6.]]
