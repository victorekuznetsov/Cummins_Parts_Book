...
type: "Процедура"
doc: "20-001-055"
title_en: "Gear Train Backlash, Front"
title_ru: "Боковой зазор передней шестерённой передачи"
modified: "2003-04-29"
engines:
  - "41349633"
families:
...
Реакция на масляный насос может быть отрегулирована путем вращения корпуса насоса.
...
>
> **Note · Примечание**
> This check **must** be performed after the gear cover is removed. If the cover is **not** already removed, refer to Procedure No. 001-031-002.
>
> **CAUTION · Осторожно**
...
>
> Rotate the gear being measured **clockwise**. Position the indicator to "0". Now rotate the gear **counterclockwise** and read the indicator.
>
> | mm |  | in |
> |---|---|---|
> | 0.07 | MIN | 0.003 |
> | 0.30 | MAX | 0.012 |
>
> The backlash on the oil pump can be adjusted by rotating the pump body.
