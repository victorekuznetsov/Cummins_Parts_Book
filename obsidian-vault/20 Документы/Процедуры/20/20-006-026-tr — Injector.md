...
Установить испытательную установку и уплотнительный шайбый станок для слива топлива, номера частей 2892297 и[[3963990]]в каждую из головок цилиндров.
...
Замените форсунку на любой цилиндр, который имеет больше утечки, чем указано.
