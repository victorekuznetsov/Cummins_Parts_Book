...
Поместите метку на все шланги, линии, связи и электрические соединения, когда они удаляются, чтобы определить их местоположение на двигателе.
...
Охладитель двигателя см. в процедуре 008-018.
...
> [!note] Примечание
> Утилизировать использованное масло в соответствии с федеральными, государственными и местными законами и правилами.

![[op2ppma.png]]

Отсоедините стартовый кабель двигателя, наземные ремни двигателя, кабину или шасси к шлангам двигателя, трубке, электрическим проводам и гидравлическим линиям.

![[13200042.png]]

Отсоедините впускные и выпускные воздушные трубы.

Отсоедините все установленные на шасси «двигатели» аксессуары.

![[ca900md.png]]

Отсоедините дроссельную связь от рычага управления насосом для впрыска; обратитесь к руководству по обслуживанию OEM.

![[fs9tboa.png]]

Отсоедините приводные агрегаты от маховика.
...
Удалите все компоненты шасси, необходимые для удаления двигателя из оборудования. Смотрите инструкции OEM.
...
Поместите двигатель на подходящие подставки для поддержки двигателя.

![[ew900we.png]]

Удалите все оставшиеся аксессуары и скобки для использования с заменяющим двигателем.
...
> ### General Information
>
> Place a tag on all hoses, lines, linkages, and electrical connections, as they are removed, to identify their locations on the engine.
>
> **WARNING · Опасно**
...
>
> **Note · Примечание**
> Dispose of used oil in accordance with federal, state, and local laws and regulations.
>
...
>
> Disconnect the throttle linkage from the injection pump control lever; refer to the OEM service manual.
>
...
>
> Remove all chassis components necessary to remove the engine from the equipment. Refer to the OEM's instructions.
>
> **WARNING · Опасно**
> This assembly weighs 23 kg \[50 lb\] or more. To avoid personal injury, use a hoist or get assistance to lift this assembly.
>
> The engine lifting equipment **must** be designed to lift the engine and transmission safely as an assembly.
>
> **Note · Примечание**
> On applications where the rear engine mounts are attached to the transmission, it will probably be necessary to remove the engine and transmission as an assembly.
>
> **Note · Примечание**
...
>
> Attach the engine lift fixture, Part No. 3163264, to the engine-mounted lifting brackets.
>
> Remove the engine.
>
...
>
> Remove all of the remaining accessories and brackets to use with the replacement engine.
