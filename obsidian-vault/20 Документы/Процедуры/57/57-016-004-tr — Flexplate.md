...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/57/57-016-004-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/57-016-004-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/57"
...
> [!abstract] Процедура · `57-016-004-tr`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/57/57-016-004-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/57-016-004-tr.pdf)
...
- Отключите электрические соединения от стартового двигателя. См. процедуру 013-020 в разделе 13.
...
Ослабьте запирающий орех.

Удалите датчик скорости двигателя из корпуса маховика двигателя.

![[19a00245.png]]

Удалите датчик скорости двигателя (генерация мощности).

> [!note] Примечание
> Этот датчик также может использоваться в некоторых промышленных приложениях.

Отсоедините датчик от жгута проводов двигателя.

Ослабьте локон. Задний сенсор из разгибающейся оболочки.
...
Удалите два болта, обеспечивающие закрепление капсулы датчика положения двигателя (EPS), в обшивку с флаксированными элементами.

Удалите капсулу, датчик и разъём жгута проводов в качестве сборки.
...
Используйте два направляющих шпилька M20, чтобы предотвратить вращение флекплейта.

Используйте подъемник, две \[5/8-11 \] T-ручки и подъемную стропу. Установите T-ручки.
...
> [!note] Примечание
> Используйте молоток, чтобы нажать на флакслат из коленчатого вала, если это необходимо.

> [!note] Примечание
> Промышленные двигатели используют штифт выравнивания для выравнивания коленчатого вала и правильного изгиба. Дюбель - это свободный припадок, ** не ** интерференционный припадок. Он может выпасть, когда флесплейт удаляется.
...
> [!tip] Момент затяжки
> Флэксплейт болты 271 Н·м [200 футов-лб]
...
Осмотрите зубья разгибающегося кольца на трещины и чипсы.
...
См. процедуру 001-016 в разделе 1 для замены коленчатого вала.
...
Осколочные крепежные болты изготавливаются с точной спецификацией с прокатной резьбой. Если требуется замена, могут быть использованы только детали, выпущенные Cummins®, в противном случае может возникнуть неисправность, которая может привести к травме.
...
Студентки-гиды помогут во время сборки. Установите направляющие шпильки в 12-часовом и 6-часовом положениях. Установите флиппл, шайбы и болты. Флэплит** должен** быть твёрдо против коленчатого вала.

> [!note] Примечание
> Промышленные двигатели имеют специальные болты M20 x 1,5 x 60 (1), которые ** должны быть установлены и затянуты сначала в противоотвал в флетчатой оболочке. Эти болты не требуют стиральной машины. В шлюз также должен быть установлен свободно облегающий дюбель ***.

> [!note] Примечание
> Некоторые промышленные двигатели ** не** имеют установленный штифт.

> [!note] Примечание
> Плечевые болты выравнивают флиплет с коленчатым валом. Штифты для синхронизации выравнивают флакслат с коленчатым валом.
...
- Подключите электрические соединения к пусковому двигателю. См. процедуру 013-020 в разделе 13.
...
> - Disconnect the electrical connections from the starting motor. Refer to Procedure 013-020 in Section 13.
...
> ### Remove
>
> Disconnect the sensor from the engine wiring harness.
>
> Loosen the locking nut.
>
> Remove the engine speed sensor from engine flywheel housing.
>
> Remove the engine speed sensor (power generation).
>
> **Note · Примечание**
> This sensor can also be used in some industrial applications.
>
> Disconnect the sensor from the engine harness.
>
> Loosen the jam nut. Back the sensor out of the flexplate housing.
>
> Remove the sensor.
>
> Disconnect the engine position sensor.
>
> Remove the two capscrews securing the engine position sensor (EPS) capsule to the flexplate housing.
>
> Remove the capsule, sensor, and harness connector as an assembly.
>
> **WARNING · Опасно**
...
>
> Use two M20 guide studs to prevent the flexplate from rotating.
>
> Use a hoist, two \[ 5/8-11 \] T-handles, and a lifting sling. Install the T-handles.
>
...
>
> **Note · Примечание**
> Use a mallet to tap the flexplate from the crankshaft, if necessary.
>
> **Note · Примечание**
> Industrial engines use an alignment dowel pin to align the crankshaft and flexplate properly. The dowel is a loose fit, **not** an interference fit. It can drop out when the flexplate is removed.
>
...
> Flexplate capscrews 271 n•m [200 ft-lb]
>
...
>
> Inspect the flexplate ring gear teeth for cracks and chips.
>
> **Note · Примечание**
...
>
> Refer to Procedure 001-016 in Section 1 to replace the crankshaft.
>
> ### Install
>
...
>
> Guide studs will help during assembly. Install guide studs at the 12-o'clock and 6-o'clock positions. Install the flexplate, washers, and capscrews. The flexplate **must** be firmly against the crankshaft.
>
> **Note · Примечание**
> Industrial engines have a special M20 x 1.5 x 60 shouldered capscrew (1) that **must** be installed and tightened snug first into the countersunk hole in the flexplate. This capscrew requires no washer. A loose-fit dowel also **must** be installed into the flexplate.
>
> **Note · Примечание**
> Some industrial engines will **not** have the dowel pin installed.
>
> **Note · Примечание**
> The shouldered capscrew aligns the flexplate with the crankshaft. The dowel pins align the flexplate with the crankshaft for timing purposes.
>
...
> - Connect the electrical connections to the starting motor. Refer to Procedure 013-020 in Section 13.
