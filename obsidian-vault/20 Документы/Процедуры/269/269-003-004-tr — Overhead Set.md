...
figures: 21
lang: "en"
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/269/269-003-004-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/269-003-004-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSZ13"
  - "группа/269"
...
> [!abstract] Процедура · `269-003-004-tr`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/269/269-003-004-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/269-003-004-tr.pdf)
...
> [!danger] WARNING · Опасно
> Do not pull or pry on the fan blades to rotate the crankshaft. Doing so can damage the fan blades. Damaged fans blades can cause premature fan failures, which can result in serious personal injury or property damage.

The valve set marks are located on the vibration damper. The marks align with a pointer on the gear housing.
...
Rotate the vibration damper **clockwise** until the A valve set mark on the damper is aligned with the pointer on the front gear housing.
...
Use the vibration damper to rotate the crankshaft. [[269-000-017 — Engine Barring|Refer to Procedure 000-017 in Section 0.]]
...
When the “A” mark is aligned with the pointer, the intake and exhaust valves for cylinder number 1 **must** be closed. If these conditions are **not** correct, cylinder number 6 **must** be ready to check. Check the valves on the cylinder, making sure both the intake and exhaust valve rocker levers can be rattled by hand or the push tubes can be freely rotated.

Use a set of feeler gauges to measure the amount of clearance (lash) between the crosshead and the rocker lever foot.

Measure and record the intake and exhaust valve lash. If the valve lash is **not** within the specifications listed below, the valve **must** be adjusted. See the Adjust step in this procedure.

| Valve Lash Recheck Limits |  |  |  |
|---|---|---|---|
|  | mm |  | in |
| Intake | 0.40 | MIN | 0.016 |
|  | 0.50 | MAX | 0.020 |
| Exhaust | 0.67 | MIN | 0.026 |
|  | 0.77 | MAX | 0.030 |

![[03c00165.png]]

If the engine is equipped with engine brakes, check the brake piston clearance. Refer to Procedure 020-024 in Section 20.
...
If the engine is equipped with an engine brake, use the following procedure to adjust the engine brake. Refer to Procedure 020-024 in Section 20.
...
After adjusting the valves and engine brakes, if equipped, on the appropriate cylinder, rotate the crankshaft using the vibration damper, and align the next valve set mark with the pointer on the front gear housing. [[269-000-017 — Engine Barring|Refer to Procedure 000-017 in Section 0.]]
