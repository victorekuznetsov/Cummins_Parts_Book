...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/269/269-008-018-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/269-008-018-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSZ13"
  - "группа/269"
...
> [!abstract] Процедура · `269-008-018-tr`
...
> **Даты:** изменён 2015-04-09
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/269/269-008-018-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/269-008-018-tr.pdf)
...
Если охлаждающая жидкость должна быть повторно использована, контейнер должен быть свободен от масла и грязи. Перед тем, как залить охлаждающую жидкость обратно в двигатель, она должна быть проверена на концентрацию SCA. См. процедуру 018-018 в разделе V.

Откройте дренажные краны радиатора.
...
После осушения охлаждающей жидкости немедленно добавьте 3,8 литра \[1 галл\] Fleetguard® RestoreTM, Restore PlusTM или эквивалент, на каждые 38-57 литров \[10-15 галл\] емкости системы охлаждения, и заполните систему простой водой.
...
Выключите двигатель и дайте ему остыть до 50°C[120°F].
...
Выключите двигатель, охладите до 50°C[120°F] и осушите систему охлаждения.
...
Заполните систему охлаждения полностью сформированным хладагентом или смесью 50/50 полностью сформированного антифриза и качественной воды. Используйте сервисный фильтр, чтобы довести охлаждающую жидкость до правильного уровня концентрации SCA. См. процедуру 018-018 в разделе V.
...
Cummins Inc. Рекомендуется использовать Fleetguard® COMPLEAT ESTM. Он доступен в гликольных формах (этилен и пропилен) и соответствует стандартам TMC RP329 и RP330.

![[08c00127.png]]

Заполните систему охлаждения сверхмощной теплоносителями и установите правильный сервисный фильтр. См. процедуру 018-018 в разделе V.
...
Удалите радиатор или заполните крышку и проверьте уровень охлаждающей жидкости. См. руководство по эксплуатации изготовителя оригинального оборудования (OEM) для рекомендаций. Добавьте охлаждающую жидкость, если это необходимо. Не переполняйте.

![[ra800sb.png]]

### Испытание на давление

Соедините линию сжатого воздуха вместо линии вентиляции на резервуаре для перенапряжения.
...
Медленно надавите на систему охлаждения до номинального давления крышки радиатора, пока пузырьки не будут видны в переполненной бутылке.

![[oi800nb.png]]

Если пузырьки начинаются при более низком давлении, чем минимальное рекомендуемое давление колпачка (см. спецификации системы охлаждения), проверьте колпачок давления радиатора. См. процедуру 008-047 в разделе 8.

Замените колпачок, если это необходимо.
...
>
> If the coolant is to be reused, the container **must** be free of oil and dirt. Before pouring coolant back into the engine, it **must** be tested for SCA concentration. Refer to Procedure 018-018 in Section V.
>
...
>
> Fill the cooling system with fully-formulated coolant or a 50/50 mixture of fully-formulated antifreeze and good-quality water. Use a service filter to bring the coolant to the correct SCA concentration level. Refer to Procedure 018-018 in Section V.
>
> ### Fill
>
...
>
> Fill the cooling system with heavy-duty coolant and install the correct service filter. Refer to Procedure 018-018 in Section V.
>
> **Note · Примечание**
