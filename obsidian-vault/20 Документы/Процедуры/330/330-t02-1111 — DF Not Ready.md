...
DF **Not** Ready - сообщение STATUS, указывающее на то, что одно из условий, необходимых для работы с двойным топливом, не было удовлетворено. В этом состоянии панель **не** позволит работать газу.
