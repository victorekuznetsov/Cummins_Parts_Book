---
aliases:
  - "Выбор и обслуживание охлаждающей жидкости — сводка"
type: "Процедура"
doc: "00-379-011"
title_en: "Engine Coolant Selection and Maintenance Summary"
title_ru: "Выбор и обслуживание охлаждающей жидкости — сводка"
modified: "2020-05-11"
engines:
  - "33239899"
  - "37292556"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/00/00-379-011.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/00-379-011.pdf"
tags:
  - "документ/процедура"
  - "двигатель/C8.3"
  - "двигатель/K38/K50"
...
# Engine Coolant Selection and Maintenance Summary
**Выбор и обслуживание охлаждающей жидкости — сводка**

> [!abstract] Процедура · `00-379-011`
...
> **Даты:** изменён 2020-05-11
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/00/00-379-011.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/00-379-011.pdf)
...
| Дизель ISV | CES 14636 |
| Дизельный 12 л Дизельный 15 л Дизельный дизель ISL Дизельный QSB и ISB | CES 14603 CES 14439 |
| Все остальные двигатели | CES 14603 |
...
Отключение системы охлаждения с помощью соответствующего предварительно разбавленного или 50/50 охлаждающей жидкости имеет решающее значение для поддержания концентрации добавок и защиты от замерзания. В целом, различные охлаждающие жидкости не должны смешиваться. **Никогда** не пополняйте систему охлаждения водой **только**.

Охлаждение следует проверять на: Концентрация гликоля, уровень SCA и пределы замены охлаждающей жидкости с различными интервалами в зависимости от типа используемой охлаждающей жидкости. В таблице 2 ниже указаны минимально необходимые интервалы испытаний в зависимости от типа охлаждающей жидкости:

| **Таблица 2, Испытательные интервалы для охладителей Fleetguard®** |  |  |  |  |
|---|---|---|---|---|
| **Тест** | **Обычный** | **Гибридный** | **ОАТ** | **Минимальный требуемый сервис**|
| Гликол 1 | Дважды в год | Дважды в год | Дважды в год | CC2602 |
| Уровень 1 SCA | Каждый смазочный масло слив | Самый короткий из: 241 401 км[150 000 миль], 4000 часов, или 1 год | Не требуется | CC2602 |
| Охлаждение Замена лимитов Проверка | Самый короткий из: 241 401 км[150 000 миль], 4000 часов, или 1 год | Самый короткий из: 241 401 км[150 000 миль], 4000 часов, или 1 год | Самый короткий из: 482 803 км [300 000 миль], 6000 часов или 1 год | CC2718 |

[[00-379-007 — Engine Coolant Testing|См. процедуру 379-007]]в разделе 5, для полного перечня всех применимых инструментов тестирования охлаждающей жидкости.

Cummins Inc. Рекомендуется ориентироваться на концентрацию гликоля/антифриза в 50 процентов по объему. Концентрация гликола должна поддерживаться в соответствии с Таблицей 3.
...
| **Таблица 4, Руководящие принципы добавления к SCA** |  |
|---|---|
| **Концентрация SCA** | **Рекомендации** |
...
| 0.3 единицы/л \[1.2 единицы/США]. gal\) до 0,8 единиц/L\[3,0 единиц/США. гал | Установите правильный фильтр химической охлаждающей жидкости или добавьте правильный жидкий SCA и установите фильтр охлаждающей жидкости без химических веществ. |
| Больше 0,8 единиц/л[3,0 единиц/США]. gal\) - 1,3 единицы/L\[5,0 единиц/США. гал | Установите правильный фильтр охлаждающей жидкости без химикатов, если это применимо. **не** Добавить жидкий SCA. Испытайте уровень SCA при каждом изменении масла, пока SCA не опустится ниже 0,8 единицы / л \[3,0 единицы / США]. Дж. Слить и заменить охлаждающую жидкость, если происходит перегрев или если коррозия системы охлаждения обнаруживается визуальными изменениями внешнего вида охлаждающей жидкости или лабораторными испытаниями. |

Таблица 4 предназначена только для потребителей, использующих охлаждающие жидкости с обычными/гибридными охлаждающими веществами, которые используют SCA. Технология органических кислот (OAT) / Охладители расширенного срока службы используют высокие уровни солей органических кислот для защиты от прокладок цилиндров и не используют нитрит и или молибдат. Поэтому эти охлаждающие жидкости **не **имеют номера SCA. Кроме того, добавки ОАТ истощаются гораздо медленнее, чем обычные добавки, и в результате охлаждающие жидкости ОАТ **не **требуют добавления продуктов SCA.
...
| **Таблица 5, Охлаждение Заменить Пределы** |  |  |
|---|---|---|
| **Загрязнитель** | **Допустимая степень** | **Вне диапазона действий** |
...
| Загрязнение маслом или топливом | Охлаждающее средство **должно быть** свободным от этих загрязнителей | Слить, очистить и заменить новым охлаждающим веществом. См. процедуру 379-009 в разделе 5. |
...
Cummins Inc. Рекомендуется использовать охлаждающие жидкости Fleetguard®.

**Фильтры с охлаждением**

Фильтры охлаждения являются необязательными для всего оборудования Cummins. Большинство двигателей Cummins®, построенных до 1 января 2013 года, были изготовлены с головкой фильтра охлаждающей жидкости. Рекомендуется использовать фильтр охлаждающей жидкости, особенно в тех случаях, когда проблема чистоты может быть проблемой. При желании головка фильтра охлаждающей жидкости для двигателя послепродажного использования от Cummins FiltrationTM может быть легко установлена на большинстве двигателей.
...
> | Glycol 1 | Twice per year | Twice per year | Twice per year | CC2602 |
> | SCA Level 1 | Every lubricating oil drain | Shortest of: 241,401 km \[150,000 miles\], 4000 hours, or 1 year | **Not** required | CC2602 |
...
>
> [[00-379-007 — Engine Coolant Testing|Refer to Procedure 379-007]] in Section 5, for a complete list of all applicable coolant testing tools.
>
