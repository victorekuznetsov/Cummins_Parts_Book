...
Добавление новой нефти также уменьшит количество загрязнений в определенном объеме нефти. Во всех случаях потребление нефти должно быть документально подтверждено количеством масла, добавленного между каждым интервалом обслуживания. Трендовое потребление масла важно, так как любой растущий тренд или изменение уровня потребления масла может указывать на возможное износ цилиндров, утечки системы или другие неисправности системы.

### Ограничения флага

Цель ограничения флага – выявить неблагоприятные тенденции в анализе нефти, которые требуют дальнейшего изучения. Руководящие принципы, предусмотренные в этой процедуре, не должны использоваться для увеличения интервалов слива нефти. Если лимит флага достигнут, обратитесь к местному поставщику услуг Cummins®.
...
- Мощности общей нефтяной системы.

Если все двигатели сгруппированы вместе, независимо от нефтяных систем, двигатели с фильтрацией типа CentinelTM, EliminatorTM/центрифуга и более высокими мощностями масляной системы будут испытывать более высокую степень износа двигателя до достижения предела флага.

| Таблица 1: Пределы анализа моторного масла |  |
|---|---|
| Параметр анализа нефти | предел |
...
| Таблица 3: Пределы загрязнения нефтью для общего базового числа (TBN) |  |  |
|---|---|---|
...
| Кремний (SI) | 15 ppm больше, чем новая нефть |
| Натрий (Na) | 20 ppm прироста по сравнению с новой нефтью |
| Бор (Б) | 25 ppm больше, чем новая нефть |
| Калий (K) | 20 ppm прироста по сравнению с новой нефтью |
| Медь (CU) | 30 ppm больше, чем новая нефть |
| Железо (FE) | 80 ppm выросли по сравнению с новой нефтью |
| Алюминий (AL) | 20 ppm прироста по сравнению с новой нефтью |
...
| Свинец (Pb) | Некоторые приложения: Род и основные подшипники, подшипники турбокомпрессора, втулки распределительного вала, втулки бездельников и вспомогательные приводные втулки и моющие устройства с тягой, втулки смазочных насосов и моющие устройства с тягой |
...
| Таблица 6: Проблемы с двигателем, которые приводят к флагам анализа нефти |  |
|---|---|
