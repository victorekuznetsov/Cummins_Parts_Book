...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/56/56-009-001-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/56-009-001-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK60"
  - "группа/56"
...
> [!abstract] Процедура · `56-009-001-tr`
...
> **Даты:** изменён 2016-10-11
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/56/56-009-001-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/56-009-001-tr.pdf)
...
> [!note] Примечание
> Если воздушный компрессор **не** установлен на двигателе, то для слива системы охлаждения не требуется.

> [!note] Примечание
> Некоторые вспомогательные накопители могут немного отличаться от тех, которые выделены в описанной ниже процедуре, например, соединения и оборудование для монтажа могут отличаться.

- Охлаждение системы, если это применимо.[[56-008-018-tr — Cooling System|См. процедуру 008-018 в разделе 8.]]
- Удалите топливный насос.[[56-005-016-tr — Fuel Pump|См. процедуру 005-016 в разделе 5.]]
- Удалите воздушный компрессор, если это применимо.[[56-012-014-tr — Air Compressor|См. процедуру 012-014 в разделе 12.]]
- Удалите дополнительный шкив привода, если это применимо.[[56-009-004-tr — Accessory Drive Pulley|См. процедуру 009-004 в разделе 9.]]
...
- Удалить уплотнение привода аксессуара, если это применимо.[[56-001-003-tr — Accessory Drive Seal|См. процедуру 001-003 в разделе 3.]]
...
Используйте индикатор циферблата для измерения оконечного зазора вспомогательного приводного вала.

| Скачать игру Shaft End Clearance |  |  |
|---|---|---|
| мм |  | в |
| 0.05 | Мин | 0.002 |
| 0.30 | Макс | 0.0118 |
...
Осмотрите кожух на наличие трещин или поврежденных монтажных отверстий.

Проверить приводное устройство (1) на наличие поврежденных зубов.

Проверить вал (2) на царапины, баллы или другие повреждения
...
> [!note] Примечание
> Сцепная шайба **должна** располагаться плотно между сцепной машиной и валом. Если шайба **не плотная, приводной блок **должен быть восстановлен или заменен.
...
Используйте челюстной съёмник, чтобы удалить тип соединения.
...
| Драйв-шина Thrust Face Distance |  |  |
|---|---|---|
| мм |  | в |
| 45.370 | Мин | 1.7862 |
| 45.450 | Макс | 1.7894 |
...
| Аксессуарный приводной вал вне измерений диаметра |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| (1) | 34.964 | Мин | 1.3765 |
|  | 34.976 | Макс | 1.3770 |
...
Используйте духовку с температурой, отрегулированной до 205 ° C \[400°F \]. Нагрейте шестерню в духовке минимум на 40 минут, но **не **больше, чем максимум на один час. Внутренний диаметр шестерни станет больше и упростит установку шестерни на распределительном валу.
...
Используйте пресс для беседки и вал в качестве подмандатной, чтобы нажать втулку в кожух.
...
Болты могут содержать бурение масла, если воздушный компрессор должен быть установлен на двигателе.
...
| Скачать Drive Shaft End Clearance |  |  |
|---|---|---|
| мм |  | в |
| 0.05 | Мин | 0.002 |
| 0.30 | Макс | 0.0118 |
...
Существует требование **не** выравнивать индекс на приводной передаче с отметками на распределительной передаче на двигателях QSK45 и QSK60.

Установите комплектующий привод сборки, поворачивая вал по мере необходимости для приведения в действие шестерен.
...
> [!warning] ОСТОРОЖНО
> При установке воздушного компрессора использование неправильной шпильной связи приведет к повреждению вспомогательного вала привода.
...
- Установите воздушный компрессор, если это применимо.[[56-012-014-tr — Air Compressor|См. процедуру 012-014 в разделе 12.]]
- Установите топливный насос.[[56-005-016-tr — Fuel Pump|См. процедуру 005-016 в разделе 5.]]
- Заполните систему охлаждения, если это применимо.[[56-008-018-tr — Cooling System|См. процедуру 008-018 в разделе 8.]]
- Запуск и работа двигателя до тех пор, пока температура охлаждающей жидкости не достигнет 71 ° C \[160° F \]. Проверьте на наличие утечек охлаждающей жидкости.
...
>
> **Note · Примечание**
> If an air compressor is **not** mounted on the engine, it is **not** necessary to drain the cooling system.
>
> **Note · Примечание**
> Some accessory drives may differ slightly from the one highlighted in the procedure below for example couplings and mounting hardware may differ.
>
> - Drain the cooling system, if applicable. [[56-008-018-tr — Cooling System|Refer to Procedure 008-018 in Section 8.]]
> - Remove the fuel pump. [[56-005-016-tr — Fuel Pump|Refer to Procedure 005-016 in Section 5.]]
> - Remove the air compressor, if applicable. [[56-012-014-tr — Air Compressor|Refer to Procedure 012-014 in Section 12.]]
> - Remove the accessory drive pulley, if applicable. [[56-009-004-tr — Accessory Drive Pulley|Refer to Procedure 009-004 in Section 9.]]
...
> - Remove the accessory drive seal, if applicable. [[56-001-003-tr — Accessory Drive Seal|Refer to Procedure 001-003 in Section 3.]]
>
> ### Remove
>
...
>
> **Note · Примечание**
> The coupling washer **must** be positioned tightly between the coupling and the shaft. If the washer is **not** tight, the drive unit **must** be rebuilt or replaced.
>
> ### Disassemble
>
> **CAUTION · Осторожно**
...
>
> Use a jaw puller to remove the type coupling.
>
...
> - Install the air compressor, if applicable. [[56-012-014-tr — Air Compressor|Refer to Procedure 012-014 in Section 12.]]
> - Install the fuel pump. [[56-005-016-tr — Fuel Pump|Refer to Procedure 005-016 in Section 5.]]
> - Fill the cooling system, if applicable. [[56-008-018-tr — Cooling System|Refer to Procedure 008-018 in Section 8.]]
