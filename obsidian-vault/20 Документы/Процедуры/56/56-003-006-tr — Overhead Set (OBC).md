...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/56/56-003-006-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/56-003-006-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK60"
...
> [!abstract] Процедура · `56-003-006-tr`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/56/56-003-006-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/56-003-006-tr.pdf)
...
Чтобы определить правый и левый берега на двигателе QSK45 или QSK60, встаньте сзади двигателя и обратитесь к передней части.

![[02600054.png]]

Каждый цилиндр имеет три рычага коромысла. При обращении к головке цилиндра рычагом качения клапанного клапана слева является рычаг качения клапана выхлопного клапана. Рука клапанного клапана справа - это рука впускного клапана. Рука качения центрального клапана предназначена для форсунки.

![[03400025.png]]

Клапаны и топливные форсунки толкателей отличаются. Если они удалены, убедитесь, что толкатели установлены в тех же местах, откуда они были удалены.

![[02400001.png]]

**QSK45 Огнестрельное устройство:**

1R-6L-5R-2L-3R-4L-1L-2R-5L-4R-3L

RB - Правый ряд цилиндров

LB — левый берег цилиндров.

![[02600054.png]]

**QSK60 Огнестрельное устройство:**
...
Направление нормального вращения для двигателей QSK45 и QSK60 составляет **по часовой стрелке**, при обзоре с передней части двигателя.
...
Чтобы определить правый и левый берега на двигателе QSK60, встаньте сзади двигателя и обратитесь к переднему.

Применительно к системной электронике была принята стандартная нумерация цилиндров. Это используется только для компонентов электронной системы на двигателях с электронным топливным форсункой.
...
Если толкатели были удалены для обслуживания, убедитесь, что они установлены в тех же местах, откуда они были удалены.

![[04600032.png]]

**QSK60 Огнестрельное устройство:**

1R-1L-3R-3L-2R-2L-5R-4L-8R-6R-6L-7R-7L-4R-5L или 2-1-6-5-4-3-10-7-16-15-12-11-14-13-8-9.

RB - Правый берег цилиндров

LB - левый берег цилиндров.

Направление нормального вращения для двигателя QSK60 составляет **по часовой стрелке**, при обзоре с передней части двигателя.
...
- Удалите крышку рычага клапанного клапана и все связанные с ней части. См. процедуру 003-011 в разделе 3.
...
Удалите крышку рычага клапанного клапана и все связанные с ней части. См. процедуру 003-011 в разделе A.

Если клапанные клапанные качалки были удалены, на всех цилиндрах заполните следующее:
...
- Толкательные стержни будут находиться вблизи той же высоты над верхней частью корпуса рычага клапанного клапана на цилиндре, который готов к регулировке.
...
Двигатели QSK45 и QSK60 имеют знаки регулировки клапана и форсунки на виброгаситель и по обе стороны корпуса маховика.

Знаки регулировки клапана и форсунки должны быть выровнены с указателем, или может произойти ложная регулировка.

Одна пара клапанов и один форсунка регулируются на каждой отметке шкива, прежде чем вращать двигатель до следующей отметки индекса.
...
> [!warning] ОСТОРОЖНО
> При использовании стартовых крышек на правом берегу должны использоваться отметки на маховике, начинающиеся с А, или клапаны и форсунка не будут правильно отрегулированы, что приведет к повреждению двигателя.

При использовании регулировочных знаков клапана и форсунки на маховике крышка верхнего стартового цилиндра должна быть удалена, чтобы увидеть маркировку.

Знаки A должны использоваться, если знаки просматриваются на правых берегах.
...
> [!warning] ОСТОРОЖНО
> При использовании стартовых крышек на левом берегу должны использоваться отметки на маховике, начинающиеся с С, или клапаны и форсунка не будут правильно отрегулированы, что приведет к повреждению двигателя.
...
VS представляет собой набор клапанов. Игнорируйте любые отметки верхнего центра (TC) при установке клапанов и форсунки.
...
Используйте следующую диаграмму, чтобы определить форсунка, который готов к настройке.

![[03400025.png]]

| QSK45 Внешний круг клапана и форсунка |  |  |  |
|---|---|---|---|
| VS Mark | Закрытые клапаны на цилиндре | Настройка клапанов на число цилиндров | Регулировка форсунки на цилиндре |
| 1R-6R VS | 1R | 1R | 2R |
...
| QSK60 Внешний круг клапана и форсунка |  |  |  |
|---|---|---|---|
| VS Mark | Закрытые клапаны на цилиндре | Настройка клапанов на число цилиндров | Регулировка форсунки на цилиндре |
| 1R-8R VS | 1R | 1R | 6R |
...
| клапан Clearances - начальный набор |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| Выхлопные валы (А) | 0.81 | макс | 0.032 |
| Взятие вейвов (B) | 0.36 | макс | 0.014 |

| клапан Clearances - перепроверка |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| Выхлопные валы (А) | 0.74 | мин. | 0.029 |
|  | 0.89 | макс | 0.035 |
| Взятие вейвов (B) | 0.36 | мин. | 0.014 |
|  | 0.51 | макс | 0.020 |

Существует два различных метода, используемых для установки зазора клапана: Метод гаечного ключа и метод измерительной датчика щупальца; оба описаны ниже. Можно использовать любой метод. Однако метод гаечного ключа крутящего момента оказался наиболее последовательным.

![[06400003.png]]

Убедитесь, что клапанные мостики прочно установлены на стеблях клапана.

Выберите правильный датчик измерения щупальца для устанавливаемых клапанов. Используйте сервисное оборудование, номер 3824901 или эквивалент.

Убедитесь, что калибр для щупальца находится под центром шарика и розетки, или розетка может раскачиваться или наклоняться, что приводит к неправильной регулировке. Держите поворот ноги плоской при проверке ресницы, чтобы избежать ложных показаний.
...
> [!tip] Момент затяжки
> Без адаптера 105 Н·м [77 футов-лб]
...
**Настройка клапана - Метод измерения щупальца:**
...
Используйте крутящий момент циферблата, номер детали 3164795, с диапазоном до 34 Н•м \[25 футов-lb\], чтобы затянуть винт регулирования рычага качения топливного форсунка. Если винт болтается во время установки, отремонтируйте винт и рычаг по мере необходимости.
...
Затянуть винт регулировки форсунки.
...
Если клапанные клапанные качалки были удалены, завершите следующее на обоих цилиндрах:
...
Двигатели QSK60 имеют знаки регулировки клапана на виброгаситель и по обе стороны корпуса маховика.

Знаки регулировки клапана должны быть выровнены с указателем или может произойти ложная регулировка.
...
Используйте следующую диаграмму, чтобы определить цилиндр, который готов к регулировке.

![[03400145.png]]

| QSK60 Outer Base Circle клапан Set (Внешняя база) |  |  |
|---|---|---|
...
- Установите крышку рычага клапанного клапана и все связанные с ней части. См. процедуру 003-011 в разделе 3.
...
> with Mechanically Actuated Injector
>
> - Remove the rocker lever cover and all related parts. Refer to Procedure 003-011 in Section 3.
>
> with Electronically Actuated Injector
>
...
> with Mechanically Actuated Injector
>
> Remove the rocker lever cover and all related parts. Refer to Procedure 003-011 in Section A.
>
...
> Marine Applications
>
> - Install the rocker lever cover and all related parts. Refer to Procedure 003-011 in Section 3.
