...
Чтобы правильно контролировать работу двигателя, запишите следующие параметры. Чтобы ограничить время работы динамометра, инструмент двигателя, чтобы выполнить как можно больше проверок. Инструменты электронного обслуживания INSITETM будут предоставлять большинство, если **не**, следующих услуг:

- Скорость двигателя rpm с проверенным тахометром
- Топливное давление
- Расход топлива
- Температура топлива, если необходимо исправить расход топлива
- Сопротивление на входе топлива
- Сопротивление магистрали слива топлива
- Нажим многократного потребления, в банке.

![[eg200ka.png]]

- Ограничение потребления воздуха, в банке
- Ограничение выхлопного воздуха, в банке
...
Используйте инструмент электронного обслуживания INSITETM для измерения давления подачи топлива.[[56-005-016-tr — Fuel Pump|См. процедуру 005-016 в разделе 5.]]

![[05500009.png]]

Тариф на топливо

Используйте инструмент для электронного обслуживания INSITETM или устройство для измерения расхода топлива.

![[19a00042.png]]

Сопротивление на входе топлива

Используйте инструмент для электронного обслуживания INSITETM или измеритель давления, номер детали ST-434, для измерения ограничения топлива между топливным фильтром и впускным отверстием переключателя.[[56-006-020 — Fuel Inlet Restriction|См. процедуру 006-020 в разделе 6.]]
...
Используйте инструмент электронного обслуживания INSITETM или вручную измеряйте давление впускного коллектора (усилитель турбокомпрессора). См. руководство по устранению неполадок и ремонту электронных систем QSK19, QSK23, QSK45, QSK60 и QSK78, вестник [[3666113 — QSK19, QSK23, QSK45, QSK60, and QSK78 Electronic Control System Troubleshooting and R\|3666113]] или соответствующее руководство по инструментированию электронных услуг.
...
Если двигатель оснащен автоматическим вентилятором, заблокируйте вентилятор охлаждения в режиме ON. Это можно сделать путем установки перемычки через переключатель температуры или путем подачи подачи сжатого воздуха в управляющий клапан. См. информацию об услугах изготовителя оборудования для рекомендуемой процедуры.

![[fa1chwa.png]]

Мониторинг температуры воздуха впускного коллектора с использованием электронного инструментария обслуживания INSITETM в режиме монитора или установка цифрового термометра FlukeTM, Номер детали 3822666 и набора проводов термопары, Номер детали 3822988, в впускной коллектор.

Температура воздуха впускного коллектора **не должна** превышать 77°C[171°F].
...
[[56-014-010-tr — Crankcase Blowby, Measure|См. процедуру 014-010 в разделе 14.]]

![[ck800wa.png]]

Давление моторного масла

Используйте измеритель давления, номер детали. 3375275, или инструмент для электронного обслуживания INSITETM для измерения давления моторного масла. Ссылка на руководство по устранению неполадок и ремонту электронных систем управления QSK19, QSK23, QSK45, QSK60 и QSK78, Бюллетень [[3666113 — QSK19, QSK23, QSK45, QSK60, and QSK78 Electronic Control System Troubleshooting and R\|3666113]].
...
Используйте воздушный танк (2). Установите регулятор (3) воздуха, способный поддерживать давление воздуха от 345 до 517 кПа [50-75 psi ] как при минимальном, так и при максимальном оборотах двигателя.
...
Если используется другой способ запуска двигателя, см. информацию об обслуживании производителя оборудования для подключения.
