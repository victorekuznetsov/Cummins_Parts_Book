...
- Утечка уплотнения (T185) для устранения неполадок дерева симптомов в разделе TS
- Утечка масла из уплотнения (T186), устраняющая неисправности дерева симптомов в разделе TS.
