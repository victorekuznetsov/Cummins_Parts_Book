...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/40/40-005-043-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/40-005-043-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/6B5.9"
  - "группа/40"
...
> [!abstract] Процедура · `40-005-043-tr`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/40/40-005-043-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/40-005-043-tr.pdf)
...
2. Запорные затворы топливных клапанов - 2
3. Шайба - 2
4. Обычная шайба - 2
5. Запорный клапан топлива - 1
6. О-кольцо - 1
7. Затворы запорного клапана адаптера - 2
8. Адаптер клапана отключения топлива - 1
9. Запорные болты запорного клапана - 2
10. Кронштейн запорного клапана - 1.

### Выбор сервисного инструмента

#### Рекомендованный сервисный инструмент Cummins®

- Вольт-омметр, номер детали 3164488.
...
Synchro-Start имеет разъем Weather PackTM с тремя проводами в нем.

| цвет | Наименование | Погодный пакет TM Port |
|---|---|---|
| черный | земля | C |
| белый | Щелчок | B |
| красный | держись | А. |
...
Ссылка на диаграмму ниже, чтобы найти правильный размер измерительной приборной ширины и длину непрерывного провода для белого (втягивающего) провода, который соединяется с соленоидной проводкой.
...
| 14 | 1.5 м[5 футов] | 2,7 м[9 футов] |
| 12 | 2,7 м[9 футов] | 4,3 м[14 футов] |
| 10 | 4,3 м[14 футов] | 7,0 м[23 фута] |
...
- Удалите топливный фильтр и линию подачи топлива, если это необходимо.[[40-006-015-tr — Fuel Filter (Spin-On Type)|См. процедуру 006-015]]и[[40-006-024-tr — Fuel Supply Lines|См. процедуру 006-024 в разделе 6.]]
...
- Удалите линию подачи топлива.[[40-006-024-tr — Fuel Supply Lines|См. процедуру 006-024 в разделе 6.]]
...
Синхро-старт соленоидов с диаметрической катушкой 50,8 мм \[2,00 дюйма\].
...
| Соленоиды Woodward с диаметром колпачка 50,8 мм \[2,00 дюйма \]. |  |  |
|---|---|---|
| Соленоидное напряжение | Допустимая дальность сопротивления в Омсе |  |
|  | Щелчок | держись |
...
Ссылка на таблицу для спецификации напряжения Synchro-Start с соленоидом при 20 ° C \[68 ° F \]. Требования к напряжению будут выше по мере повышения температуры двигателя; поэтому эти значения действительны только при соленоиде при нормальных температурах окружающей среды.
...
Испытайте выключаемый соленоид на насосе впрыска топлива StanadyneTM DB4, применив электрический ток к терминалам и прослушивая щелчок. Если слышен сильный щелчок, соленоид работает свободно.

Используйте следующие значения для проверки энергетизированных соленоидов:

| StandadyneTM DB4 Solenoid |  |
|---|---|
...
Стеклоотвод (Back Leakage клапанs on LucasTM CAV Pumps)
...
| Bosch® Shutdown Values (Ценности закрытия) | Сопротивление Омс | Пик Ампера |
|---|---|---|
| 12 VDC | 7.4 + 0.5 | 2 |
| 24 VDC | 29.5 + 2.5 | 1 |
...
Подключите провод. Убедитесь, что катушка запорного клапана имеет правильное напряжение.

Напряжение катушки и номер детали отбрасываются в конец терминального соединения катушки.

![[fp8vacf.png]]

Переключатель зажигания транспортного средства в положение "Включено".

Проверьте напряжение постоянного тока на катушке с помощью вольт-омметра, Номер детали 3164488 или эквивалент.

Напряжение должно быть таким же, как напряжение батареи.

Переключатель зажигания транспортного средства переключателя в положение "OFF".

![[fv2swkb.png]]

Убедитесь, что провод катушки **не подключен **перед проверкой сопротивления катушки.

Проверьте сопротивление катушки с помощью вольт-омметра. Сопротивление катушки должно быть:
...
Замените катушку, если сопротивление не соответствует спецификациям.

![[fv2swkc.png]]

Переключатель зажигания транспортного средства в положение "Включено". Слушайте, чтобы клапан «щелкнул», когда провод прикасается к терминалу катушки. Если клапан делает **не** "щелчок", ремонт или замена топливного отключающего клапана.
...
- Удалите линию слива топлива.[[40-006-021-tr — Fuel Manifold (Drain)|См. процедуру 006-021 в разделе 6.]].
- Удалите дроссель и отключите связь. См. сервисную документацию изготовителя оборудования.
- Удалите непроницаемые винты с помощью набора для инструментов, номер детали 3399870.[[40-005-012-tr — Fuel Injection Pumps, In-Line|См. процедуру 005-012]]или[[40-005-014-tr — Fuel Injection Pump, Rotary|См. процедуру 005-014 в разделе 5.]].
...
- Разобрать крышку топливного насоса. Ссылка на Руководство по ремонту, насосы для топливных форсунок и топливный форсунок, Вестник 3666037.
...
Удалите адаптер клапана отключения топлива, клапан отключения топлива, кольцо, шайбу замка, простую шайбу и болты.
...
Замените кронштейн, разъём и адаптер отключения топлива, если обнаружена трещина или повреждение.
...
> [!warning] ОСТОРОЖНО
> Новые соленоидные крепежные болты должны использоваться при замене старого соленоида размером 1-3/4 дюйма на 2-дюймовый соленоид. Недостаточное зацепление резьбы может привести к повреждению насоса и соленоида.
...
Установите кольцо o-ring на канавку

![[05400430.png]]

Установите запорный клапан, шайбу и простую шайбу.
...
> 2. Fuel shutoff valve mounting capscrew - 2
> 3. Lock washer - 2
> 4. Plain washer - 2
> 5. Fuel shutoff valve - 1
> 6. O-ring - 1
> 7. Fuel shutoff valve adapter capscrew - 2
> 8. Fuel shutoff valve adapter - 1
> 9. Fuel shutoff valve bracket capscrew - 2
> 10. Fuel shutoff valve bracket - 1.
>
...
> | Red | Hold-in | A |
>
> Reference the chart below to find the correct gauge size and length of continuous wire for the white (pull-in) wire which connects to the solenoid wiring.
>
...
> - Remove the fuel filter and fuel supply line, if necessary. [[40-006-015-tr — Fuel Filter (Spin-On Type)|Refer to Procedure 006-015]] and [[40-006-024-tr — Fuel Supply Lines|Refer to Procedure 006-024 in Section 6.]]
...
> - Remove the fuel supply line. [[40-006-024-tr — Fuel Supply Lines|Refer to Procedure 006-024 in Section 6.]]
>
> ### Initial Check
>
...
>
> Reference the table for Synchro-Start voltage specification with solenoid at 20°C \[68°F\]. Voltage requirements will be higher as engine temperature rises; therefore, these values are **only** valid with the solenoid at normal ambient temperatures.
>
...
>
> Check the DC voltage to the coil with a volt-ohm meter, Part Number 3164488, or equivalent.
>
...
> - Remove the fuel drain line. [[40-006-021-tr — Fuel Manifold (Drain)|Refer to Procedure 006-021 in Section 6]].
> - Remove the throttle and shutoff linkage. See equipment manufacturer service information.
> - Remove tamper-resistant screws using service tool kit, Part Number 3399870. [[40-005-012-tr — Fuel Injection Pumps, In-Line|Refer to Procedure 005-012]] or [[40-005-014-tr — Fuel Injection Pump, Rotary|Refer to Procedure 005-014 in Section 5]].
...
> - Disassemble the fuel injection pump top cover. Reference the Master Repair Manual, Injector Pumps and Injectors, Bulletin 3666037.
>
> Bosch™ A Pump with RSV Governor
>
...
>
> Remove the fuel shutoff valve adapter, fuel shutoff valve, o-ring, lock washer, plain washer, and capscrews.
>
...
>
> Install the fuel shutoff valve, lock washer, and plain washer.
>
> Tighten the capscrews
>
> **Момент затяжки · Torque Value**
