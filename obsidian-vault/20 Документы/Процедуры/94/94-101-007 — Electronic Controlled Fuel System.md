...
Условия неисправности заставят выходы реле Common Warning или Common Alarm (2A @ 30 VDC) быть активизированы ECM. Выбранные GOEM устройства, используя эти схемы, заставят оператора знать, что существует неисправность.
