...
- INLINETM 7 CAN Data Bus Adapter Kit, Part Number 5299899 or 5572620
- Цифровой мультиметр, номер детали 3164488
...
Инструмент диагностики шины данных J1939 CAN используется для выявления проблем с производительностью шины данных J1939 CAN.

Диагностический инструмент шины данных J1939 CAN **только **совместим с набором адаптера шины данных Cummins® INLINETM 7 CAN, Номер детали 5299899 или 5572620. В противном случае, устранение неполадок шины данных J1939 CAN должно быть выполнено с помощью цифрового мультиметра, Часть Номер 3164488.

Используйте следующую процедуру для продолжения опубликованного устранения неполадок, если комплект адаптера шины данных Cummins® INLINETM 7 CAN, Part Number 5299899 или 5572620, недоступен. См. процедуру 019-417 в разделе 19.

С помощью инструмента диагностики шины данных J1939 CAN отключат все соединения с модулем управления двигателем (ECM).

Если требуется рекомендованное электронное средство обслуживания Cummins® или его эквивалент, диагностический инструмент шины данных J1939 CAN должен быть отключен от ECM.

Диагностический инструмент шины данных J1939 CAN может использоваться во время работы двигателя и может быть остановлен в любое время.

не водить автомобиль во время выполнения J1939 CAN данных шины диагностической инструмент, если не направлено опубликованной устранение неполадок.

Инструмент расположен в инструменте электронного сервиса под вкладкой Инструменты в верхней панели инструментов. См. рисунок 1. Инструмент диагностики шины данных J1939 CAN ранее был известен как инструмент диагностики шины Controller Area Network (CAN).

![[14k00033.png]]

Рисунок 1 Табличка инструментов в верхней панели инструментов электронного обслуживания

При открытии инструмента диагностики шины данных J1939 появится вкладка «Настройки», которая будет содержать параметры настроек соединения и каталог местоположений файлов для сохранения журналов после записи. См. рисунок 2.

![[00u00098.png]]

Рисунок 2, J1939 CAN шина данных Диагностические настройки инструмента вкладка

1. Выбор вкладок
2. Параметры настроек подключения
3. Запись местонахождения лог-файла.

Диагностический инструмент шины данных J1939 CAN также может записывать журналы и воспроизводиться при отключении от ECM. См. рисунок 3.

![[00u00099.png]]

Рисунок 3, Запись Tab

1. Запись на вкладке
2. Доступные записи.

Диагностический инструмент шины данных J1939 CAN будет **не** запущен или будет прерван в следующих ситуациях:

- Проводится диагностический тест.
- Адаптер шины данных INLINETM 7 CAN не используется.
- Адаптер шины данных INLINETM 7 CAN **не** подключен к трехконтактному сервисному разъему.
- Низкое напряжение батареи.

### Подготовительные операции

не использовать инструмент диагностики шины данных J1939 CAN с активными кодами неисправностей, если только он не руководствуется процедурой обслуживания и/или опубликованным устранением неполадок.

Перед использованием инструмента диагностики шины данных J1939 CAN выполните следующие шаги:

1. Подключите адаптер шины данных INLINETM 7 CAN к трехконтактному сервисному разъему.
2. Подключите аллигаторы к адаптеру шины данных INLINETM 7 CAN к надежному источнику напряжения.

### Использование инструментов

Чтобы начать использовать диагностический инструмент шины данных J1939 CAN, выполните следующие шаги:

- Переведите замок зажигания в положение OFF.
- Подключите адаптер шины данных INLINETM 7 CAN к трехконтактному сервисному разъему и соедините зажимы аллигатора шины данных INLINETM 7 CAN с надежным источником напряжения.
- Откройте диагностический инструмент шины данных J1939, найденный во вкладке Инструменты.
- Выберите соответствующие настройки подключения во вкладке «Настройки».
- Выберите кнопку Connect.
- Выберите кнопку Запись.
- Переведите замок зажигания в положение ON.
- Проверка транспортного средства и окружающей его территории осуществляется во время использования диагностического инструмента шины данных J1939 CAN. Если возникает какое-либо небезопасное состояние, выключите ключ или немедленно выключите двигатель.

См. раздел Анализ данных этой процедуры для ремонта действий по результатам.

Если связь между диагностическим инструментом шины данных J1939 CAN и ECM по какой-либо причине будет потеряна, появится всплывающее сообщение. В этом случае диагностический инструмент шины данных J1939 CAN автоматически отключается. Диагностический инструмент шины данных J1939 CAN можно перезапустить после нажатия на кнопку Connect, а затем включить переключатель зажигания в положение Включения.

### Анализ данных

Неактивное устранение неисправностей кода

Для неактивного устранения неполадок кода неисправности выполните следующие шаги в порядке:

Выберите кнопку Отключить на диагностическом инструменте шины данных J1939.

Выключите замок зажигания.

Отсоедините каждую батарею друг от друга и выполните индивидуальный тест нагрузки на каждую батарею.

См. спецификации производителя оригинального оборудования (OEM) для приемлемых пороговых значений для 12 систем VDC и 24 систем VDC. Если напряжение **не** в спецификации OEM, заряжайте или заменяйте батареи.

Проверяйте предохранители питания аккумулятора ECM, предохранители питания аккумулятора после обработки и предохранители питания аккумулятора для повреждения, коррозии или рыхлых соединений.

Используйте диагностический инструмент шины данных J1939 CAN для подключения, нажав кнопку Connect, а затем нажмите кнопку Record.

Запустите двигатель и доведите его до рабочей температуры (выше 70°C \[158°F \]).

Проведите дорожные испытания.

Когда дорожные испытания будут завершены, прекратите запись и нажмите кнопку Отключить.

Выберите вкладку Записи и выберите журнал, нажав кнопку Play.

Выберите вкладку J1939 Component Summary.

Игнорируйте компонент «Замедлитель — Двигатель».

Соберите названия компонентов с помощью дельты Timestamp Delta (sec) в 30 секунд или более. См. рисунок 4.

![[00k00247.png]]

Рисунок 4, J1939 Компонентное резюме в режиме воспроизведения

1. Имя вкладки
2. Компоненты с адресом претензии TS Delta менее 30 секунд
3. Компоненты с адресом запроса TS Delta более 30 секунд.

Если ни один из компонентов J1939 не имеет значения Claim Address TS Delta (sec) 30 секунд или более, перейдите на вкладку Log Navigator (Component Comm).

Поиск любых пиков более 1000 миллисекунд во вкладке Log Navigator (Component Comm). См. рисунок 5.

![[00u00100.png]]

Рисунок 5, Лог-навигатор (Component Comm) в режиме воспроизведения

1. Имя вкладки
2. Первая пара пиков/дипов
3. Вторая пара пиков/дипов
4. 1000 миллисекунд клещей.

Спайки, превышающие 1000 миллисекунд, представляют собой потерю связи.

Устранение неполадок компонентов J1939 с помощью пиков более 1000 миллисекунд во вкладке Log Navigator (Component Comm).

Ниже приведена таблица, которая показывает, какая схема для устранения неполадок для компонентов J1939 с шипами.

| Компоненты со шипами более 1000 миллисекунд и адресом претензии TS Delta (sec) | Обсуждение Troubleshoot |
|---|---|
| Менее 30 секунд | J1939 Схема шины данных КАН |
| Более 30 секунд | Мощность и наземная схема |

См. соответствующую схему проводов для двигателя, над которым ведется работа по устранению неполадок.

Активное устранение неисправностей кода

Для однократного и многократного активного устранения неполадок кода неисправности выполните следующие действия в порядке:

Выберите статус компонента и вкладку напряжения CAN.

Игнорируйте компонент «Замедлитель — Двигатель».

Используйте приведенный ниже список, чтобы сравнить, какие компоненты **не **присутствуют в вкладке «Статус компонента» и «Напряжение CAN».

- ECM 1
- Датчик NOx для поглощения
- Датчик NOx выходной
- Датчик температуры выхлопного газа
- Датчик качества Urea.

Получите следующую информацию из состояния компонента и вкладки напряжения CAN.

1. Названия компонентов, которые **не **присутствуют по сравнению с приведенным выше списком
2. CAN H (J1939+) среднее напряжение
3. CAN L (J1939-) среднее напряжение
4. Средняя шинный загрузка (%).

Сопоставьте информацию, собранную с наиболее близкой моделью в матрице известных неисправностей J1939. См. Рисунок 6.

![[00k00249.png]]

Рисунок 6, Состояние компонента и Совместимость с неисправностью вкладки напряжения CAN

1. Имя вкладки
2. J1939 Компонентный статус связи
3. Средние статистические значения
4. Соответствующий шаблон, который был сопоставлен.

Устранение неполадок вероятная причина в связи с найденным матчем.

Следуйте за процессом технической эскалации, если не определено совпадение из матрицы известных неисправностей J1939.

Устранение неполадок компонентов J1939, OEM-проводов, электропроводки двигателя и всех межсоединений.

После того, как проблема будет подтверждена, прекратите запись.

### Завершающие операции

- Анализ данных, собранных с помощью инструмента.
- Переключатель зажигания в положение выключения в течение 90 секунд.
- Выключите замок зажигания до подтверждения того, что все компоненты взаимодействуют и что напряжение J1939 находится на номинальном уровне 2,5 ВДК (±0,1 ВДК).
