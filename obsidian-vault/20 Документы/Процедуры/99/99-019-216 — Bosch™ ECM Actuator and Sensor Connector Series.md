---
aliases:
  - "Разъёмы датчиков и исполнительных механизмов ЭБУ Bosch™"
type: "Процедура"
doc: "99-019-216"
title_en: "Bosch™ ECM Actuator and Sensor Connector Series"
title_ru: "Разъёмы датчиков и исполнительных механизмов ЭБУ Bosch™"
modified: "2009-04-23"
engines:
  - "37292556"
  - "37295879"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/99/99-019-216.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/99-019-216.pdf"
tags:
  - "документ/процедура"
  - "двигатель/C8.3"
  - "двигатель/NT/NTA855"
...
# Bosch™ ECM Actuator and Sensor Connector Series
**Разъёмы датчиков и исполнительных механизмов ЭБУ Bosch™**

> [!abstract] Процедура · `99-019-216`
...
> **Даты:** изменён 2009-04-23
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/99/99-019-216.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/99-019-216.pdf)
...
Разъем используется для присоединения соответствующей проводной ремни к ECM.
...
Используйте инструмент извлечения Bosch® (2), Part Number 3164093 (небольшие терминалы) или используйте инструмент извлечения Bosch® (1), Part Number 3164091 (большие терминалы) по проводу для удаления штифта из разъема.
...
Вставьте инструмент для извлечения штифтов в отверстия для разблокировки в разъеме.
...
Используйте резак для резки 127 мм \[5 in\] провода и штифта.
...
Используйте тепловую пушку, номер детали 3822860, для нагрева термоусадочной трубы вокруг провода.

Трубка будет сжиматься и делать соединение водонепроницаемым.

![[19d01803.png]]

Проволочный терминал имеет штифты определения местоположения, которые ** только ** позволяют установить его в определенной ориентации.
...
> [!note] Примечание
> Если запирающий тан провода ** не** зацепился, то удалите провод, отсоедините тан от терминала и повторите этот шаг.

![[19d01321.png]]

### Замена разъёма

Этот разъем используется для присоединения жгута проводов двигателя к ECM.
...
Удалите один контактный провод за раз. Если необходимо заменить более одного провода, прикрепите к каждому удаленному проводу буквенную метку.
...
Тщательно вытащите провод из разъема и запишите отверстие, из которого вынимается штифт. Если удалить ее трудно, повторите всю процедуру.
...
> [!missing]- Иллюстрация `19d01324.png` не извлечена — смотрите PDF-оригинал документа

Вставьте штифты в правильное отверстие сменного разъёма.
...
Закройте оболочку разъема на разъем и проводку ремня, нажав его на танге разъема, пока не будет слышен щелчок.
...
>
> **Note · Примечание**
> If the wire's locking tang has **not** latched, then remove the wire, pry the tang away from the terminal, and repeat this step.
>
