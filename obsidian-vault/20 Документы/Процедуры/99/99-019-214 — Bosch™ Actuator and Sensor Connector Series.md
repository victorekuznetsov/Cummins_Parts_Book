---
aliases:
  - "Разъёмы датчиков и исполнительных механизмов Bosch™"
type: "Процедура"
doc: "99-019-214"
title_en: "Bosch™ Actuator and Sensor Connector Series"
title_ru: "Разъёмы датчиков и исполнительных механизмов Bosch™"
modified: "2009-03-19"
engines:
  - "33210083"
  - "33219033"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/99/99-019-214.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/99-019-214.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K19"
  - "двигатель/NT/NTA855"
...
# Bosch™ Actuator and Sensor Connector Series
**Разъёмы датчиков и исполнительных механизмов Bosch™**

> [!abstract] Процедура · `99-019-214`
...
> **Семейство:** K19, NT/NTA855 · ISM/QSM11, QSK23, QSK60, QSM11, QST30, QSX15
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/99/99-019-214.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/99-019-214.pdf)
...
Разъем не ремонтируем. Если какая-либо часть разъема повреждена, замените разъем соответствующим ремонтным разъемом.
...
Убедитесь, что правильные провода подключены к контакту 1, контакту 2 и контакту 3, когда требуется замена.
...
Перед тем, как разрезать провода, измерьте и пометьте три провода.

Используйте резак для резки провода 1 117 мм \[4-1⁄2 в\] от поверхности разъема.

Используйте резак для резки провода 2 104 мм \[4 в\] от поверхности разъема.

Используйте резак для резки провода 3 91 мм \[3-1⁄2 в\] от поверхности разъема.

![[19d01700.png]]

Используйте инструмент для обжима проводов, номер детали 3822930, чтобы удалить 6 мм изоляции из всех электрических проводов.
...
Используйте тепловую пушку, номер детали 3822860, чтобы уменьшить трубку. Трубка будет сжиматься и делать соединение водонепроницаемым.

> [!missing]- Иллюстрация `19d01701.png` не извлечена — смотрите PDF-оригинал документа

Заверните провода лентой для дополнительной защиты, чтобы завершить ремонт.

> [!missing]- Иллюстрация `19d01702.png` не извлечена — смотрите PDF-оригинал документа


> [!quote]- Original (English) · английский оригинал
> ### Pin Replacement
>
> The connector is **not** repairable. If any part of the connector becomes damaged, replace the connector with the appropriate repair connector.
>
...
>
> Make sure the correct wires are connected to pin 1, pin 2, and pin 3, when replacement is necessary.
>
...
>
> Use wire cutters to cut wire 1 117 mm \[4-½ in\] from the face of the connector.
>
> Use wire cutters to cut wire 2 104 mm \[4 in\] from the face of the connector.
>
> Use wire cutters to cut wire 3 91 mm \[3-½ in\] from the face of the connector.
>
> Use wire crimping tool, Part Number 3822930, to remove 6 mm \[¼ in\] of insulation from all electrical wires.
>
...
>
> Use heat gun, Part Number 3822860, to shrink the tubing. The tubing will shrink and make the connection waterproof.
>
