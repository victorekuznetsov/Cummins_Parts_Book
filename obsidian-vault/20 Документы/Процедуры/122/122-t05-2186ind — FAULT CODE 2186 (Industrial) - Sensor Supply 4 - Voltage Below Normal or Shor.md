---
aliases:
  - "Код 2186 (промышленный) — питание датчиков 4 — напряжение ниже нормы"
type: "Процедура"
doc: "122-t05-2186ind"
title_en: "FAULT CODE 2186 (Industrial) - Sensor Supply 4 - Voltage Below Normal or Shorted to Low Source"
title_ru: "Код 2186 (промышленный) — питание датчиков 4 — напряжение ниже нормы"
modified: "2017-03-23"
engines:
  - "33239746"
  - "33239899"
...
manuals:
  - "4022102"
lang: "en"
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/122/122-t05-2186ind.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/122-t05-2186ind.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K38/K50"
  - "группа/122"
...
# FAULT CODE 2186 (Industrial) - Sensor Supply 4 - Voltage Below Normal or Shorted to Low Source
**Код 2186 (промышленный) — питание датчиков 4 — напряжение ниже нормы**

> [!abstract] Процедура · `122-t05-2186ind`
> **Двигатели:** [[33239746 — QSK60 CM2150 MCRS CPL 3451|33239746]], [[33239899 — QSK50 CM2150 MCRS CPL 3379|33239899]]
> **Семейство:** K38/K50 · QSK38, QSK50, QSK60
> **Входит в руководства:** [[4022102 — QSK38, QSK50, and QSK60 CM2150 Electronic Control System Troubleshooting and Repair M|4022102]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2017-03-23
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/122/122-t05-2186ind.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/122-t05-2186ind.pdf)
...
|  | **STEP 3I.** Check the circuit response. | Fault Code 2186 active? |
...
|  | **STEP 4J.** Check the circuit response. | Fault Code 2186 active? |
...
|---|---|---|
| **Action** | **Specification/Repair** | **Next Step** |
| Inspect the sensor pins and engine harness connector for damage. Refer to Procedure 019-361 in Section 19. Use INSITE™ electronic service tool to read the fault codes | Fault Code 2186 active? **YES** | 3I |
| Fault Code 2186 active? **NORepair:** Replace the fuel supply pressure sensor. Refer to Procedure 019-398 in the Associated Procedures Table. | 6A |  |

#### STEP 3I. Check the circuit response.

| **Conditions:** Turn keyswitch OFF. Disconnect the pre-filter oil pressure sensor from the engine harness. Turn keyswitch ON. Connect INSITE™ electronic service tool. |  |  |
|---|---|---|
| **Action** | **Specification/Repair** | **Next Step** |
| Inspect the sensor pins and engine harness connector for damage. Refer to Procedure 019-361 in Section 19. Use INSITE™ electronic service tool to read the fault codes | Fault Code 2186 active? **YES** | 5A |
| Fault Code 2186 active? **NORepair:** Replace the pre-filter oil pressure sensor. Refer to Procedure 019-126 in the Associated Procedures Table. | 6A |  |
...
|---|---|---|
| **Action** | **Specification/Repair** | **Next Step** |
| Inspect the sensor pins and engine harness connector for damage. Refer to Procedure 019-361 in Section 19. Use INSITE™ electronic service tool to read the fault codes | Fault Code 2186 active? **YES** | 4I |
| Fault Code 2186 active? **NORepair:** Replace the fuel supply pressure sensor. Refer to Procedure 019-398 in the Associated Procedures Table. | 6A |  |

#### STEP 4I. Check the circuit response.

| **Conditions:** Turn keyswitch OFF. Disconnect the pre-filter oil pressure sensor from the engine harness. Turn keyswitch ON. Connect INSITE™ electronic service tool. |  |  |
|---|---|---|
| **Action** | **Specification/Repair** | **Next Step** |
| Inspect the sensor pins and engine harness connector for damage. Refer to Procedure 019-361 in Section 19. Use INSITE™ electronic service tool to read the fault codes | Fault Code 2186 active? **YES** | 4J |
| Fault Code 2186 active? **NORepair:** Replace the pre-filter oil pressure sensor. Refer to Procedure 019-126 in the Associated Procedures Table. | 6A |  |

#### STEP 4J. Check the circuit response.

| **Conditions:** Turn keyswitch OFF. Disconnect the post-filter oil pressure sensor from the engine harness. Turn keyswitch ON. Connect INSITE™ electronic service tool. |  |  |
|---|---|---|
| **Action** | **Specification/Repair** | **Next Step** |
| Inspect the sensor pins and engine harness connector for damage. Refer to Procedure 019-361 in Section 19. Use INSITE™ electronic service tool to read the fault codes | Fault Code 2186 active? **YES** | 5A |
| Fault Code 2186 active? **NORepair:** Replace the post-filter oil pressure sensor. Refer to Procedure 019-447 in the Associated Procedures Table. | 6A |  |

### STEP 5. Check the ECM and engine harness.

#### STEP 5A. Check for a pin-to-pin short circuit in the engine harness.

| **Conditions:** Turn keyswitch OFF. Disconnect the engine harness from the ECM connector. Disconnect the camshaft speed sensor from the engine harness. Disconnect the rail fuel pressure sensor from the engine harness. Disconnect the intake manifold air temperature and pressure sensor from the engine harness. Disconnect the crankcase pressure sensor from the engine harness. Disconnect the engine oil pressure sensor from the engine harness. Disconnect the ambient air pressure sensor from the engine harness. Disconnect the engine coolant pressure sensor from the engine harness. Disconnect the pre-filter oil pressure sensor sensor from the engine harness. Disconnect the post-oil filter pressure sensor from the engine harness. |  |  |
|---|---|---|
| **Action** | **Specification/Repair** | **Next Step** |
...
| Greater than 100k ohms? **NORepair:** Repair or replace the OEM harness. Refer to Procedure 019-043 in the Associated Procedures Table. | 6A |  |
...
| Engine Control Module | Refer to Procedure 019-031 | QSK38, QSK50, and QSK60 CM2150 | [[4022102 — QSK38, QSK50, and QSK60 CM2150 Electronic Control System Troubleshooting and Repair M\|4022102]] |
...
| Pre-Filter Oil Pressure Sensor | Refer to Procedure 019-126 | QSK38, QSK50, and QSK60 CM2150 | [[4022102 — QSK38, QSK50, and QSK60 CM2150 Electronic Control System Troubleshooting and Repair M\|4022102]] |
...
| Post-Oil Filter Pressure Sensor | Refer to Procedure 019-447 | QSK38, QSK50, and QSK60 CM2150 | [[4022102 — QSK38, QSK50, and QSK60 CM2150 Electronic Control System Troubleshooting and Repair M\|4022102]] |
