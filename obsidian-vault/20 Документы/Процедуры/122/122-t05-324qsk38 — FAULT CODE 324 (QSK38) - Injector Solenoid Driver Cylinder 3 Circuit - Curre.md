---
aliases:
  - "Код 324 (QSK38) — цепь электромагнита форсунки цилиндра 3 — ток ниже нормы или обрыв"
type: "Процедура"
doc: "122-t05-324qsk38"
title_en: "FAULT CODE 324 (QSK38) - Injector Solenoid Driver Cylinder 3 Circuit - Current Below Normal or Open Circuit"
title_ru: "Код 324 (QSK38) — цепь электромагнита форсунки цилиндра 3 — ток ниже нормы или обрыв"
modified: "2019-06-04"
engines:
  - "33239899"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/122/122-t05-324qsk38.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/122-t05-324qsk38.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K38/K50"
  - "группа/122"
...
> [!abstract] Процедура · `122-t05-324qsk38`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/122/122-t05-324qsk38.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/122-t05-324qsk38.pdf)
...
|  | **ШАГ 1В.** Прочитайте коды неисправностей с помощью инструментария электронного обслуживания INSITETM. | Код 324 не активен? |
...
|  | **ШАГ 2Е.** Прочитайте коды ошибок. | Код 324 является единственным активным кодом ошибки. |
...
| **Условия:** Включите переключатель зажигания на подключенной электронном сервисе INSITETM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте короткое замыкание на землю. Измерьте сопротивление между соленоидным цилиндром 1 двигателя и заземлением блока двигателя. Измерьте сопротивление между соленоидным цилиндром 3 двигателя и заземлением блока двигателя. Измерьте сопротивление между соленоидным цилиндром 5 двигателя и заземлением блока двигателя. Используйте схему проводов для идентификации контакта с разъемом и используйте следующую процедуру для общих методов измерения сопротивления.[[99-019-360 — Resistance Measurement Using a Multimeter\|См. процедуру 019-360 в разделе 19.]] | Больше 100 тысяч ом? *Да | 3C |
| Больше 100 тысяч ом? **NORepair:** Заменить форсунка (форсунки). Для двигателей QSK45 и QSK60 см. следующую процедуру замены форсунки в Руководстве по эксплуатации, QSK45 и QSK60, Вестник [[4021530 — QSK45 and QSK60 Service Manual\|4021530]].[[56-006-026-tr — Injector\|См. процедуру 006-026 в разделе 6.]]Для двигателей K38, K50 и QSKK38 см. следующую процедуру замены форсунки в Руководстве по эксплуатации, K38, K50, QSK38 и QSK50, Вестник [[4021528 — K38, K50, QSK38, and QSK50 Service Manual\|4021528]].[[28-006-026-tr — Injector\|См. процедуру 006-026 в разделе 6.]] | 4А |  |

#### ШАГ 3C. Проверьте жгут электропроводки двигателя.

| **Условия:** Переключатель зажигания выключите Отключите разъёмы жгута двигателя от форсунки соленоидного цилиндра водителя 1, 3 и 5 разъемов Отключите разъемы жгута двигателя от разъема штифта ECM 60. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
...
| **Условия:** Выключите замок зажигания. Отсоедините разъёмы жгута проводов двигателя от разъема ECM 60 pin. Отсоедините разъёмы жгута проводов двигателя от топливных форсунок соленоидного цилиндра водителя 1, 3 и 5 разъемов. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте короткое замыкание на землю. Измерить сопротивление от форсунки соленоидного цилиндра водителя 1 сигнального контакта на проводах двигателя упряжкой ECM 60 штифтового разъема к заземлению блока двигателя. Повторите проверку на цилиндре 3 SIGNAL для водителя соленоида форсунки и цилиндре 5 SIGNAL для водителя соленоида форсунки на разъёме 60 штифтов электропроводки двигателя. Измерить сопротивление от форсунки соленоидного цилиндра водителя 1 обратного контакта на проводах двигателя упряжкой ECM 60 штифтового разъема к заземлению блока двигателя. Повторите проверку для цилиндра 3 RETURN форсунки и цилиндра 5 RETURN для форсунки на разъёме 60 пин-коннектора электропроводки двигателя. Используйте схему проводов для идентификации контакта с разъемом и используйте следующую процедуру для общих методов измерения сопротивления.[[99-019-360 — Resistance Measurement Using a Multimeter\|См. процедуру 019-360 в разделе 19.]] | Больше 100 тысяч ом? *Да | 3С-2 |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for continuity in the injector solenoid driver cylinder 3 circuit. Measure the resistance between the injector solenoid driver cylinder 3 SIGNAL pin and the injector solenoid driver cylinder 3 RETURN pin at the engine harness ECM connector. Use a wiring diagram for connector pin identification and use the following procedure for general resistance measurement techniques. [[99-019-360 — Resistance Measurement Using a Multimeter\|Refer to Procedure 019-360 in Section 19.]] | 0.5 to 5 ohms? **YES** | 2E |
> | 0.5 to 5 ohms? **NO** | 2C |  |
>
> #### STEP 2C. Inspect the injector harness connector pins.
>
> | **Conditions:** Turn keyswitch OFF Disconnect engine harness connector from the ECM 60 pin connector Disconnect engine harness connector from the injector solenoid driver cylinder 3 connector. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Inspect the engine harness and injector connector pins for the following: Loose connector Corroded pins Bent or broken pins Pushed back or expanded pins Moisture in or on the connector Missing or damaged connector seals Dirt or debris in or on the connector pins Connector shell broken Wire insulation damage Damaged connector locking tab. Use the following procedure for general inspection techniques. [[99-019-361 — Component Connector and Pin Inspection\|Refer to Procedure 019-361 in Section 19.]] | Dirty or damaged pins? **YESRepair:** Clean the connector and pins. Replace the damaged section of the harness or damaged injector. Refer to the circuit diagram or wiring diagram for all harness interconnections. [[122-019-043 — Engine Wiring Harness\|Refer to Procedure 019-043 in Section 19.]] For QSK45 and QSK60 engines, see the following procedure to replace the injector in Service Manual, QSK45 and QSK60, Bulletin [[4021530 — QSK45 and QSK60 Service Manual\|4021530]]. [[56-006-026-tr — Injector\|Refer to Procedure 006-026 in Section 6.]] For K38, K50, and QSKK38 engines, see the following procedure to replace the injector in Service Manual, K38, K50, QSK38 and QSK50, Bulletin [[4021528 — K38, K50, QSK38, and QSK50 Service Manual\|4021528]]. [[28-006-026-tr — Injector\|Refer to Procedure 006-026 in Section 6.]] | 4A |
...
> | 0.5 to 5 ohms? **NORepair:** Replace the injector(s). For QSK45 and QSK60 engines, see the following procedure to replace the injector in Service Manual, QSK45 and QSK60, Bulletin [[4021530 — QSK45 and QSK60 Service Manual\|4021530]]. [[56-006-026-tr — Injector\|Refer to Procedure 006-026 in Section 6.]] For K38, K50, and QSKK38 engines, see the following procedure to replace the injector in Service Manual, K38, K50, QSK38 and QSK50, Bulletin [[4021528 — K38, K50, QSK38, and QSK50 Service Manual\|4021528]]. [[28-006-026-tr — Injector\|Refer to Procedure 006-026 in Section 6.]] | 4A |  |
>
...
> | Greater than 100k ohms? **NORepair:** Replace the injector(s). For QSK45 and QSK60 engines, see the following procedure to replace the injector in Service Manual, QSK45 and QSK60, Bulletin [[4021530 — QSK45 and QSK60 Service Manual\|4021530]]. [[56-006-026-tr — Injector\|Refer to Procedure 006-026 in Section 6.]] For K38, K50, and QSKK38 engines, see the following procedure to replace the injector in Service Manual, K38, K50, QSK38 and QSK50, Bulletin [[4021528 — K38, K50, QSK38, and QSK50 Service Manual\|4021528]]. [[28-006-026-tr — Injector\|Refer to Procedure 006-026 in Section 6.]] | 4A |  |
>
