---
aliases:
  - "Код 2262 — давление подачи топливного насоса ниже нормы — низший уровень"
type: "Процедура"
doc: "122-t05-2262"
title_en: "FAULT CODE 2262 - Fuel Pump Delivery Pressure - Data Valid But Below Normal Operating Range - Least Severe Level"
title_ru: "Код 2262 — давление подачи топливного насоса ниже нормы — низший уровень"
modified: "2015-04-07"
engines:
  - "33239746"
  - "33239899"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/122/122-t05-2262.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/122-t05-2262.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K38/K50"
  - "группа/122"
...
# FAULT CODE 2262 - Fuel Pump Delivery Pressure - Data Valid But Below Normal Operating Range - Least Severe Level
**Код 2262 — давление подачи топливного насоса ниже нормы — низший уровень**

> [!abstract] Процедура · `122-t05-2262`
> **Двигатели:** [[33239746 — QSK60 CM2150 MCRS CPL 3451|33239746]], [[33239899 — QSK50 CM2150 MCRS CPL 3379|33239899]]
> **Семейство:** K38/K50 · QSK38, QSK50, QSK60
> **Входит в руководства:** [[4022102 — QSK38, QSK50, and QSK60 CM2150 Electronic Control System Troubleshooting and Repair M|4022102]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2015-04-07
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/122/122-t05-2262.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/122-t05-2262.pdf)
...
|  | **ШАГ 1А.** Попытка запуска двигателя. | Двигатель запускается и продолжает работать? |
| ШАГ 2. | Проверьте сторону низкого давления топливной системы. |  |
|  | **ШАГ 2А.** Проверка внешних утечек топлива. | Топливо просачивается наружу? |
|  | **ШАГ 2В.** Проверка воздуха в топливе. | Присутствует ли воздух в потоке топлива? |
...
| Попробуйте запустить двигатель. Проверьте, не запустится ли двигатель или запустится двигатель и остановится. | Двигатель запускается и продолжает работать? *Да | 2А |
...
| Код 2262 неактивен? **NORepair:** Возврат к шагам устранения неполадок или свяжитесь с авторизованным местом ремонта Cummins®, если все шаги были завершены и проверены снова. | 1А |  |
...
> |  | **STEP 1A.** Attempt to start engine. | Engine starts and continues running? |
> | STEP 2. | Check the low-pressure side of the fuel system. |  |
> |  | **STEP 2A.** Check for external fuel leaks. | Fuel leaking externally? |
> |  | **STEP 2B.** Check for air in fuel. | Air present in fuel flow? |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Disable the fault code. Use INSITE™ electronic service tool to verify the fault code is inactive. | Fault Code 2262 inactive? **YES** | 3B |
