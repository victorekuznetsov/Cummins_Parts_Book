...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/82-fc155.pdf"
tags:
  - "документ/процедура"
  - "двигатель/NT/NTA855"
  - "группа/82"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/82/82-fc155.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/82-fc155.pdf)
...
|---|---|---|
| Код неисправности: 155 P(P): P105 SPN: 105 FMI: 0/0 лампа: Красная СТО: | Температура во впускном коллекторе 1 выше нормы — наивысший уровень. Сигнал температуры воздуха впускного коллектора указывает температуру воздуха впускного коллектора выше критического предела защиты двигателя. | Мощность двигателя снижается. |
...
Модуль управления двигателем (ECM) обеспечивает 5 вольт в цепи сигнала температуры впускного коллектора и контролирует изменение напряжения, вызванное изменениями сопротивления датчика, для определения температуры впускного коллектора. Когда воздух впуска холодный, сопротивление датчика (или термистора) высокое. Напряжение сигнала ECM **только *** тянет небольшое количество через датчик к земле. Поэтому ECM ощущает высокое напряжение сигнала или низкую температуру. Когда воздух впуска теплый, сопротивление датчика низкое. Сигнальное напряжение тянет вниз большую величину. Поэтому ECM ощущает низкое напряжение сигнала или высокую температуру.

### Расположение компонента

Датчик температуры впускного коллектора 1 расположен в роге воздухозаборника.
...
Модуль управления двигателем (ECM) обнаружил, что температура впускного коллектора была выше 105 ° C \[221 ° F \] в течение 5 секунд.

### Действия системы при активном коде неисправности

- ECM освещает красный свет STOP ENGINE сразу после запуска диагностики и выхода из строя.

- Выходной крутящий момент двигателя будет уменьшен.

- Максимальная рабочая скорость двигателя будет снижена.
