---
aliases:
  - "Цепь электромагнита форсунки цилиндра 2 — ток ниже нормы или обрыв"
type: "Процедура"
doc: "82-fc331"
title_en: "Injector Solenoid Driver Cylinder 2 Circuit - Current Below Normal, or Open Circuit"
title_ru: "Цепь электромагнита форсунки цилиндра 2 — ток ниже нормы или обрыв"
modified: "2010-09-02"
engines:
  - "41343322"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/82/82-fc331.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/82-fc331.pdf"
tags:
  - "документ/процедура"
  - "двигатель/NT/NTA855"
  - "группа/82"
...
> [!abstract] Процедура · `82-fc331`
> **Двигатели:** [[41343322 — NH NT 855 CPL 3362|41343322]]
> **Семейство:** NT/NTA855 · ISM/QSM11
> **Входит в руководства:** [[3666266 — ISM and QSM11 Electronic Control System Troubleshooting and Repair Manual|3666266]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2010-09-02
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/82/82-fc331.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/82-fc331.pdf)
...
|---|---|---|
| Код неисправности: 331 P(P): S006 SPN: 656 FMI: 5/5 лампы: Янтарная СРТ: | Цепь электромагнита форсунки цилиндра 2 — ток ниже нормы или обрыв. Ток, обнаруживаемый на топливной форсунке № 2 при выключенном напряжении. | Ток к топливному форсунке отключается. Двигатель может неправильно работать или работать грубо. |

![[19200156.png]]

форсунка Solenoid Driver Cylinder 2 Circuit
...
Устранение неполадок код t05-331
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 331 PID(P): S006 SPN: 656 FMI: 5/5 Lamp: Amber SRT: | Injector Solenoid Driver Cylinder 2 Circuit - Current Below Normal, or Open Circuit. Current detected at injector number 2 when voltage is turned off. | The current to the injector is shut off. The engine can possibly misfire or run rough. |
>
