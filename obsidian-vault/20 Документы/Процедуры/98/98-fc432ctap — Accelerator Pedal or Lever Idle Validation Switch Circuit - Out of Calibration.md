...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/98/98-fc432ctap.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/98-fc432ctap.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K19"
  - "группа/98"
...
> [!abstract] Процедура · `98-fc432ctap`
> **Двигатели:** [[37269910 — K19 CPL 1253|37269910]], [[37280605 — K19 CPL 447|37280605]]
> **Семейство:** K19
> **Входит в руководства:** [[3666070 — CENTRY™ Electronic Control System Troubleshooting and Repair Manual|3666070]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2021-09-15
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/98/98-fc432ctap.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/98-fc432ctap.pdf)
...
|---|---|---|
| Код неисправности: 432-ктап PID(P): P91 SPN: ФМИ: 13 ламп: Флешинг SRT: 00-622 | Напряжение, обнаруживаемое одновременно как на холостых валидационных, так и на выключателях валидации. | Возможно снижение производительности двигателя. |

![[19802316.png]]

Датчик положения ускорителя (CELECTTM Type Accelerator Pedal)
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 432-ctap PID(P): P91 SPN: FMI: 13 Lamp: Flashing SRT: 00-622 | Voltage detected simultaneously on both idle validation and off-idle validation switches. | Possible reduced engine performance. |
>
> Accelerator Position Sensor - (CELECT™ Type Accelerator Pedal)
>
> ### Circuit Description
>
