...
|---|---|---|
| Код неисправности: 131-nctap PID(P): P91 SPN: ФМИ: 3 лампы: Флешинг SRT: 00-622 | Высокое напряжение, обнаруженное в цепи сигнала положения дроссельной заслонки. | Возможно снижение производительности двигателя. |
