...
### Вспомогательная схема датчика температуры - напряжение ниже нормального или короткое до низкого источника
...
|---|---|---|
| Код неисправности: 522 PID(P): P177 SPN: ФМИ: 4 лампы: На SRT: 00-646 | Низкое напряжение сигнала, обнаруженное на схеме вспомогательного датчика температуры. | Ни одного на выступление. |
...
Модуль управления двигателем (ECM) обнаружил, что напряжение сигнала вспомогательного датчика температуры было за пределами диапазона.
...
См. Код устранения неполадок t05-522
