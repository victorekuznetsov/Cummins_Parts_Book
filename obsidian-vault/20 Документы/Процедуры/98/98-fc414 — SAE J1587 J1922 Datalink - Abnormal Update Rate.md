...
### SAE J1587/J1922 CAN Data Bus - Обновление данных по аномальным явлениям
...
|---|---|---|
| Код неисправности: 414 PID(P): S250 SPN: ФМИ: 9 лампы: На SRT: 00-632 | На шине данных J1587/1922 CAN была обнаружена ненормальная скорость обновления. | Нет |
...
Модуль управления двигателем (ECM) обнаружил, что шина передачи данных J1587/1992 CAN передает ненормально.
...
Устранение неполадок код t05-414
