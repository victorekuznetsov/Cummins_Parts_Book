...
### Схема датчика давления на железной дороге - напряжение выше нормального или короткое до высокого источника
...
|---|---|---|
| Код неисправности: 514 PID(P): S18 SPN: ФМИ: 7 ламп: Флешинг SRT: 00-644 | Выявлено высокое давление на рельсах. | Двигатель может работать только на высоком холостом ходу|
...
Модуль управления двигателем (ECM) обнаружил высокое давление на рельсах.
...
- Неисправность или повреждение электронного клапана управления топливом.
