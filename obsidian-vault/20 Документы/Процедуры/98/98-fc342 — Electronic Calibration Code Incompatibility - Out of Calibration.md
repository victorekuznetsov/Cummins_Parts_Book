...
|---|---|---|
| Код неисправности: 342 P(P): S253 SPN: ФМИ: 12 ламп: На SRT: 00-631 | Стираемая программируемая ошибка контрольной суммы памяти только для показаний. | Двигатель может **не** завестись. Двигатель может отключиться. Возможно снижение производительности двигателя. |
