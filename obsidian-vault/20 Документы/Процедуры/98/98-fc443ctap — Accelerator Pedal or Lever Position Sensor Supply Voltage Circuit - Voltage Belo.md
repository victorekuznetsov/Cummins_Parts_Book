...
|---|---|---|
| Код неисправности: 443-ктап PID(P): S254 SPN: ФМИ: 4 лампы: Флешинг SRT: 00-637 | Низкое напряжение, обнаруженное на подаче датчика для схемы датчика положения дроссельной заслонки. | Возможно снижение производительности двигателя. |
