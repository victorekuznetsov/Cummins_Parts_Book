...
type: "Процедура"
doc: "98-fc451"
title_en: "Injector Metering Rail 1 Pressure Sensor Circuit - Voltage Above Normal or Shorted to High Source"
modified: "2021-09-15"
engines:
  - "37269910"
  - "37280605"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/98/98-fc451.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/98-fc451.pdf"
tags:
  - "документ/процедура"
  - "двигатель/K19"
  - "группа/98"
...
> [!abstract] Процедура · `98-fc451`
> **Двигатели:** [[37269910 — K19 CPL 1253|37269910]], [[37280605 — K19 CPL 447|37280605]]
> **Семейство:** K19
> **Входит в руководства:** [[3666070 — CENTRY™ Electronic Control System Troubleshooting and Repair Manual|3666070]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2021-09-15
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/98/98-fc451.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/98-fc451.pdf)
...
### Форсунка Metering Rail 1 Pressure Sensor Circuit - напряжение выше нормального или короткое до высокого источника
...
|---|---|---|
| Код неисправности: 451 PID (P): P94 SPN: ФМИ: 3 лампы: На SRT: 00-640 | Высокое напряжение сигнала, обнаруженное на цепи датчика давления рельса. | Мощность и скорость двигателя снижаются. |
...
Датчик давления в рельсах представляет собой датчик переменного сопротивления, используемый ECM для мониторинга давления в рельсах топлива. Этот датчик имеет три схемы: 5-вольтовые цепи подачи, возврата и сигнала. Этот датчик давления рельса сигнализирует о изменении напряжения на основе давления в топливной рельсе.
...
Модуль управления двигателем (ECM) обнаружил, что напряжение сигнала давления в рельсах было вне диапазона.
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 451 PID(P): P94 SPN: FMI: 3 Lamp: On SRT: 00-640 | High signal voltage detected at the rail pressure sensor circuit. | Power and engine speed derate. |
>
...
>
> The Engine Control Module (ECM) detected the rail pressure signal voltage was out of range high.
>
