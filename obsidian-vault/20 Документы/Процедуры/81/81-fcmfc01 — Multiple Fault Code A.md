...
|---|---|---|
| Код неисправности: Многократный PID(P): СПН: ФМИ: Лампа: СТО: 00-517 | Датчик питания А01 сокращен до +24 VDC. | Одновременно возникают несколько кодов 156, 212 и 694 датчиков. |
