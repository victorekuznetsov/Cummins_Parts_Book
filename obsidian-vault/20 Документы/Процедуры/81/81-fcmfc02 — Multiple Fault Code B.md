...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/81/81-fcmfc02.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/81-fcmfc02.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK60"
  - "группа/81"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/81/81-fcmfc02.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/81-fcmfc02.pdf)
...
|---|---|---|
| Код неисправности: Многократный PID(P): СПН: ФМИ: Лампа: СТО: 00-517 | Один из двух проводов подачи питания или возврата датчика закорочен на землю или имеет открытую цепь. | Одновременно возникают несколько кодов 157, 213 и 695 датчиков. |
...
Электронный модуль управления (ECM) поставляет датчики на проводной ремне CENSETM с +5 VDC либо от контакта 01, либо от контакта 02 на разъеме ECM A. Неисправность в этой схеме вызовет несколько кодов неисправностей.
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: Multiple PID(P): SPN: FMI: Lamp: SRT: 00-517 | One of the two sensor power supply or sensor return wires is shorted to ground, or has an open circuit. | Multiple sensor Fault Codes 157, 213, and 695 simultaneously occur. |
>
> Multiple Fault Code B
>
> ### Circuit Description
