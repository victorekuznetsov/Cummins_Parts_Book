...
|---|---|---|
| Код неисправности: 212 P(P): 175 SPN: 175 ФМИ: 3 лампы: Желтая СТО: 00-501 | Цепь датчика температуры масла 1 — напряжение выше нормы. Высокое напряжение, обнаруженное на контакте SIGNAL 35 основной проводов ремня разъема A ECM. | Код 214 неисправности отключен. |
