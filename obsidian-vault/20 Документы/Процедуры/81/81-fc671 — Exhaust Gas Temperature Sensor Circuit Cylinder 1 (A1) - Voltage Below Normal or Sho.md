...
type: "Процедура"
doc: "81-fc671"
title_en: "Exhaust Gas Temperature Sensor Circuit Cylinder 1 (A1) - Voltage Below Normal or Shorted to Low Source"
modified: "2015-07-10"
engines:
  - "33210083"
  - "33219033"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/81/81-fc671.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/81-fc671.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK60"
  - "группа/81"
...
# Exhaust Gas Temperature Sensor Circuit Cylinder 1 (A1) - Voltage Below Normal or Shorted to Low Source

> [!abstract] Процедура · `81-fc671`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/81/81-fc671.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/81-fc671.pdf)
...
### Код неисправности: 671

### Цилиндр 1 (A1) - напряжение ниже нормального или короткого до низкого источника
...
|---|---|---|
| Код неисправности: 671 PID(P): СПН: 1137 FMI: 4/4 лампы: Обслуживание SRT: 00-391 | Цилиндр 1 (A1) - напряжение ниже нормального или от короткого до низкого источника. Низкое напряжение, обнаруженное на цилиндре 1 датчиком температуры выхлопа SIGNAL, контактирует 29 с основным проводным ремнем разъема B ECM. | Коды 621, 641 и 661 неисправности отключены. |
...
Схема датчика температуры выхлопных газов контролирует температуру выхлопных газов для цилиндра 1 и передает информацию в модуль управления двигателем CENSETM (ECM) через электропроводку двигателя. ECM контролирует температуру и сравнивает ее с температурой выхлопных газов других цилиндров.
...
См. Код устранения неполадок t05-671
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 671 PID(P): SPN: 1137 FMI: 4/4 Lamp: Maintenance SRT: 00-391 | Exhaust Gas Temperature Sensor Circuit Cylinder 1 (A1) - Voltage Below Normal or Shorted to Low Source. Low voltage detected on cylinder 1 exhaust temperature sensor SIGNAL pin 29 of the main harness B ECM connector. | Fault Codes 621, 641, and 661 are disabled. |
>
> Exhaust Gas Temperature Sensor Circuit Cylinder 1
>
> ### Circuit Description
>
> The exhaust gas temperature sensor circuit monitors exhaust gas temperature for cylinder 1 and passes information to the CENSE™ engine control module (ECM) through the engine harness. The ECM monitors the temperature and compares it to the exhaust gas temperatures of other cylinders.
>
> ### Component Location
>
...
>
> Refer to Troubleshooting Fault Code t05-671
