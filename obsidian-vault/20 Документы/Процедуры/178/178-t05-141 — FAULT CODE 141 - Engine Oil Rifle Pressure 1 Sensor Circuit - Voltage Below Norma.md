...
type: "Процедура"
doc: "178-t05-141"
title_en: "FAULT CODE 141 - Engine Oil Rifle Pressure 1 Sensor Circuit - Voltage Below Normal or Shorted to Low Source"
modified: "2019-08-22"
engines:
  - "82099327"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/178/178-t05-141.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/178-t05-141.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSB6.7"
  - "группа/178"
...
# FAULT CODE 141 - Engine Oil Rifle Pressure 1 Sensor Circuit - Voltage Below Normal or Shorted to Low Source

> [!abstract] Процедура · `178-t05-141`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/178/178-t05-141.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/178-t05-141.pdf)
...
> [!warning] ОСТОРОЖНО
> Чтобы не повредить контакты и жгут, при измерениях пользуйтесь следующими измерительными проводами: Номер детали 3164596 — штыревой пробный щуп FramatomeTM, номер детали 3822917 — пробный щуп типа сокет DeutschTM/AMPTM/Metri-PackTM.
...
|  | **STEP 1B.** Проверить неактивный код ошибки. | Код 141 неактивен? |
...
|  | **STEP 2C.** Проверьте реакцию цепи. | Код 135 неисправности активен, а Код 141 неактивен? |
|  | **STEP 2D.** Проверьте коды неисправностей и состояние датчика. | Код 141 активен? |
...
|  | **STEP 3A-1.** Проверьте напряжение питания датчика и схему возврата. | 4,75 VDC до 5,25 VDC? |
|  | **STEP 3A-2.** Проверьте наличие активного кода неисправности. | Код 141 неактивен? |
|  | **STEP 3B** Проверить контакты разъема электропроводки и электропроводки двигателя. | Грязные или поврежденные контакты? |
|  | **STEP 3B-1.** Проверьте реакцию ECM. | Код 135 неисправности активен, а Код 141 неактивен? |
|  | **STEP 3B-2.** Проверьте наличие активного кода неисправности. | Код 141 неактивен? |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте неактивный код ошибки. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 141 неактивен? *Да | Используйте следующую процедуру для неактивного или прерывистого кода неисправности.[[99-019-362 — Inactive or Intermittent Fault Code\|См. процедуру 019-362 в разделе 19.]] |
| Код 141 неактивен? **НЕТ** | 2А |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Осмотрите контактные линзы разъёма электропроводки двигателя и датчика давления масла на предмет: Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема Разъем разъема разъема или разбитые штифты Разъем разъема разъема или разъема или разъема разъема разъема оболочки разбитого изоляционного повреждения Проволоки Поврежденный разъем блокировки вкладки. Используйте следующую процедуру для общих методов проверки.[[99-019-361 — Component Connector and Pin Inspection\|См. процедуру 019-361 в разделе 19.]] | Грязные или поврежденные контакты? **Ремонт: **В датчике или разъёме жгута проводов обнаружено поврежденное соединение. Очистите разъем и булавки. По возможности отремонтируйте поврежденную проводку, разъем или штифты. См. процедуру 019-043 в Таблице ассоциированных процедур. | 4А |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте напряжение питания и обратную цепь. Измерьте напряжение от контакта подачи масла +5 VOLT до обратного контакта давления масла на разъеме датчика проводов двигателя. См. схему или схему проводов для идентификации контакта с разъемом. Используйте следующую процедуру для общих методов использования мультиметра.[[99-019-359 — Multimeter Usage\|См. процедуру 019-359 в разделе 19.]] | 4,75 VDC до 5,25 VDC? *Да | 2C |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте отклик цепи. Поместите провод перемычки между контактом подачи масла +5 VOLT и контактом сигнала давления масла на разъем датчика давления масла проводов двигателя. Включите зажигание. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. См. схему или схему проводов для идентификации контакта с разъемом. | Код 135 неисправности активен, а Код 141 неактивен? *Да | 2D |
| Код 135 неисправности активен, а Код 141 неактивен? **НЕТ** | 3B |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте соответствующую реакцию цепи через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 141 активен? Поврежденный датчик был обнаружен. Замените датчик давления масла. См. процедуру 019-066 в Таблице ассоциированных процедур. | 4А |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте напряжение питания и обратную цепь. Измерьте напряжение от контакта подачи масла +5 VOLT до обратного контакта давления масла на разъеме двигателя ECM. См. схему или схему проводов для идентификации контакта с разъемом. Используйте следующую процедуру для общих методов использования мультиметра.[[99-019-359 — Multimeter Usage\|См. процедуру 019-359 в разделе 19.]] | 4,75 VDC до 5,25 VDC? *Да | 3А-2 |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте соответствующую реакцию цепи через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 141 неактивен? **Ремонт: **Нет. Удаление и установка разъема исправили неисправность. | 4А |
| Код 141 неактивен? **NORepair: **В ремне электропроводки двигателя обнаружена открытая или короткосхемная цепь подачи. Ремонт или замена ремня электропроводки двигателя. См. процедуру 019-043 в Таблице ассоциированных процедур. | 4А |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте реакцию ECM. Поместите провод перемычки между контактом подачи масла +5 VOLT и контактом сигнала давления масла на разъеме двигателя ECM. Включите зажигание. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. См. схему или схему проводов для идентификации контакта с разъемом. | Код 135 неисправности активен, а Код 141 неактивен? *Да | 3В-2-2 |
| Код 135 неисправности активен, а Код 141 неактивен? Заменить ЭКМ. См. процедуру 019-031 в Таблице ассоциированных процедур. | 4А |  |
...
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте соответствующую реакцию цепи через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 141 неактивен? **Ремонт: **Нет. Удаление и установка разъема исправили неисправность. | 4А |
| Код 141 неактивен? **NORepair: **На проводе SIGNAL ремня электропроводки двигателя обнаружено открытое замыкание или короткое замыкание от контакта к контакту. Ремонт или замена ремня электропроводки двигателя. См. процедуру 019-043 в Таблице ассоциированных процедур. | 4А |  |
...
| Датчик давления моторного масла / коммутатор | См. процедуру 019-066 | ISB5.9 CM2880 B127 | 4383645 |
...
>
> **CAUTION · Осторожно**
> To reduce the possibility of pin and harness damage, use the following test leads when taking a measurement: Part Number 3164596 - male Framatome™ test lead, Part Number 3822917 - female Deutsch™/AMP™/Metri-Pack™ test lead.
>
...
> |  | **STEP 1B.** Check for an inactive fault code. | Fault Code 141 inactive? |
...
> |  | **STEP 2C.** Check the circuit response. | Fault Code 135 active and Fault Code 141 inactive? |
> |  | **STEP 2D.** Check the fault codes and verify sensor condition. | Fault Code 141 active? |
> | STEP 3. | Check the ECM and engine harness. |  |
> |  | **STEP 3A.** Inspect the ECM and engine harness connector pins. | Dirty or damaged pins? |
> |  | **STEP 3A-1.** Check the sensor supply voltage and return circuit. | 4.75 VDC to 5.25 VDC? |
> |  | **STEP 3A-2.** Check for an active fault code. | Fault Code 141 inactive? |
> |  | **STEP 3B.** Inspect the ECM and engine harness connector pins. | Dirty or damaged pins? |
> |  | **STEP 3B-1.** Check the ECM response. | Fault Code 135 active and Fault Code 141 inactive? |
> |  | **STEP 3B-2.** Check for an active fault code. | Fault Code 141 inactive? |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for an inactive fault code. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 141 inactive? **YES** | Use the following procedure for an inactive or intermittent fault code. [[99-019-362 — Inactive or Intermittent Fault Code\|Refer to Procedure 019-362 in Section 19.]] |
> | Fault Code 141 inactive? **NO** | 2A |  |
>
> ### STEP 2. Check the oil pressure sensor and circuit.
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the circuit response. Place a jumper wire between the oil pressure +5 VOLT SUPPLY pin and the oil pressure SIGNAL pin at the oil pressure sensor connector of the engine harness. Turn keyswitch ON. Use INSITE™ electronic service tool to read the fault codes. Refer to the circuit diagram or the wiring diagram for connector pin identification. | Fault Code 135 active and Fault Code 141 inactive? **YES** | 2D |
> | Fault Code 135 active and Fault Code 141 inactive? **NO** | 3B |  |
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the appropriate circuit response after 30 seconds. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 141 active? **YESRepair:** A damaged sensor has been detected. Replace the oil pressure sensor. Refer to Procedure 019-066 in the Associated Procedures Table. | 4A |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the supply voltage and return circuit. Measure the voltage from the oil pressure +5 VOLT SUPPLY pin to the oil pressure RETURN pin at the ECM engine connector. Refer to the circuit diagram or the wiring diagram for connector pin identification. Use the following procedure for general multimeter usage techniques. [[99-019-359 — Multimeter Usage\|Refer to Procedure 019-359 in Section 19.]] | 4.75 VDC to 5.25 VDC? **YES** | 3A-2 |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for the appropriate circuit response after 30 seconds. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 141 inactive? **YESRepair:** None. The removal and installation of the connector corrected the fault. | 4A |
> | Fault Code 141 inactive? **NORepair:** An open or shorted supply circuit has been detected in the engine harness. Repair or replace the engine harness. Refer to Procedure 019-043 in the Associated Procedures Table. | 4A |  |
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the ECM response. Place a jumper wire between the oil pressure +5 VOLT SUPPLY pin and the oil pressure SIGNAL pin at the ECM engine connector. Turn keyswitch ON. Use INSITE™ electronic service tool to read the fault codes. Refer to the circuit diagram or the wiring diagram for connector pin identification. | Fault Code 135 active and Fault Code 141 inactive? **YES** | 3B-2 |
> | Fault Code 135 active and Fault Code 141 inactive? **NORepair:** Replace the ECM. Refer to Procedure 019-031 in the Associated Procedures Table. | 4A |  |
>
...
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for the appropriate circuit response after 30 seconds. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 141 inactive? **YESRepair:** None. The removal and installation of the connector corrected the fault. | 4A |
> | Fault Code 141 inactive? **NORepair:** An open return or a pin-to-pin short circuit has been detected on the SIGNAL wire of the engine harness. Repair or replace the engine harness. Refer to Procedure 019-043 in the Associated Procedures Table. | 4A |  |
>
> ### STEP 4. Check ECM calibration and clear fault codes.
>
...
> | Engine Oil Pressure Sensor/Switch | Refer to Procedure 019-066 | ISB5.9 CM2880 B127 | 4383645 |
