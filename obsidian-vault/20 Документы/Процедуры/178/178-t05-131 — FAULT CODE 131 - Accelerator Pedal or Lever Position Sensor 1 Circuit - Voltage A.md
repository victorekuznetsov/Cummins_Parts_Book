...
type: "Процедура"
doc: "178-t05-131"
title_en: "FAULT CODE 131 - Accelerator Pedal or Lever Position Sensor 1 Circuit - Voltage Above Normal or Shorted to High Source"
modified: "2019-08-22"
engines:
  - "82099327"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/178/178-t05-131.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/178-t05-131.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSB6.7"
  - "группа/178"
...
> [!abstract] Процедура · `178-t05-131`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/178/178-t05-131.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/178-t05-131.pdf)
...
|  | **STEP 1B.** Проверить наличие кода сбоя. | Код 131 активен? |
| ШАГ 2. | Проверьте педаль акселератора или цепь датчика положения рычага. |  |
|  | **STEP 2A.** Проверить датчик положения педали акселератора и контакты разъема. | Грязные или поврежденные контакты? |
|  | **STEP 2B.** Проверьте напряжение питания и обратную цепь датчика положения педали акселератора. | Между 4,75-VDC и 5,25-VDC? |
|  | **STEP 2C.** Проверьте реакцию цепи. | Код 132 активен, а Код 131 неактивен? |
|  | **STEP 2D.** Проверьте коды неисправностей и проверьте состояние педали акселератора или рычага. | Код 132 ошибки активен? |
| ШАГ 3. | Проверьте электропроводку ECM и оригинальную электропроводку оборудования (OEM). |  |
...
|  | **STEP 3D.** Проверить неактивный код ошибки. | Код 131 неактивен? |
...
| Проверьте коды неисправностей датчика. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код ошибки 2185 активен? *Да | Устранение неисправностей 2185 |
| Код ошибки 2185 активен? **НЕТ** | 1В |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте активный код ошибки. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 131 активен? *Да | 2А |
| Код 131 активен? **НЕТ** | Используйте следующую процедуру для неактивного или прерывистого кода неисправности.[[99-019-362 — Inactive or Intermittent Fault Code\|См. процедуру 019-362 в разделе 19.]] |  |

### ШАГ 2. Проверьте педаль акселератора или датчик положения рычага и схему.

#### ШАГ 2A. Осмотрите педаль акселератора или датчик положения рычага и контакты разъема.

| **Условия:** Выключите замок зажигания. Отсоедините педаль акселератора или датчик положения рычага от электропроводки OEM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
...
#### ШАГ 2B. Проверьте педаль акселератора, датчик положения подачи напряжения и обратный контур.

| **Условия:** Выключите замок зажигания. Отсоедините датчик положения педали акселератора от электропроводки OEM. Включите зажигание. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте напряжение питания и обратную цепь. Измерить напряжение от датчика положения педали акселератора +5 VOLT подачи контакта к датчику положения педали акселератора обратного контакта на разъеме датчика проводов OEM. Используйте схему проводов для идентификации штифта и следующую процедуру для общего многометрового использования.[[99-019-359 — Multimeter Usage\|См. процедуру 019-359 в разделе 19.]] | Между 4,75-VDC и 5,25-VDC? *Да | 2C |
| Между 4,75-VDC и 5,25-VDC? **НЕТ** | 3А |  |

#### ШАГ 2C. Проверьте отклик цепи.

| **Условия:** Выключите замок зажигания. Отсоедините датчик положения педали акселератора от электропроводки OEM. Включите зажигание. Подключите инструмент электронного сервиса INSITETM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте соответствующий ответ на ECM через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 132 активен, а Код 131 неактивен? *Да | 2D |
| Код 132 активен, а Код 131 неактивен? **НЕТ** | 3А |  |

#### ШАГ 2D. Проверьте коды неисправностей и состояние педали акселератора.

| **Условия:** Выключите замок зажигания. Подключите педаль акселератора или рычаг к электропроводке OEM. Включите зажигание. Подключите инструмент электронного сервиса INSITETM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте соответствующую реакцию цепи через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 131 активен? **Ремонт: **Выявлена поврежденная педаль акселератора или рычаг. Свяжитесь с авторизованным местом ремонта Cummins® для получения инструкций по ремонту. Замените педаль акселератора или рычаг. См. сервисную документацию изготовителя оборудования. | 4А |
| Код 131 активен? **Норвегия: **Нет. Удаление и установка разъема исправили неисправность. | 4А |  |
...
| **Условия:** Выключите замок зажигания. Отсоедините проводку OEM от разъема ECM. Отсоедините датчик положения педали акселератора от электропроводки OEM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте цепь на обрыв. Измерить сопротивление между OEM проводкой жгута разъема ECM коннектора педали обратного контакта и OEM проводов жгута педали обратного контакта. Используйте схему проводов для идентификации штифта и следующую процедуру для общих методов измерения сопротивления.[[99-019-360 — Resistance Measurement Using a Multimeter\|См. процедуру 019-360 в разделе 19.]] | Менее 10 Ом? *Да | 3C |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте короткое контактное соединение. Измерьте сопротивление между контактом педали акселератора в разъёме ECM проводов OEM и всеми другими штифтами в разъеме OEM. См. схему или схему проводов для идентификации контакта с разъемом. Используйте следующую процедуру для общих методов измерения сопротивления.[[99-019-360 — Resistance Measurement Using a Multimeter\|См. процедуру 019-360 в разделе 19.]] | Больше 100 тысяч ом? *Да | 3D |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте соответствующую реакцию цепи через 30 секунд. Используйте инструмент электронного сервиса INSITETM для считывания кодов неисправностей. | Код 131 неактивен? **Ремонт: **Нет. Удаление и установка разъема исправили неисправность. | 4А |
| Код 131 неактивен? Заменить ЭКМ. См. процедуру 019-031 в Таблице ассоциированных процедур. | 4А |  |
...
> |  | **STEP 1B.** Check for an active fault code. | Fault Code 131 active? |
> | STEP 2. | Check the accelerator pedal or lever position sensor circuit. |  |
...
> |  | **STEP 2C.** Check the circuit response. | Fault Code 132 active and Fault Code 131 inactive? |
> |  | **STEP 2D.** Check the fault codes and verify accelerator pedal or lever condition. | Fault Code 132 active? |
> | STEP 3. | Check the ECM and original equipment harness (OEM) harness. |  |
...
> |  | **STEP 3D.** Check for an inactive fault code. | Fault Code 131 inactive? |
...
> | Check for sensor supply fault codes. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 2185 active? **YES** | Troubleshoot Fault Code 2185 |
> | Fault Code 2185 active? **NO** | 1B |  |
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for an active fault code. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 131 active? **YES** | 2A |
> | Fault Code 131 active? **NO** | Use the following procedure for inactive or intermittent fault code. [[99-019-362 — Inactive or Intermittent Fault Code\|Refer to Procedure 019-362 in Section 19.]] |  |
>
> ### STEP 2. Check the accelerator pedal or lever position sensor and circuit.
>
> #### STEP 2A. Inspect the accelerator pedal or lever position sensor and connector pins.
>
> | **Conditions:** Turn keyswitch OFF. Disconnect the accelerator pedal or lever position sensor from the OEM harness. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for the appropriate ECM response after 30 seconds. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 132 active and Fault Code 131 inactive? **YES** | 2D |
> | Fault Code 132 active and Fault Code 131 inactive? **NO** | 3A |  |
>
> #### STEP 2D. Check the fault codes and verify accelerator pedal condition.
>
> | **Conditions:** Turn keyswitch OFF. Connect the accelerator pedal or lever to the OEM harness. Turn keyswitch ON. Connect INSITE™ electronic service tool. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for the appropriate circuit response after 30 seconds. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 131 active? **YESRepair:** A damaged accelerator pedal or lever has been detected. Contact a Cummins® Authorized Repair Location for repair instructions. Replace the accelerator pedal or lever. See equipment manufacturer service information. | 4A |
> | Fault Code 131 active? **NORepair:** None. The removal and installation of the connector corrected the fault. | 4A |  |
>
> ### STEP 3. Check the ECM and original equipment harness (OEM) harness.
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check for the appropriate circuit response after 30 seconds. Use INSITE™ electronic service tool to read the fault codes. | Fault Code 131 inactive? **YESRepair:** None. The removal and installation of the connector corrected the fault. | 4A |
> | Fault Code 131 inactive? **NORepair:** Replace the ECM. Refer to Procedure 019-031 in the Associated Procedures Table. | 4A |  |
>
> ### STEP 4. Check ECM calibration and clear fault codes.
>
