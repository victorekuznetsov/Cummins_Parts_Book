...
> [!abstract] Процедура · `102-010-033-om`
...
Свяжитесь с авторизованным местом ремонта Cummins®, если обнаружен ущерб. См. номер модели на табличке с данными турбокомпрессора.

![[10400022.png]]

### Измерение

Измерьте зазор конца турбокомпрессора с помощью измерителя глубины, номера детали ST-537 или индикатора циферблата.

| Турбокомпрессор Shaft End Clearance |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| HX60 Турбокомпрессор | 0.051 | Мин | 0.002 |
|  | 0.152 | Макс | 0.006 |
...
| HX60 и HX82 Turbocharger Radial Bearing Clearance |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| Император компрессора | 0.15 | Мин | 0.006 |
|  | 0.45 | Макс | 0.018 |
| Турбинное колесо | 0.20 | Мин | 0.008 |
|  | 0.55 | Макс | 0.022 |

| HX83 Turbocharger Radial Bearing Clearance (Радиальный зазор) |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| Император компрессора | 0.15 | Мин | 0.006 |
|  | 0.70 | Макс | 0.028 |
...
Технические характеристики для проверки радиального и осевого зазора отсутствуют.

Осмотрите признаки контакта между фургонами турбокомпрессора и корпусом.

Проверьте систему подшипников для износа:

- Удерживайте оба конца вала турбокомпрессора и вращайте вал, прикладывая давление вниз на сторону компрессора и вверх на сторону турбины. Он должен вращаться свободно и не должно быть контакта между колесом компрессора и корпусом компрессора или колесом турбины и корпусом турбины.
...
>
> Contact a Cummins® Authorized Repair Location if damage is found. Refer to the model number on the turbocharger dataplate.
>
> ### Measure
>
> Measure the turbocharger shaft end clearance with depth gauge, Part Number ST-537, or a dial indicator.
>
...
> |  | 0.125 | MAX | 0.005 |
>
> If the turbocharger is **not** within specifications, contact a Cummins® Authorized Repair Location. Refer to the model number on the turbocharger dataplate.
>
> Push the compressor impeller end of the shaft toward the housing.
>
> Using a feeler gauge that is **not** more than 13 mm \[0.5 in\] wide, measure the clearance between the impeller and the housing at the minimum clearance point.
>
> Perform the same measurement for the turbine wheel.
>
> | HX60 and HX82 Turbocharger Radial Bearing Clearance |  |  |  |
> |---|---|---|---|
> |  | mm |  | in |
...
> |  | 0.77 | MAX | 0.031 |
>
> If the turbocharger is **not** within specifications, contact a Cummins® Authorized Repair Facility. Refer to the model number on the turbocharger dataplate.
>
> **Note · Примечание**
...
>
> - Hold both ends of the turbocharger shaft and rotate the shaft while applying pressure down on the compressor side and up on the turbine side. It should rotate freely and there should be no contact between the compressor wheel and the compressor housing, or the turbine wheel and turbine housing.
>
> Replace the turbocharger if any malfunctions are identified.
>
> ### Replace
>
> Contact a Cummins® Authorized Repair Location to schedule this maintanance.
