...
> [!danger] ОПАСНО
> Корпус разгрузочного клапана установлен с пружинным натяжением. Чтобы уменьшить вероятность получения травмы, удерживайте тело разгрузчика вниз при удалении болтов.
