...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/96-fc219.pdf"
tags:
  - "документ/процедура"
  - "двигатель/NT/NTA855"
  - "двигатель/QST30"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/96/96-fc219.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/96-fc219.pdf)
...
|---|---|---|
| Код неисправности: 219 P(P): СПН: ФМИ: Лампа: Красная СТО: | Низкий уровень масла в баке подпитки. Этот код неисправности отображается, чтобы указать, что масляный масляный бак масла ниже заданных уровней. | Система CentinelTM будет работать **не**. |

![[05800061.png]]

### Описание цепи

Низкий датчик уровня масла в масляном баке контролирует уровень масла в масляном баке и сообщает модулю управления CentinelTM, когда масло опускается ниже указанного уровня.

### Расположение компонента

Низкий датчик уровня масла в масляном масле расположен на нижней части передней части масляного резервуара системы CentinelTM.
...
**Компонент может быть поврежден внутри, если его уронить.**

## Сводка по поиску неисправности

| Степс | Спецификации |  |
|---|---|---|
| ШАГ 1. | Проверьте низкий уровень масла в масле. |  |
|  | **STEP 1A.** Осмотрите датчик низкого уровня масла в масляном масле и разъёмы проводной ремни CentinelTM. | Никаких поврежденных контактов |
|  | **STEP 1B.** Проверьте на наличие открытого датчика уровня масла в масле. | менее 100 Ом |
...
|  | **STEP 2C.** Проверьте короткое замыкание от пин-кодов до пин-кодов. | Более 1к Ом |
| ШАГ 3. | Сбросьте коды неисправностей. |  |
|  | **STEP 3A.** Отключить код ошибки. | Код ошибки 219 неактивен |

### ШАГ 1. Проверьте низкий уровень масла в масле.

#### ШАГ 1A. Проверьте низкий датчик уровня масла в масле макияжа и разъём проводов CentinelTM.

| **Условия:** Заполните масляный бак. Выключите замок зажигания. Отсоедините проводную упряжку CentinelTM от датчика низкого уровня масла в масляном масле. |  |  |
|---|---|---|
...
| **Починить поврежденные контакты** Починить или заменить проводную упряжку CentinelTM или датчик низкого уровня масла в масле, в зависимости от того, какие контакты повреждены. Ремонт проводной упряжки CentinelTM. См. процедуру 019-202. Замените проводную упряжку CentinelTM. См. процедуру 019-131. Замените масляный датчик низкого уровня масла. См. процедуру 019-056. Установите соответствующий уплотнитель разъема, если он поврежден или отсутствует. | 3А |  |

#### ШАГ 1B. Проверьте низкий уровень масла в масле для открытого.

| **Условия:** Заполните масляный бак. Выключите замок зажигания. Отсоедините датчик низкого уровня масла в масляном масле от проводной упряжки CentinelTM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Измерьте сопротивление от контакта А до контакта В разъема низкого уровня масла в масляном масле, в то время как датчик покрыт маслом. См. схему проводов для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | менее 100 Ом | 2А |
| **Заменить масляный датчик уровня масла в масле** См. процедуру[[96-019-056-tr — Lubricating Oil Level Sensor\|019-056]]. | 3А |  |
...
| **Условия:** Выключите замок зажигания. Отсоедините датчик низкого уровня масла в масляном масле от проводной упряжки CentinelTM. Отсоедините проводную упряжку CentinelTM от модуля управления CentinelTM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Тяжелая работа: Измерьте сопротивление от контакта 7 разъёма проводов CentinelTM для контакта A с датчиком низкого уровня масла в масле макияжа, проводкой с жгута проводов. Тяжелая работа: Измерьте сопротивление от контакта 3 разъёма проводов CentinelTM к контакту B с датчиком низкого уровня масла в масле макияжа, проводкой с жгута проводов. Высокая мощность: Измерьте сопротивление от контакта 13 разъёма проводов CentinelTM с контактом A с датчиком низкого уровня масла в масле макияжа, проводкой с жгута проводов. Высокая мощность: Измерьте сопротивление от контакта 26 разъёма проводов CentinelTM с контактом B низкоуровневого датчика уровня масла макияжа, стороны проводов жгута проводов. См. схему проводов для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Менее 10 Ом | 2C |
...
| **Условия:** Выключите замок зажигания. Отсоедините проводную упряжку CentinelTM от датчика низкого уровня масла в масляном масле. Отсоедините проводную упряжку CentinelTM от модуля управления CentinelTM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Тяжелая работа: Измерьте сопротивление контактов 3 и 1 разъёма проводов CentinelTM со всеми смежными штифтами в разъеме. Высокая мощность: Измерьте сопротивление контактов 13 и 22 разъёма проводов CentinelTM со всеми смежными штифтами в разъеме. См. схему проводов для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Более 1к Ом | 3А |
| **Заменить проводную упряжку CentinelTM**См. процедуру[[96-019-131-tr — Centinel™ Wiring Harness\|019-131]]. | 3А |  |

### ШАГ 3. Сбросьте коды неисправностей.

#### ШАГ 3A. Отключите вину.

| **Условия:** Соедините все компоненты. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Запустите двигатель и запускайте его на холостом ходу не менее 1 минуты. Убедитесь, что код 219 неактивен. | Код ошибки 219 неактивен | Полный комплект |
