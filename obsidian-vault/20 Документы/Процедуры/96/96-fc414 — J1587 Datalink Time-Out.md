...
Шина данных J1587 CAN обеспечивает связь между электронным модулем управления двигателем (ECM) и модулем управления CentinelTM. Это позволяет системе CentinelTM отслеживать динамику двигателя. Используя эти данные, система CentinelTM способна функционировать в пределах заданных параметров.
