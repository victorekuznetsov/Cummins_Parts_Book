---
aliases:
  - "Цепь датчика давления рампы — выше диапазона"
type: "Процедура"
doc: "96-fc118"
title_en: "Fuel Rail Pressure Sensor Circuit - Out of Range High"
title_ru: "Цепь датчика давления рампы — выше диапазона"
modified: "2004-02-25"
engines:
  - "37292556"
  - "37295879"
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/96/96-fc118.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/96-fc118.pdf"
tags:
  - "документ/процедура"
  - "двигатель/NT/NTA855"
  - "двигатель/QST30"
...
# Fuel Rail Pressure Sensor Circuit - Out of Range High
**Цепь датчика давления рампы — выше диапазона**

> [!abstract] Процедура · `96-fc118`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/96/96-fc118.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/96-fc118.pdf)
...
|---|---|---|
| Код неисправности: 118 PID(P): СПН: ФМИ: Лампа: Красная СТО: | Цепь датчика давления рампы — выше диапазона. Давление на топливных рельсах высокое. | Система CentinelTM будет работать **не**. |
...
|  | **STEP 3A.** Отключить код ошибки. | Код 118 неактивен |
...
| ** Заменить проводную упряжку CentinelTM** Заменить проводную упряжку CentinelTM. См. процедуру[[96-019-131-tr — Centinel™ Wiring Harness\|019-131]]. | 3А |  |
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Убедитесь, что код 118 неактивен, проверив красный свет. | Код 118 неактивный или красный свет выключен | Полный комплект |
...
> | Codes | Reason | Effect |
> |---|---|---|
> | Fault Code: 118 PID(P): SPN: FMI: Lamp: Red SRT: | Fuel Rail Pressure Sensor Circuit - Out of Range High. The fuel rail pressure is high. | The Centinel™ system will **not** function. |
>
> ### Circuit Description
>
...
> | **Replace the Centinel™ harness** Replace the Centinel™ harness. Refer to Procedure [[96-019-131-tr — Centinel™ Wiring Harness\|019-131]]. | 3A |  |
>
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Start the engine and let it idle for 1 minute. Verify that Fault Code 118 is inactive by checking the red light. | Fault Code 118 inactive or red light off | Complete |
