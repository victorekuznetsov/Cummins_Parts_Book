...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/96-fc224.pdf"
tags:
  - "документ/процедура"
  - "двигатель/NT/NTA855"
  - "двигатель/QST30"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/96/96-fc224.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/96-fc224.pdf)
...
|---|---|---|
| Код неисправности: 224 P(P): СПН: ФМИ: Лампа: Красная СТО: | Цепь электромагнита клапана впрыска — короткое замыкание. Горящий соленоид закорочен. | Система CentinelTM будет работать **не**. |
...
|  | **STEP 3A.** Отключить код ошибки. | Код ошибки 224 неактивен |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Цикл питания. Запустите двигатель и запускайте его на холостом ходу в течение 1 минуты. Используйте плагин службы для проверки вывода. Убедитесь, что код 224 неактивен. | Код ошибки 224 неактивен | Полный комплект |
