...
Корневая проводка QST30 состоит из четырех разъемов интерфейса, которые представляют собой треугольные 3-контактные штепсельные ште Один из разъемов вставляется в левобережную проводку двигателя, а один вставляется в правобережную проводку. Два других имеют ограничение и обеспечивают соединение интерфейса инструментария (по одному на каждом банке).
...
Два 6-контактных разъема шины данных CAN на стороне двигателя не используются с помощью служебной оснастки. Они представляют собой порты шины данных J1587/1708 CAN и используются только для общего инструмента. Для двигателей QST30 требуется протокол связи J1939 с адаптером INLINE II.
...
Перережьте стяжки на магистральной проводах J1939.
