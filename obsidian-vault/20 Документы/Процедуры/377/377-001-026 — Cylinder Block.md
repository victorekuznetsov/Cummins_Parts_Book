...
figures: 65
lang: "en"
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/377/377-001-026.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/377-001-026.pdf"
tags:
  - "документ/процедура"
  - "группа/377"
---
...
> [!abstract] Процедура · `377-001-026`
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/377/377-001-026.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/377-001-026.pdf)

### Select Service Tools

#### Recommended Cummins® Service Tools

- Spacer, Part Number 3376206
- Primer, Part Number 3824715
- Thread locking compound, Part Number 3824038
...
| Assignable Cause | Cleaning Process | Note: Additional Instructions |
|---|---|---|
| Debris/shavings contamination | Cleaning tank or non-cleaning tank | Replace the lubricating oil cooler if the engine has had a debris-generating failure. |
...
- An improperly grounded voltage system.
...
Before cleaning or further disassembly of the cylinder block, perform an inspection to see if there is any damage (cracks, fretting, etc.) that would prohibit reuse. If any cracks are found other than in the counterbore ledge area, the cylinder block **must** be replaced. Pay close attention to areas of the cylinder block including:
...
Remove all pipe plugs. Refer to Procedure 017-002 in Section 17.

Remove all straight threaded plugs. Refer to Procedure 017-002 in Section 17.
...
Cracks discovered in the counterbore ledge area **must** be machined and inspected. [[377-001-058 — Cylinder Block Counterbore|Refer to Procedure 001-058 in Section 1.]]
...
Refer to Service Bulletin, Cylinder Liner Counterbore Ledge Reuse Guidelines, Bulletin [[4383753 — Cylinder Liner Counterbore Ledge Reuse Guidelines|4383753]], to inspect the counterbore ledge surface areas for signs of pitting, fretting, or wear.

If liner ledge pitting, fretting, or wear is discovered during block inspection, the block **must** be machined.

[[377-001-058 — Cylinder Block Counterbore|Refer to Procedure 001-058 in Section 1.]]

![[01c00388.png]]

Check the top surface of the block for damage.
...
If fretting damage, scratches, cracks, or corrosion deeper than 0.08 mm \[0.003 in\] is present in an area where a head gasket seal ring or a grommet makes contact, the cylinder block **must** be replaced. There **must not** be any defect which extends more than 2.41 mm \[0.095 in\] from the edge of the coolant passage.
...
The main bearing bore diameter **must** be measured with the main bearings removed and the main bearing caps assembled and tightened to the correct specification. [[377-001-006 — Bearings, Main|Refer to Procedure 001-006 in Section 1.]]
...
Use the following procedure for location of the oil and coolant passages. Refer to Procedure 200-002 in Section F.
...
Dry the cylinder block with compressed air. Blow out all of the bolt holes, water and oil passages, or galleries with compressed air.
...
Make sure the cylinder block and all water and oil passages have been thoroughly cleaned and dried.
...
> [!note] Note · Примечание
> Before assembling the engine, clean and inspect the crankshaft, camshaft, gear housing, oil pan, cylinder head, rocker levers, lubricating oil pump, pistons, connecting rods and other associated parts thoroughly to remove debris and replace damage parts.
...
Reference Section AS - Engine Assembly - Group 00.
