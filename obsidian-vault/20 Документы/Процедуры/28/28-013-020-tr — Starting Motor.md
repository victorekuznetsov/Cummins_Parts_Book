...
> [!abstract] Процедура · `28-013-020-tr`
...
Предлагаются два варианта стартового двигателя:

- Delco Remy® Стартовые двигатели
- Prestolite® Стартовые двигатели

![[13u00031.png]]

Престолит® Запуск двигателя взорванный вид

1. Стартер
2. Втягивающее реле стартера
3. Втягивающее реле стартера
4. Пиньон

![[13k00044.png]]

Delco Remy® Starting Motor Exploded View (недоступная ссылка)
...
Электродвигатели Prestolite® и Delco Remy® могут быть предоставлены компанией Cummins Inc. или изготовителем оборудования. Если это предусмотрено производителем оборудования, см. информацию об услугах производителя оборудования. Электродвигатели работают на 24 VDC. Мощность для запуска двигателей обеспечивается через оригинальную проводку производителя оборудования (OEM). Стартовые двигатели установлены на корпус маховика. Стартерный магнитный переключатель крепится к пусковому двигателю и подключается к OEM-проводах жгута. Все компоненты, связанные с пусковым двигателем Prestolite®, весят менее 23 кг [50 фунтов]. Все компоненты, связанные со стартером Delco Remy, весят менее 36 кг[79 фунтов].
...
- Отключите батарею.[[99-013-009 — Battery Cables and Connections|См. процедуру 013-009 в разделе 13.]]

- Отключите батарею.[[99-013-009 — Battery Cables and Connections|См. процедуру 013-009 в разделе 13.]]
- Удалите электрические соединения из стартера.

![[ck800wa.png]]

### Снятие

Delco Remy® Стартовый двигатель

Удалите электрические соединения от стартового двигателя Delco Remy®.
...
Престолит® Стартовый двигатель

Удалите сигнальный провод из стартового магнитного переключателя (1).

Удалите положительный (+) кабель из стартового соленоида.

Удалить отрицательный (-) кабель из пускового двигателя.

![[13u00032.png]]

Удалить стартовый двигатель.
...
Используйте пар для очистки внешней стороны стартового двигателя.

Проверьте передачу, вал, терминалы и втулку на предмет износа или повреждения.

Замените стартовый двигатель, если он изношен или поврежден.
...
Чистый внешний вид стартового двигателя. Используйте пар. Просушите сжатым воздухом.

Осмотрите двигательное тело и пиньон.

Заменить пусковой двигатель, если:

- Разбитый
- Пинионные зубы носят
- Зубы пиниона сколоты
- У пиниона сломаны зубы
- В противном случае поврежден

![[13u00034.png]]

Осмотрите запуск электропроводки для корродированных или рыхлых соединений.

Чистить и затягивать соединения, если это необходимо.

![[13u00036.png]]

Используйте устройство для блокировки двигателя, чтобы вращать двигатель один полный оборот при осмотре зубов маховика кольцевой передачи через отверстие стартового фланца.

Заменить кольцевую передачу, если:

- наплевать
- В противном случае поврежден

[[102-016-008 — Flywheel Ring Gear|См. процедуру 016-008 в разделе 16.]]
...
> [!warning] ОСТОРОЖНО
> Убедитесь, что вы используете ту же толщину стартерного моторного прокладки (1) (если используется), что и убранный для установки стартера для предотвращения повреждения двигателя или стартера.

Установка первого электродвигателя на двигателях серий K38 и K50 упростит установку обоих пусковых двигателей.
...
Установите стартер и болты.

Затяните болты.

> [!tip] Момент затяжки
> Кассета Iron Flywheel 215 Н·м [159 футов-лб]

> [!tip] Момент затяжки
> Алюминиевый корпус Flywheel 195 Н·м [144 фут-лб]
...
Подключите положительный (+) кабель к терминалу «В» на стартере соленоида.

> [!tip] Момент затяжки
> 26 Н·м [230 фунт-дюйм]

Подключите отрицательный (-) кабель к терминалу на стартовом двигателе.

> [!tip] Момент затяжки
> 26 Н·м [230 фунт-дюйм]

Подключите сигнальный провод к терминалу на стартовом магнитном переключателе (1).

> [!tip] Момент затяжки
> 2.25 Н·м [20 фунт-дюйм]
...
- Подключите батарею.[[99-013-009 — Battery Cables and Connections|См. процедуру 013-009 в разделе 13.]]
- Управляйте стартером и проверяйте правильность работы.

- Установите электрические соединения на стартерный двигатель.
- Подключите батарею.[[99-013-009 — Battery Cables and Connections|См. процедуру 013-009 в разделе 13.]]
- Управляйте стартером и проверяйте правильность работы.
...
>
> - Disconnect the battery. [[99-013-009 — Battery Cables and Connections|Refer to Procedure 013-009 in Section 13.]]
>
> - Disconnect the battery. [[99-013-009 — Battery Cables and Connections|Refer to Procedure 013-009 in Section 13.]]
...
>
> **Note · Примечание**
> **Not** all engines contain spacers and gaskets.
>
...
> - Otherwise damaged
>
> [[102-016-008 — Flywheel Ring Gear|Refer to Procedure 016-008 in Section 16.]]
>
> ### Install
>
> Delco Remy® Starting Motor
...
> Batteries can emit explosive gases. To reduce the possibility of personal injury, always ventilate the compartment before servicing the batteries. To reduce the possibility of arcing, remove the negative (-) battery cable first and attach the negative (-) battery cable last.
>
> - Connect the battery. [[99-013-009 — Battery Cables and Connections|Refer to Procedure 013-009 in Section 13.]]
