...
С момента появления двигателей К38 изменилась конструкция цилиндрового гильзы-контрбора. Старые двигатели не содержат кольца против ствола, но имеют толстый фланцевый гильза. Более новые двигатели имеют противоборство для толстых фланцевых цилиндрических гильз и содержат противоборное кольцо.

Все двигатели K50 содержат противоборство для толстых фланцевых цилиндрических вкладышей и содержат противоборные кольца.

Изменилась линейная протрузия для двигателей К38 и К50. Протрузия гильзы должна быть в пределах от 0,152 мм до 0,203 мм \[0,006 до 0,008 дюйма \]. Глубина противоборства на существующих блоках была изменена для получения правильного выступа.
...
Были изменены пластины крышки Vee, которые крепятся к блоку на K38. Предыдущие двигатели имели две крышки, которые были одинакового размера. Современные двигатели требуют одной маленькой и трех больших крышечных пластин.
...
В течение короткого периода времени, отверстия для обоих распределительных валов были обработаны так же, как и новый цилиндрический вал водяного насоса. Следующие серийные номера двигателя требуют вала бездействия, Часть Номер 3176836, в местах бездействия распределительного вала.
...
4. Распредвальная масляная винт
...
4. Пластина и уплотнение (**Только**, если двигатель имеет задний уплотнительный кожух;**, если двигатель имеет задний привод привода нижний, должны быть открыты, чтобы обеспечить маслом задний привод привода нижний и верхний блоки). Левый берег (LB) и правый (RB) пластины отличаются. Некоторые блоки **не содержат эти отверстия.
5. Распредвальная масляная винт
6. Дюбель с гильзой.
...
14. Основная масляная винт трубная пробка (на двигателях с контролем времени шага (STC), фитинг для STC контрольного клапана впускного шланга масла должен быть установлен).
...
14. Основная масляная винт трубная пробка (на двигателях с STC, фитинг для STC управления клапаном впускного шланга масла должен быть установлен).
...
18. Надбавная масляная винт.

19. Пин-штукатурка для цилиндров.

20. Штепсель для бурения масляных труб (обычно для установки калибра давления масла в транспортном средстве).

21. Масляное бурение AVSEAL® или трубная пробка.

22. Штепсель для бурения масляных труб (в некоторых двигателях впускной шланг типа масла для турбокомпрессора).
...
14. Основная масляная винт трубная пробка (На двигателях с STC устанавливается фитинг для впускного шланга STC управляющего клапана масла).
...
13. Основная масляная винт трубная пробка (На двигателях с STC устанавливается фитинг для впускного шланга STC управляющего клапана масла).
...
> [!warning] ОСТОРОЖНО
> Чтобы уменьшить вероятность повреждения блока двигателя, убедитесь, что вся вода удалена из болтовых отверстий и масляных проходов.

Удалите блок из резервуара для очистки.

Очистите блок двигателя паровым очистителем. Убедитесь, что все масляные каналы чистые.
...
Проверьте сиденья гильзы блока двигателя на прокладку.
...
Диаметр (1) зависит от того, были ли установлены стандартные размеры или негабаритные гильзы.
...
Глубина (2) зависит от того, были ли установлены стандартные размеры или негабаритные гильзы. Глубина также зависит от того, был ли блок разрезан для трамплинов.
...
Глубина может быть максимум 3,38 мм \[0,133 дюйма \] больше, если блок был обработан ранее для шасси и негабаритных гильз.
...
Если верхняя противоборка **не** в стандартных спецификациях, блок должен быть обработан для негабаритных гильз.[[28-001-058-tr — Cylinder Block Counterbore|См. процедуру 001-058 в разделе 1.]]
...
(2) Эти спецификации необходимы для протрузии гильзы от 0,152 до 0,203 мм \[0,006 до 0,008 дюйма \]. Спецификация протрузии изменилась с тех пор, как были введены блоки с этой конструкцией. Фактический размер зависит от того, были ли установлены стандартные размеры или негабаритные гильзы, и был ли блок обработан для шампиньонов.
...
Если блок больше, чем спецификация для самого большого гильзы, может быть установлен ремонтный рукав.[[28-001-058-tr — Cylinder Block Counterbore|См. процедуру 001-058 в разделе 1.]]
...
> [!note] Примечание
> Эти спецификации являются теми, которые необходимы для протрузии гильзы от 0,152 мм до 0,203 мм \[0,006 до 0,008 дюйма \]. Спецификация протрузии изменилась с тех пор, как были изготовлены блоки с этой конструкцией.
...
Внутренний диаметр верхней контрборы **должен быть круглым в пределах 0,025 мм \[0,001 дюйма \]. Если измерение **не в пределах спецификации, проверьте, можно ли обработать блок для негабаритных гильз.[[28-001-058-tr — Cylinder Block Counterbore|См. процедуру 001-058 в разделе 1.]]

> [!note] Примечание
> Верхняя контрбора **должна** быть не более 0,025 мм \[0,001 дюйма \] больше, чем фланец цилиндрового гильзы, или не более 0,076 мм \[0,003 дюйма \] меньше, чем фланец цилиндрового гильзы.
...
> [!note] Примечание
> Если обрабатывается поверхность головной палубы блока, то обрабатывается глубина выступа противоборки цилиндрового гильзы.[[28-001-058-tr — Cylinder Block Counterbore|См. процедуру 001-058 в разделе 1.]]
...
> [!warning] ОСТОРОЖНО
> Основные подшипники пронумерованы через «7» на К38, а через «9» на двигателях К50. Установите каждый колпачок в правильном месте. Крышка «1» должна быть установлена в передней части блока. Слот в крышке для подшипника должен быть на той же стороне, что и слот в блоке.

Используйте чистое моторное масло для смазки болтов, головок и шайб.

Установите каждый болт и шайбу (21) вручную, чтобы убедиться, что они расположены правильно.
