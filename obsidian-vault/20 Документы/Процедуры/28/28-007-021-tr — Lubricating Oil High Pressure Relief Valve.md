...
> [!abstract] Процедура · `28-007-021-tr`
...
- Слить масло из двигателя. См. процедуру 007-037 в разделе 7.
- Уберите масляную кастрюлю.[[28-007-025-tr — Lubricating Oil Pan|См. процедуру 007-025 в разделе 7.]]
- Удалите трубки для переноса масла.[[28-007-040-tr — Lubricating Oil Transfer Tube|См. процедуру 007-040 в разделе 7.]]

![[ck800wa.png]]

### Разборка

Эта процедура описывает клапан сброса высокого давления для двигателей K38 (1), QSK38 (2), K50 (2) и QSK50 (2). Функция и процедура являются одинаковыми. В качестве примера используется клапан K38 (1).

![[lp6vaga.png]]

Используйте небольшой молоток и дрейф. Удалить **один** штифт (3) из удерживающего штифта (4).
...
Нажмите на шайбу (5), пока она не коснется удерживающего штифта.

Используйте молоток и дрейф. Удалите удерживающий штифт (4) из корпуса клапана (8).

![[lp6vafb.png]]

Удалите затвердевшую шайбу (5), пружину (9) и плунжер (10) из тела (8).

Прыгун (11) для клапанов QSK38, K50 и QSK50 отличается от плунжера для клапанов K38.
...
Если шайба изношена, ее следует заменить правильной закаленной шайбой машиной.

![[lp6vaeb.png]]

### Осмотр

Проверьте цилиндр, который был в корпусе плунжера и плунжере, на предмет повреждений.

Если мелкая решетчатая ткань крокуса не устраняет повреждение, часть должна быть заменена.

![[lp6vasa.png]]

Измерьте свободную длину пружины. Используйте пружинный тестер для измерения силы пружины (7) на рабочей высоте (6).

| K38 Высоконапорная релифовая волна |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| Свободная длина: | 178.8 | Мин | 7.04 |
|  | 182.6 | Макс | 7.19 |
| Рабочая высота (6): | 117.09 | НМ | 4.61 |

| K38 Высоконапорная релифовая волна |  |  |  |
|---|---|---|---|
|  | n |  | хулиган |
| Загрузка (7): | 729 | Мин | 164 |
|  | 164 | Макс | 192 |

![[kn8spta.png]]

| QSK38 и K50 High-Pressure Relief клапан Spring |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| Свободная длина: | 92.2 | Мин | 3.63 |
|  | 94.7 | Макс | 3.73 |
| Рабочая высота (6): | 49.3 | НМ | 1.94 |

|  | n |  | хулиган |
|---|---|---|---|
| Загрузка (7): | 391 | Мин | 88 |
|  | 463 | Макс | 104 |

| QSK50 High-Pressure Relief клапан Spring (Воздушная волна) |  |  |  |
|---|---|---|---|
|  | мм |  | в |
| Свободная длина: | 83.1 | Мин | 3.27 |
|  | 85.6 | Макс | 3.37 |
| Рабочая высота (6): | 49.3 | НМ | 1.94 |
...
Используйте чистое моторное масло для смазки плунжера и цилиндра, вставленного в корпус.

Установите плунжер (10) и пружину (9) в корпус (8).
...
Положите затвердевшую шайбу (5) на конец пружины.

Выталкивайте детали в цилиндр, пока шайба не выйдет за отверстие для удерживающего штифта.

Установите удерживающий штифт (4) в корпус. Используйте небольшой молоток и дрейф, чтобы перемещать штифт через отверстие в теле, пока отверстие в штифте для штифта рулона не будет открыто.

![[lp6vaab.png]]

Используйте небольшой молоток. Установите штифт (3) в отверстие в удерживающем штифте (4).
...
- Установите трубки для переноса масла.[[28-007-040-tr — Lubricating Oil Transfer Tube|См. процедуру 007-040 в разделе 7.]]
...
> - Drain the oil from the engine. Refer to Procedure 007-037 in Section 7.
> - Remove the oil pan. [[28-007-025-tr — Lubricating Oil Pan|Refer to Procedure 007-025 in Section 7.]]
> - Remove the oil transfer tubes. [[28-007-040-tr — Lubricating Oil Transfer Tube|Refer to Procedure 007-040 in Section 7.]]
>
> ### Disassemble
>
...
> Some state and federal agencies have determined that used engine oil can be carcinogenic and cause reproductive toxicity. Avoid inhalation of vapors, ingestion, and prolonged contact with used engine oil. If not reused, dispose of in accordance with local environmental regulations.
>
> - Install the oil transfer tubes. [[28-007-040-tr — Lubricating Oil Transfer Tube|Refer to Procedure 007-040 in Section 7.]]
