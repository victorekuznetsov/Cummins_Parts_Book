...
> [!abstract] Процедура · `28-003-009-tr`
...
Используйте растворитель. Очистите шахту. Используйте сжатый воздух для продувания масляных скважин, чтобы убедиться, что пять масляных отверстий не заблокированы.

Вилка (1) в основной масляной винте шахты коромысла должна быть установлена в кольцевой дюбельной части шахты (выхлопной рычаг).
...
Используйте сжатый воздух для продувания масляных буровых скважин, чтобы убедиться, что они не заблокированы.
...
Рука впускного клапана качения (1) должна иметь заклепку (2), установленную в масляном бурении.

Рука качения клапана выхлопного клапана (3) **не должна **иметь заклепку в масляном бурении.
...
Используйте пресс для арбора и ручную стрелку для качения клапанного клапана (1), номер детали ST-1284 или эквивалент для электрически приводимого в действие форсунки для установки втулки.
