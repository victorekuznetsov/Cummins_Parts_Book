...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/97/97-fc339int.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/97-fc339int.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSM11"
  - "двигатель/QSX15"
...
> [!abstract] Процедура · `97-fc339int`
> **Двигатели:** [[35354607 — QSM11 CM570 CPL 8608|35354607]], [[35373113 — QSM11 CM570 CPL 8471|35373113]], [[71156161 — QSM11 CM570 CPL 8543|71156161]], [[80141463 — QSX15 CM570 CPL 3088|80141463]], [[80248213 — QSX15 CM570 CPL 8760|80248213]]
> **Семейство:** QSM11, QSX15
> **Входит в руководства:** [[3666415 — ICON Idle Control System Master Repair Manual|3666415]]
> **Секции:** Section TF - Troubleshooting Fault Codes
> **Даты:** изменён 2004-09-28
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/97/97-fc339int.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/97-fc339int.pdf)
...
### Код неисправности: 339 (интегрированный)
...
|---|---|---|
| Код неисправности: 339 P(P): S087, 4 SPN: 1267 FMI: 4 лампы: Желтая СТО: | Idle Shutdown Vehicle Accessories Relay Driver Circuit - напряжение ниже нормального или короткое до низкого источника. Менее 6 VDC обнаруживаются на выходной цепи реле зажигания, когда высокое напряжение ожидал электронный модуль управления двигателем (ECM). | Система ICONTM будет отключена. Включено только обязательное отключение. Постоянная мощность будет находиться в цепи зажигания переключателя зажигания. |

![[19803215.png]]

### Описание цепи

Реле зажигания управляет цепями зажигания, питающими элементы управления отоплением и кондиционированием воздуха и другое оборудование, подключенное к реле (реле) шины зажигания. Это реле(ы) управляется положительным (+) сигналом реле зажигания от контакта 35 разъема ECM OEM двигателя.
...
Этот дефект обычно указывает на короткое замыкание на землю или открытую цепь от разъема двигателя ECM контакт 35, реле зажигания положительное (+). Реле зажигания положительное (+) (контакт 35) выводит 12 VDC для открытия реле (ретрансляторов) шины зажигания, когда система ICONTM приводит в действие транспортное средство и должна отключить питание, идущее к кабине. Реле (ретрансляторы) шины ICONTM обычно закрывается, когда не применяется питание.
...
|  | **ШАГ 1А.** Прочитайте коды неисправностей с помощью инструментария электронного обслуживания INSITETM или выключите светильник ICONTM. | Код 339 неактивен |
...
| ШАГ 3. | Осмотрите разъём OEM-проводов и переборку огневой стены OEM-проводов. |  |
|  | **STEP 3A.** Проверить проводку OEM и контакты разъема ECM двигателя. | Никаких поврежденных контактов |
...
|  | **STEP 3D** Проверить наличие открытой схемы. | См. руководство по устранению неполадок и ремонту OEM для спецификаций |
...
|  | **STEP 4B.** Проверьте катушку реле зажигания шины для короткого замыкания. | См. руководство по устранению неполадок и ремонту OEM для спецификаций |
| ШАГ 5. | Очистите код ошибки. |  |
|  | **STEP 5A.** Отключить код ошибки. | Код 339 неактивен; Вентиляторы панели управления отключены |
...
| Прочитайте коды неисправностей с помощью инструментария электронного обслуживания INSITETM или выключите лампу ICONTM. | Код 339 неактивен | 2А |
| Код ошибки 339 активный | 2А |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| См. процедуру 019-305. | Вентиляторы приборной панели выключаются | 5а |
| не соответствует спецификациям | 3А |  |

### ШАГ 3. Осмотрите разъём OEM-проводов и переборку огневой стены OEM-проводов.

#### ШАГ 3A. Проверьте проводку OEM и контакты разъема ECM двигателя.

| **Условия:** Выключите замок зажигания. Отсоедините разъём OEM-проводов от разъема ECM двигателя и разъем переборки OEM-проводов. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
...
| **Условия:** Выключите замок зажигания. Отсоедините разъем OEM-проводов от двигателя ECM. Отсоедините реле (ретрансляторы) шины зажигания от электропроводки OEM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Измерьте сопротивление от контакта 35 ко всем другим штифтам в разъёме OEM-проводов. См. схему проводов или описание схемы в начале этого кода неисправности для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Более 100 тыс. ом | 3D |
| Ремонт или замена OEM проводов жгута. См. сервисное руководство изготовителя машины. | 5а |  |

#### ШАГ 3D. Проверьте цепь на обрыв.

| **Условия:** Выключите замок зажигания. Отсоедините разъем OEM-проводов от двигателя ECM. Отсоедините проводку OEM от реле шины зажигания. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Измерить сопротивление от разъема 85 реле зажигания к разъему OEM-проводов ремня при контакте 35 двигателя ECM. См. схему проводов или описание схемы в начале этого кода неисправности для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | См. руководство по устранению неполадок и ремонту OEM для спецификаций. | 4А |
| Ремонт или замена OEM проводов жгута. См. сервисное руководство изготовителя машины. | 5а |  |
...
#### ШАГ 4B. Проверьте катушку реле зажигания для короткого замыкания.

| **Условия:** Выключите замок зажигания. Отсоедините реле шины зажигания от электропроводки OEM. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Измерить сопротивление от контакта 86 реле (реле) шины зажигания до контактов 30, 87 и 87А реле (реле). См. схему проводов или описание схемы в начале этого кода неисправности для идентификации контакта с разъемом. Для общих методов измерения сопротивления, обратитесь к измерениям сопротивления с использованием мультиметра и схемы проводов, процедуры[[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | См. руководство по устранению неполадок и ремонту OEM для спецификаций | 5а |
| Заменить аксессуар для автомобиля с отключением или реле шины зажигания, обратитесь к руководству по устранению неполадок и ремонту OEM. | 5а |  |
...
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверить код 339 неактивен с помощью инструментария электронного обслуживания INSITETM. Выполните испытание реле зажигания шины с использованием инструментария электронного обслуживания INSITETM. Стирайте неактивные коды неисправностей с помощью инструментария электронного обслуживания INSITETM. | Код 339 неактивен; Вентиляторы панели управления отключены | Ремонт завершён |
...
>
> | **Conditions:** Turn keyswitch OFF. Disconnect the OEM harness connector from the engine ECM and the OEM harness bulkhead connector. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
...
>
> | **Conditions:** Turn keyswitch OFF. Disconnect the OEM harness connector from the engine ECM. Disconnect the ignition bus relay(s) from the OEM harness. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Measure the resistance from pin 35 to all other pins in the OEM harness connector. Refer to the wiring diagram or the circuit description at the beginning of this fault code for connector pin identification. For general resistance measurement techniques, refer to the Resistance Measurements Using a Multimeter and Wiring Diagram, Procedure [[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | More than 100k ohms | 3D |
> | Repair or replace the OEM wiring harness. Refer to the OEM service manual. | 5A |  |
>
> #### STEP 3D. Check for an open circuit.
>
> | **Conditions:** Turn keyswitch OFF. Disconnect the OEM harness connector from the engine ECM. Disconnect the OEM harness from the ignition bus relay. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Measure the resistance from the ignition bus relay connector pin 85 to the OEM harness connector at engine ECM pin 35. Refer to the wiring diagram or the circuit description at the beginning of this fault code for connector pin identification. For general resistance measurement techniques, refer to the Resistance Measurements Using a Multimeter and Wiring Diagram, Procedure [[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Refer to the OEM troubleshooting and repair manual for specifications. | 4A |
> | Repair or replace the OEM wiring harness. Refer to the OEM service manual. | 5A |  |
>
> ### STEP 4. Check the ignition bus relay.
>
...
> | Repair the damaged pins. Flush the dirt, debris, and moisture from the connector pins using electrical contact cleaner, Part Number 3824510. Install the appropriate connector seal if it is damaged or missing. Repair or replace the OEM wiring harness. Refer to the OEM service manual. Replace the engine ECM. Refer to Procedure 019-031 in Troubleshooting and Repair Manual, CELECT™ Plus, Bulletin 3666130, or Procedure 019-031 in Troubleshooting and Repair Manual, Electronic Control System, ISM, Bulletin [[3666266 — ISM and QSM11 Electronic Control System Troubleshooting and Repair Manual\|3666266]], or Procedure 019-031 in Troubleshooting and Repair Manual, Electronic Control System, Signature and ISX, Bulletin 3666259, or Procedure 019-031 in Troubleshooting and Repair Manual, Electronic Control System, CM870 ISM, Bulletin 4021381, or Procedure 019-031 in Troubleshooting and Repair Manual, Electronic Control System, CM870 Signature and ISX, Bulletin 4021334, or Procedure 019-031 in Troubleshooting and Repair Manual, Electronic Control System, CM875 ISM, Bulletin 4021477. | 5A |  |
>
> #### STEP 4B. Check the ignition bus relay coil for a short circuit.
>
> | **Conditions:** Turn keyswitch OFF. Disconnect the ignition bus relay from the OEM harness. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Measure the resistance from pin 86 of the ignition bus relay(s) to pins 30, 87, and 87A of the relay(s). Refer to the wiring diagram or the circuit description at the beginning of this fault code for connector pin identification. For general resistance measurement techniques, refer to the Resistance Measurements Using a Multimeter and Wiring Diagram, Procedure [[99-019-360 — Resistance Measurement Using a Multimeter\|019-360]]. | Refer to the OEM troubleshooting and repair manual for specifications | 5A |
