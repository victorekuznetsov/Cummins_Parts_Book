...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/01-fc1423.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/01"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/01/01-fc1423.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/01-fc1423.pdf)
...
|---|---|---|
| Код неисправности: 1423 PID(P): СПН: ФМИ: Лампа: Предупреждение СТО: | Диагностика водителя топливного насоса выявила ошибку. | Никаких действий со стороны ЕКМ не предпринимается. Возможная потеря производительности. |
...
ECM проверяет привод привода топливного насоса для поддержания правильной работы. Привод топливного насоса приводится в действие электронным модулем управления (ECM) для управления замером топлива. Каждый топливный привод соединен с ECM посредством подачи и обратной проволоки. Электрический импульс отправляется в топливный привод от ECM на подаче провода и возвращается в ECM на обратном проводе. Каждый соленоидный клапан обычно закрыт, и он открыт только электрическим импульсом от ECM во время измерения. ECM контролирует напряжение, никакое напряжение не будет срабатывать с кодом 1423 по умолчанию и может быть вызвано шортами, открываниями или неисправным приводом привода топливного насоса в ECM.

### Расположение компонента

Водитель топливного насоса находится в ECM.
...
См. Код устранения неисправностей t05-1423
