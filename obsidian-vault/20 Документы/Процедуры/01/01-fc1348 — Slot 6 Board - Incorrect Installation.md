...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/01-fc1348.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/01"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/01/01-fc1348.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/01-fc1348.pdf)
...
|---|---|---|
| Код неисправности: 1348 PID(P): СПН: ФМИ: Лампа: Отключение SRT: | Слот 6 доска отсутствует или был установлен правильно. | Двигатель не запускается **. |
...
Этот код неисправности используется ECM для того, чтобы сообщить оператору, что доска слота 6 отсутствует или установлена неправильно.

### Расположение компонента

См. раздел E для определения местоположения клетки карты ECM и доски слота 6.

### Практические замечания

Возможные режимы отказа — неправильная установка слота 6 и загрузка неправильной программной калибровки в ECM.

См. Код устранения неполадок t05-1348
