...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/01-fc399.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QST30"
  - "группа/01"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/01/01-fc399.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/01-fc399.pdf)
...
|---|---|---|
| Код неисправности: 399 PID(P): СПН: ФМИ: Лампа: Отключение SRT: | Схема срабатывания привода № 2 — заземленная схема. (задний) | Двигатель отключится. |
...
Устранение неполадок код t05-399
