...
Нагрузка управляет аналоговым входным сигналом точки заданной точки заданного значения, который является внешним входом в модуль управления двигателем, используемым для управления и изменения выходного сигнала генератора киловатт, в то время как генераторный набор параллелен утилите. Нагрузка регулирует киловаттный заданный аналоговый входной сигнал, посылаемый в модуль управления двигателем с удаленного устройства ввода.
