...
|---|---|---|
| Код неисправности: 1457 PID(P): СПН: ФМИ: Лампа: Предупреждение СТО: | Генератор, синхронизирующийся с электрическим шиной, не сработал. | Генератор будет продолжать работать, но не будет поднимать нагрузку. |
