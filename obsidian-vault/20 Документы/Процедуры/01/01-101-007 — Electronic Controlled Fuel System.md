...
Корпус управляющего клапана регулирует расход топлива с помощью рельсового привода (2) и заправочного рельсового привода (6).
...
Подменю «Данные шины» предоставляет оператору следующую информацию:
...
1. Отображение подменю калибровки напряжения шины.
...
7. Повторите шаги 2-6 для шинный вольт L2 и L3. (На шаге 2 прикрепите метр к выходу переменного тока от L2 до L3 для калибровки L2 и L3 до L1 для калибровки L3.)
