...
|  | **ШАГ 1А.** Проверьте подачу и возврат проводов в коммуникационном шине ModiconTM на наличие открытого доступа. | Менее 10 Ом? |
...
#### ШАГ 1A. Проверьте подачу коммуникационного шины ModiconTM и обратные провода для открытого доступа.
