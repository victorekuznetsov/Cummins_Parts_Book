---
aliases:
  - "Останов двигателя при активном верхнем диапазоне частот, когда это неприменимо"
type: "Процедура"
doc: "116-t02-1095"
title_en: "Engine Shutdown With High Speed Range Active When Not Applicable"
title_ru: "Останов двигателя при активном верхнем диапазоне частот, когда это неприменимо"
modified: "2009-07-15"
engines:
  - "41349633"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1095.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1095.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
# Engine Shutdown With High Speed Range Active When Not Applicable
**Останов двигателя при активном верхнем диапазоне частот, когда это неприменимо**

> [!abstract] Процедура · `116-t02-1095`
> **Двигатели:** [[41349633 — QSK19 CM2150 MCRS CPL 3666|41349633]]
> **Семейство:** QSK19
> **Входит в руководства:** [[4021617 — C Command Elite and C Command Elite Plus Panel System Marine Master Repair Manual|4021617]]
> **Секции:** Section TT - Troubleshooting Symptoms (New Format)
> **Даты:** изменён 2009-07-15
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1095.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1095.pdf)
...
- Устройство SDU410 реагирует на датчик диапазона скоростей, когда ** не** активируется и выключает двигатель.
...
Устройство SDU410 имеет два датчика давления моторного масла. Один для диапазона низких оборотов двигателя (LSR) и один для диапазона высоких оборотов двигателя (HSR). Датчик LSR всегда активен, но датчик HSR активен только при скорости двигателя выше 1400 об/мин.
...
> ### Symptoms
>
> - The SDU410 unit is reacting to the high speed range sensor when **not** activated and shuts down the engine.
>
