---
aliases:
  - "Неверная индикация неисправности питания на блоке останова"
type: "Процедура"
doc: "116-t02-1087"
title_en: "Incorrect Indication of Power Supply Fault and Engine Shutdown Unit"
title_ru: "Неверная индикация неисправности питания на блоке останова"
modified: "2008-04-04"
engines:
  - "41349633"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1087.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1087.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
# Incorrect Indication of Power Supply Fault and Engine Shutdown Unit
**Неверная индикация неисправности питания на блоке останова**

> [!abstract] Процедура · `116-t02-1087`
> **Двигатели:** [[41349633 — QSK19 CM2150 MCRS CPL 3666|41349633]]
> **Семейство:** QSK19
> **Входит в руководства:** [[4021617 — C Command Elite and C Command Elite Plus Panel System Marine Master Repair Manual|4021617]]
> **Секции:** Section TT - Troubleshooting Symptoms (New Format)
> **Даты:** изменён 2008-04-04
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1087.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1087.pdf)
...
- Сигнализация звучит на блоке DCU410 с ложным сигналом тревоги +24-VDC.
...
Сигнализация блока DCU410 будет звучать, если будет обнаружена неисправность источника питания +24-VDC.
...
### ШАГ 1. Проверьте блок DCU410.

#### ШАГ 1A. Проверьте мощность светодиода для освещения.

| **Условия:** Проверьте дисплей блока DCU410. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте блок DCU410 для освещенных светодиодов. | Светодиодная подсветка? *** Ремонт:** Проверьте цепи подачи и возврата блока DCU410 на наличие прерывистой неисправности. Ссылка на соответствующее дерево устранения неполадок. | Ремонт завершён |
| Светодиодная подсветка? **NORepair:** Заменить блок DCU410. Свяжитесь с авторизованным ремонтным центром Cummins® для замены блока DCU410. | 2А |  |

### ШАГ 2. Проверьте блок питания DCU410.

#### ШАГ 2A. Проверьте блок питания DCU410 для +24-VDC.

| **Условия: ** Откройте окно интерфейса клиента. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте блок питания DCU410 для +24-VDC. | Является ли электропитание +24-VDC? *** Ремонт:** Проверить аккумуляторы. См. сервисное руководство изготовителя машины. | Ремонт завершён |
...
#### ШАГ 3C-2. Проверьте напряжение батареи 1 питания и возврат проводов для провода к проводу коротко.

| **Условия: ** Откройте окно интерфейса клиента. Отключите напряжение 1 питания и возврата от блока SDU410 и блока DCU410. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте напряжение батареи 1 питания и возврат проводов для провода к проводу коротко. Поместите один испытательный щуп на провод питания напряжения батареи 1 в блоке SDU410. Поместите другой испытательный щуп на все другие провода в блок SDU410. Поместите один испытательный щуп на провод возврата напряжения батареи 1 в блок SDU410. Поместите другой испытательный щуп на все другие провода в блок SDU410. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Менее 10 Ом? *** Заменить провод.[[116-015-023 — Customer Interface Box\|См. процедуру 015-023 (Customer Interface Box) в разделе 15.]] | Ремонт завершён |
| Менее 10 Ом? ** НЕТ** | 3D |  |
...
> ### Symptoms
>
> - Alarm is sounding on DCU410 unit with false alarm power supply +24-VDC fault.
>
...
> ### Shoptalk
>
> The DCU410 unit alarm will sound if the power supply +24-VDC fault is detected.
>
...
>
> ### STEP 1. Check the DCU410 unit.
>
> #### STEP 1A. Check the power LED for illumination.
>
> | **Conditions:** Check the DCU410 unit display. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the DCU410 unit for illuminated LEDs. | Is the power LED illuminated? **YESRepair:** Check the DCU410 unit supply and return circuits for intermittent fault. Reference the appropriate troubleshooting tree. | Repair complete |
> | Is the power LED illuminated? **NORepair:** Replace the DCU410 unit. Contact a Cummins® Authorized Repair Location for replacement of the DCU410 unit. | 2A |  |
>
> ### STEP 2. Check the DCU410 unit power supply.
>
> #### STEP 2A. Check the DCU410 unit power supply for +24-VDC.
>
> | **Conditions:** Open the customer interface box. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the DCU410 unit power supply for +24-VDC. | Is the power supply +24-VDC? **YESRepair:** Check the batteries. Refer to the OEM service manual. | Repair complete |
...
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the battery voltage 1 supply wire for a short to ground. Place one test lead on the battery voltage 1 supply wire at the customer interface box logic unit. Place the other test lead on panel ground. Refer to the appropriate circuit diagram or wiring diagram for pin and wire identification. | Less than 10 ohms? **YESRepair:** Replace the wire. [[116-015-023 — Customer Interface Box\|Refer to Procedure 015-023 (Customer Interface Box) in Section 15.]] | Repair complete |
