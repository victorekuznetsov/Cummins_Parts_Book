---
aliases:
  - "Блок останова не индицирует активную неисправность"
type: "Процедура"
doc: "116-t02-1098"
title_en: "Shutdown Unit Does Not Indicate Fault When Fault is Active"
title_ru: "Блок останова не индицирует активную неисправность"
modified: "2008-04-04"
engines:
  - "41349633"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1098.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1098.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
# Shutdown Unit Does Not Indicate Fault When Fault is Active
**Блок останова не индицирует активную неисправность**

> [!abstract] Процедура · `116-t02-1098`
> **Двигатели:** [[41349633 — QSK19 CM2150 MCRS CPL 3666|41349633]]
> **Семейство:** QSK19
> **Входит в руководства:** [[4021617 — C Command Elite and C Command Elite Plus Panel System Marine Master Repair Manual|4021617]]
> **Секции:** Section TT - Troubleshooting Symptoms (New Format)
> **Даты:** изменён 2008-04-04
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1098.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1098.pdf)
...
|  | **STEP 1C.** Убедитесь, что блок DCU410 взаимодействует с блоком SDU410. |  |
| ШАГ 2. | Проверка проводки интерфейсной коробки заказчика |  |
|  | **STEP 2A.** Проверьте цепь коммуникационных автобусов ModiconTM на предмет открытия. | Менее 10 Ом? |
|  | **STEP 2B.** Проверьте цепь коммуникационных шин ModiconTM на короткое время от провода до провода. | Менее 10 Ом? |
|  | **STEP 2C.** Проверьте цепь коммуникационных автобусов ModiconTM на короткое время до земли. | Менее 10 Ом? |
...
#### ШАГ 1C. Проверьте дисплеи устранения неполадок DCU410.

| **Условия:** Проверьте наличие неисправностей в SDU410 и DCU410. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
...
#### ШАГ 2A. Проверьте цепь коммуникационных автобусов ModiconTM на предмет открытия.

| **Условия: ** Откройте окно интерфейса клиента Отключите сигнал и провода возврата на цепи шин связи модуля отключения модикон в терминальных полосах SDU410 и DCU410. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте цепь коммуникационных автобусов ModiconTM на предмет открытия. Поместите один испытательный щуп на блок отключения провода питания коммуникационных шин ModiconTM на терминальной полосе SDU410. Поместите другой испытательный щуп на блок отключения питания коммуникационных автобусов ModiconTM на терминальной полосе DCU410. Поместите один испытательный щуп на отключающем блоке коммуникационных шины ModiconTM обратного провода на терминальной полосе SDU410. Поместите другой испытательный щуп на отключающем блоке ModiconTM, возвращающемся на терминальной полосе DCU410. См. соответствующую схему или схему проводов для идентификации соединительного штифта. | Менее 10 Ом? *Да** | 2В |
...
#### ШАГ 2B. Проверьте цепь коммуникационных автобусов ModiconTM для короткого провода.
...
#### ШАГ 2C. Проверьте цепь коммуникационных автобусов ModiconTM для короткого приземления.
...
> |  | **STEP 1C.** Check to make sure the DCU410 unit is communicating with the SDU410 unit. |  |
...
>
> #### STEP 1C. Check the DCU410 troubleshooting display.
>
> | **Conditions:** Check the SDU410 and DCU410 units for faults. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
