---
aliases:
  - "Блок останова не индицирует активную неисправность датчика частоты"
type: "Процедура"
doc: "116-t02-1101"
title_en: "Shutdown Unit Does Not Indicate Speed Pickup Fault When Fault is Active"
title_ru: "Блок останова не индицирует активную неисправность датчика частоты"
modified: "2008-04-04"
engines:
  - "41349633"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1101.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1101.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
# Shutdown Unit Does Not Indicate Speed Pickup Fault When Fault is Active
**Блок останова не индицирует активную неисправность датчика частоты**

> [!abstract] Процедура · `116-t02-1101`
> **Двигатели:** [[41349633 — QSK19 CM2150 MCRS CPL 3666|41349633]]
> **Семейство:** QSK19
> **Входит в руководства:** [[4021617 — C Command Elite and C Command Elite Plus Panel System Marine Master Repair Manual|4021617]]
> **Секции:** Section TT - Troubleshooting Symptoms (New Format)
> **Даты:** изменён 2008-04-04
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1101.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1101.pdf)
...
|  | **ШАГ 1А.** Проверьте сигнал 1 оборота двигателя и провода возврата для открытого. | Менее 10 Ом? |
|  | **STEP 1A-1.** Проверьте сигнал 2 оборота двигателя и провода возврата для открытого. | Менее 10 Ом? |
|  | **STEP 1B.** Проверьте сигнал 1 оборота двигателя и провода возврата для короткого провода на блоке SDU410 и разъеме C4. | Менее 10 Ом? |
...
|  | **STEP 1C.** Проверьте скорость двигателя 1 сигнального провода на короткое время до заземления на блоке SDU410 и разъеме C4. | Менее 10 Ом? |
|  | **STEP 1C-1.** Проверьте скорость 2 двигателя на короткое время до заземления на SDU410 и разъеме C4. | Менее 10 Ом? |
...
#### ШАГ 1A. Проверьте сигнал 1 оборота двигателя и верните провода для открытого.
...
#### ШАГ 1A-1. Проверьте сигнал 2 оборота двигателя и верните провода для открытого.
...
#### ШАГ 1B. Проверьте сигнал 1 оборота двигателя и возвратные провода для короткого провода на блоке SDU410 и разъеме C4.
...
| Менее 10 Ом? ** НЕТ** | 1В-1-1 |  |

#### ШАГ 1B-1. Проверьте сигнал 2 оборота двигателя и возвратные провода для короткого провода на блоке SDU410 и разъеме C4.
...
#### ШАГ 1C. Проверьте скорость 1 сигнала двигателя на короткое время до земли в блоке SDU410 и разъеме C4.
...
#### ШАГ 1C-1. Проверьте скорость 2 двигателя сигнального провода для короткого приземления на блоке SDU410 и разъеме C4.
...
> ### Shoptalk
>
> The SDU410 unit has two engine speed input signals. If the signals differ, the unit the SDU410 unit uses the higher of the two readings as the signal.
>
