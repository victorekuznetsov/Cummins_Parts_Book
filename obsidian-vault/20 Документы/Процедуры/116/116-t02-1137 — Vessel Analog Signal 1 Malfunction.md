...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/116-t02-1137.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1137.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/116-t02-1137.pdf)
...
|  | **STEP 1B.** Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для открытого. |  |
|  | **STEP 1CB.** Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для короткого провода к проводу. |  |
...
|  | **STEP 2A.** Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для открытого. |  |
|  | **STEP 2B.** Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для короткого провода к проводу. |  |
|  | **STEP 2C** Проверить датчик температуры судна 1 сигнальной проволокой на короткое время до заземления. |  |
...
#### ШАГ 1B. Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для открытого.

| **Условия:** Откройте окно интерфейса клиента. Отсоедините датчик температуры судна 1 сигнал и возвращайте провода от блока DCU410 и соединения X4. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для открытого. Поместите один испытательный щуп на датчик температуры судна 1 сигнального провода в блок DCU410. Поместите другой испытательный щуп на датчик температуры судна 1 сигнального провода в соединение X4. Поместите один испытательный щуп на датчик температуры судна 1 обратного провода в блок DCU410. Поместите другой испытательный щуп на датчик температуры судна 1 обратного провода в соединение X4. Поместите один испытательный щуп на датчик температуры судна 1 возврата 2 провода в блок DCU410. Поместите другой испытательный щуп на датчик температуры судна, возвращающий 2 провода в соединение X4. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Менее 10 Ом? *Да | 1С |
...
#### ШАГ 1C. Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для короткого провода к проводу.

| **Условия:** Откройте окно интерфейса клиента. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для короткого провода к проводу. Поместите один испытательный щуп на датчик температуры судна 1 сигнального провода в блок DCU410. Поместите другой испытательный щуп на все другие провода в блок DCU410. Поместите один испытательный щуп на датчик температуры судна 1 обратного провода в блок DCU410. Поместите другой испытательный щуп на все другие провода в блок DCU410. Поместите один испытательный щуп на датчик температуры судна 1 возврата 2 провода в блок DCU410. Поместите другой испытательный щуп на все другие провода в блок DCU410. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Менее 10 Ом? * Заменить провод.[[116-015-023 — Customer Interface Box\|См. процедуру 015-023 (Customer Interface Box) в разделе 15.]] | Ремонт завершён |
| Менее 10 Ом? **НЕТ** | 1D |  |

#### ШАГ 1D. Проверьте датчик температуры судна 1 сигнальной проволокой для короткого приземления.

| **Условия:** Откройте окно интерфейса клиента. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте датчик температуры судна 1 сигнальной проволокой для короткого приземления. Поместите один испытательный щуп на датчик температуры судна 1 сигнального провода в блок DCU410. Поместите другой испытательный щуп на панельную площадку. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Менее 10 Ом? * Заменить DCU410. Обратитесь в авторизованный сервисный центр Cummins®. | Ремонт завершён |
| Менее 10 Ом? **НЕТ** | 2А |  |

### ШАГ 2. Проверьте жгут проводов изготовителя машины.

#### ШАГ 2A. Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для открытого.

| **Условия:** Откройте окно интерфейса клиента. Отсоедините датчик температуры судна 1 сигнал, верните и верните 2 провода при соединении X4. Отсоедините датчик температуры судна 1 датчик разъема. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для открытого. Поместите один испытательный щуп на датчик температуры судна 1 сигнального провода в соединение X4. Поместите другой испытательный щуп на датчик температуры судна 1 сигнальный контакт на разъем датчика. Поместите один испытательный щуп на датчик температуры судна 1 обратного провода в соединение X4. Поместите другой испытательный щуп на датчик температуры судна 1 обратного контакта на разъем датчика. Поместите один испытательный щуп на датчик температуры судна 1 возврата 2 провода в соединение X4. Поместите другой испытательный щуп на датчик температуры судна 1 обратный 2 штифт на разъем датчика. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Менее 10 Ом? *Да | 2В |
| Менее 10 Ом? **NORepair:** Заменить провод. См. сервисное руководство изготовителя машины. | Ремонт завершён |  |

#### ШАГ 2B. Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для короткого провода к проводу.

| **Условия:** Откройте окно интерфейса клиента. Отсоедините датчик температуры судна 1 сигнал, верните и верните 2 провода при соединении X4. Отсоедините датчик температуры судна 1 датчик разъема. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте датчик температуры судна 1 сигнал, возврат и возврат 2 проводов для короткого провода к проводу. Поместите один испытательный щуп на датчик температуры судна 1 сигнального провода в соединение X4. Поместите другой испытательный щуп на все другие провода в соединение X4. Поместите один испытательный щуп на датчик температуры судна 1 обратного провода в соединение X4. Поместите другой испытательный щуп на все другие провода в соединение X4. Поместите один испытательный щуп на датчик температуры судна 1 возврата 2 провода в соединение X4. Поместите другой испытательный щуп на все другие провода в соединение X4. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Менее 10 Ом? * Заменить провод. См. сервисное руководство изготовителя машины. | Ремонт завершён |
| Менее 10 Ом? **НЕТ** | 2C |  |

#### ШАГ 2C. Проверьте датчик температуры судна 1 сигнальной проволокой для короткого приземления.

| **Условия:** Откройте окно интерфейса клиента. Отсоедините датчик температуры судна 1 сигнальной проволокой при соединении X4. Отсоедините датчик температуры судна 1 датчик разъема. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте датчик температуры судна 1 сигнальной проволокой для короткого приземления. Поместите один испытательный щуп на датчик температуры судна 1 сигнального провода в соединение X4. Поместите другой испытательный щуп на землю двигателя. См. соответствующую схему или схему проводов для идентификации штифта и провода. | Менее 10 Ом? * Заменить провод. См. сервисное руководство изготовителя машины. | Ремонт завершён |
| Менее 10 Ом? **NORepair:** Заменить датчик температуры судна 1 датчиком. См. руководство по обслуживанию OEM или свяжитесь с авторизованным местом ремонта Cummins®. | Ремонт завершён |  |
