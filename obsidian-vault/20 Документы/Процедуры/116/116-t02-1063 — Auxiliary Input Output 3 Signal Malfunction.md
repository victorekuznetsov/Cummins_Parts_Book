...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1063.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1063.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1063.pdf)
...
- Отсутствие возможности для вспомогательного входа/выхода 3 сигнала.

### Как пользоваться этим деревом

Это дерево симптомов может быть использовано для устранения неполадок вспомогательного сигнала ввода/вывода 3. Начните с шага 1 поиска неисправностей. На шаге 2 система задаст ряд вопросов и по симптому выдаст перечень действий по поиску неисправности.
...
|  | **STEP 1A.** Проверьте вспомогательный вход/выход 3 сигнальной проводов для открытого доступа | Менее 10 Ом? |
|  | **ШАГ 1В.** Проверьте Вспомогательный вход/выход 3 сигнальной проводов для провода короткой проводов | Менее 10 Ом? |
|  | **STEP 1C.** Проверьте вспомогательную входную / выходную 3 сигнальную проводку для короткой посадки | Менее 10 Ом? |
| ШАГ 2. | Проверьте электропроводку двигателя на кабель клиентского интерфейса |  |
|  | **STEP 2A.** Проверьте вспомогательный вход/выход 3 сигнальной проводов для открытого доступа | Менее 10 Ом? |
|  | **STEP 2B.** Проверьте вспомогательную входную / выходную 3 сигнальную проводку для провода с коротким проводом | Менее 10 Ом? |

### ШАГ 1. Проверка проводки интерфейсной коробки заказчика

#### ШАГ 1A. Проверить вспомогательный вход/выход 3 сигнальной проводов для открытого доступа
...
| Проверьте вспомогательный вход/выход 3 сигнального провода на наличие открытого. Поместите один испытательный щуп на вспомогательный вход/выход 3 сигнального контакта в разъём С2. Поместите другой испытательный щуп на вспомогательный входной/выходной 3 сигнальный терминал на разъем X4. | Менее 10 Ом? *Да** | 1В |
| Менее 10 Ом? **NORepair:** Заменить провод. См. процедуру[[116-015-023 — Customer Interface Box\|015-023]]. | Ремонт завершён |  |

#### ШАГ 1B. Проверьте вспомогательную входную / выходную 3 сигнальную проводку для провода короткой проводов

| **Условия: ** Откройте окно клиентского интерфейса Отключить окно клиентского интерфейса к проводах двигателя, разъёму кабеля C2 от окна клиентского интерфейса. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте вспомогательный входной/выходной 3 сигнальный провод для провода для провода короткого. Поместите один испытательный щуп на вспомогательный вход/выход 3 сигнального контакта в разъём С2. Поместите другой испытательный щуп на каждый из оставшихся терминалов в разъем X4. | Менее 10 Ом? *** Заменить провод. См. процедуру[[116-015-023 — Customer Interface Box\|015-023]]. | Ремонт завершён |
| Менее 10 Ом? ** НЕТ** | 1С |  |

#### ШАГ 1C. Проверьте вспомогательную входную / выходную 3 сигнальную проводку для короткой посадки

| **Условия: ** Откройте окно клиентского интерфейса Отключить окно клиентского интерфейса к проводах двигателя, разъёму кабеля C2 от окна клиентского интерфейса. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте вспомогательный входной/выходной 3 сигнальный провод на короткое время до земли. Поместите один испытательный щуп на вспомогательный вход/выход 3 сигнального контакта в разъём С2. Поместите другой испытательный щуп на панельную площадку. | Менее 10 Ом? *** Заменить провод. См. процедуру[[116-015-023 — Customer Interface Box\|015-023]]. | Ремонт завершён |
| Менее 10 Ом? ** НЕТ** | 2А |  |

### ШАГ 2. Проверьте электропроводку двигателя на кабель клиентского интерфейса

#### ШАГ 2A. Проверить вспомогательный вход/выход 3 сигнальной проводов для открытого доступа
...
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте вспомогательный вход/выход 3 сигнального провода на наличие открытого. Поместите перемычку между вспомогательным контактом сигнала ввода/вывода 3 и вспомогательным контактом сигнала ввода/вывода 2 в разъеме C9. Поместите один испытательный щуп во вспомогательный входной/выходной 2 сигнальный контакт разъема С2. Поместите другой испытательный щуп во вспомогательный входной/выходной 3-сигнальный контакт разъема С2. | Менее 10 Ом? *Да** | 2В |
| Менее 10 Ом? **Заменить кабель.** | Ремонт завершён |  |

#### ШАГ 2B. Проверьте вспомогательную входную / выходную 3 сигнальную проводку для провода короткой проводов

| **Условия:** Отсоединить окно интерфейса клиента к разъёму кабеля C2 с помощью проводов двигателя от окна интерфейса клиента Отключить окно интерфейса клиента к разъёму кабеля C9 с помощью проводов двигателя. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте вспомогательный вход/выход 3 сигнального провода для провода к проводу короткий. Поместите один испытательный щуп на вспомогательный вход/выход 3 сигнального контакта в разъём С2. Поместите другой испытательный щуп на каждый из оставшихся штифтов в разъеме C2. | Менее 10 Ом? *** Заменить кабель. | Ремонт завершён |
