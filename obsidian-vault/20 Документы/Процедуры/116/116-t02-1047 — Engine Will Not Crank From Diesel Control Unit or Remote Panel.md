...
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/116-t02-1047.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1047.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/116-t02-1047.pdf)
...
|  | **ШАГ 1А.** Проверьте кнопку остановки двигателя на предмет вовлечения. |  |
|  | **STEP 1B.** Проверьте логическую подсветку светодиодного блока интерфейса клиента. |  |
|  | **STEP 1C.** Проверьте провод питания DCU410 на напряжение +24-VDC. |  |
|  | **STEP 1D.** Проверьте провод дистанционного пуска на наличие открытого источника питания. |  |
|  | **ШАГ 1Е.** Проверьте провод сигнала переключателя реле стартера на наличие открытого. |  |
|  | **STEP 1F.** Проверить провод сигнала прелюбрикационной активации на наличие открытого сигнала. |  |
|  | **STEP 1G.** Проверить наличие провода сигнала для открытого сигнала. |  |
|  | **STEP 1H.** Проверьте провод питания для дистанционного запуска на короткое время. |  |
|  | **STEP 1I.** Проверьте сигнальный провод реле стартера на короткое расстояние от провода к проводу. |  |
|  | **STEP 1J.** Проверить сигнал прелюбрикационной активации провода на короткое расстояние от провода к проводу. |  |
|  | **STEP 1K.** Проверьте полный сигнальный провод для короткого провода к проводу. |  |
|  | **STEP 1L.** Проверьте провод дистанционного пускового питания на короткое время до земли. |  |
|  | **STEP 1M.** Проверить сигнал прелюбрикационной активации на короткое время до заземления. |  |
|  | **STEP 1N.** Проверить прелюбрикационный полный сигнальный провод на короткое время до заземления. |  |
...
#### ШАГ 1A. Проверьте кнопку остановки двигателя для взаимодействия.

| **Условия:** Проверьте кнопку остановки двигателя в передней части окна интерфейса клиента. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Убедитесь, что кнопка остановки двигателя полностью отключена. Кнопка остановки двигателя 1/16-й поворот по часовой стрелке. Кнопка остановки двигателя будет издавать звуковой шум при его отключении. Кнопка остановки двигателя не повернется, если она отключится. | Кнопка остановки двигателя включена? **Ремонт:** Кнопка остановки двигателя 1/16-й поворот **по часовой стрелке** для отключения. | Ремонт завершён |
| Кнопка остановки двигателя включена? **НЕТ** | 1В |  |

#### ШАГ 1B. Проверьте логическое устройство клиентского интерфейса LED подсветка.

| **Условия:** Откройте окно интерфейса клиента. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
| Проверьте лампу с коленчатым приводом на блоке DCU 410 или удаленной панели для освещения. | Светильник с кривошипом? *Да | 1С |
| Светильник с кривошипом? **НЕТ** | Свяжитесь с авторизованным местом ремонта Cummins® |  |

#### ШАГ 1C. Проверьте провод питания DCU410 на напряжение +24-VDC.
...
| Меньше +24-VDC? **НЕТ** | 1D |  |

#### ШАГ 1D. Проверьте провод дистанционного запуска для открытия.
...
#### ШАГ 1F. Проверьте провод сигнала прелюбрикационной активации на наличие открытого.
...
#### ШАГ 1G. Проверьте прелюбрикационный полный сигнальный провод на наличие открытого.

| **Условия:** Откройте окно интерфейса клиента. Отсоедините провод с прелюбрикацией полного сигнала на блоке DCU410 и блоке CLU. Отключите разъем C1. |  |  |
|---|---|---|
| **Действие** | **Спецификация/ремонт** | **Следующий шаг** |
...
#### ШАГ 1H. Проверьте провод дистанционного запуска для короткого провода.
...
#### ШАГ 1I. Проверьте сигнальный провод переключателя реле стартера для короткого провода к проводу.
...
#### ШАГ 1J. Проверьте сигнал прелюбрикации для короткого провода к проводу.
...
#### ШАГ 1K. Проверьте прелюбрикационный полный сигнальный провод для короткого провода к проводу.
...
#### ШАГ 1L. Проверьте провод дистанционного пуска для короткого приземления.
...
#### ШАГ 1M. Проверьте сигнал прелюбрикационной активации на короткое время до земли.
...
#### ШАГ 1N. Проверьте прелюбрикационный полный сигнальный провод на короткое время до земли.
