---
aliases:
  - "Двигатель не останавливается при активном судовом сигнале останова 2"
type: "Процедура"
doc: "116-t02-1077"
title_en: "Engine Does Not Shut Down When Vessel Shutdown 2 Signal Active on Shutdown Unit"
title_ru: "Двигатель не останавливается при активном судовом сигнале останова 2"
modified: "2008-03-20"
engines:
  - "41349633"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1077.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1077.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
# Engine Does Not Shut Down When Vessel Shutdown 2 Signal Active on Shutdown Unit
**Двигатель не останавливается при активном судовом сигнале останова 2**

> [!abstract] Процедура · `116-t02-1077`
> **Двигатели:** [[41349633 — QSK19 CM2150 MCRS CPL 3666|41349633]]
> **Семейство:** QSK19
> **Входит в руководства:** [[4021617 — C Command Elite and C Command Elite Plus Panel System Marine Master Repair Manual|4021617]]
> **Секции:** Section TT - Troubleshooting Symptoms (New Format)
> **Даты:** изменён 2008-03-20
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1077.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1077.pdf)
...
- SDU410 не отключает двигатель с сигналом 2, активным при подключении OEM X6.
...
|  | **STEP 2A.** Проверить сигнал 2 и возврат проводов на наличие открытого соединения X6. | Менее 10 Ом? |
...
#### ШАГ 2A. Проверьте сигнал 2 и верните провода для открытия соединения X6.

| **Условия: ** Откройте окно интерфейса клиента Отключите сигнал 2 и верните провода на OEM X6 соединение. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте сигнал 2 и верните провода для открытия соединения X6. Поместите один испытательный щуп на сигнальный провод 2 в разъем X6. Поместите другой испытательный щуп на сигнальный провод 2 сигнала в OEM-соединение. Поместите один испытательный щуп на провод возврата сигнала 2 на разъем X6. Поместите другой испытательный щуп на провод возврата сигнала 2 в OEM-соединение. См. соответствующую схему или схему проводов для идентификации соединительного штифта. | Менее 10 Ом? *Да** | Ремонт завершён |
...
> ### Symptoms
>
> - The SDU410 does **not** shut down the engine with signal 2 active at OEM X6 connection.
>
...
> |  | **STEP 2A.** Check the signal 2 signal and return wires for an open at the X6 connection. | Less than 10 ohms? |
>
> ### STEP 1. Check customer interface box
>
...
> ### STEP 2. Check customer interface box wiring
>
> #### STEP 2A. Check the signal 2 signal and return wires for an open at the X6 connection.
>
> | **Conditions:** Open the customer interface box Disconnect the signal 2 signal and return wires on the OEM X6 connection. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the signal 2 signal and return wires for an open at the X6 connection. Place one test lead on the signal 2 signal wire at the X6 connector. Place the other test lead on the signal 2 signal wire at the OEM connection. Place one test lead on the signal 2 return wire at the X6 connector. Place the other test lead on the signal 2 return wire at the OEM connection. Refer to the appropriate circuit diagram or wiring diagram for connection pin identification. | Less than 10 ohms? **YES** | Repair complete |
