---
aliases:
  - "Двигатель не останавливается при высокой температуре ОЖ"
type: "Процедура"
doc: "116-t02-1074"
title_en: "Engine Does Not Shut Down with High Coolant Temperature"
title_ru: "Двигатель не останавливается при высокой температуре ОЖ"
modified: "2008-03-20"
engines:
  - "41349633"
families:
...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1074.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1074.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSK19"
  - "группа/116"
...
# Engine Does Not Shut Down with High Coolant Temperature
**Двигатель не останавливается при высокой температуре ОЖ**

> [!abstract] Процедура · `116-t02-1074`
> **Двигатели:** [[41349633 — QSK19 CM2150 MCRS CPL 3666|41349633]]
> **Семейство:** QSK19
> **Входит в руководства:** [[4021617 — C Command Elite and C Command Elite Plus Panel System Marine Master Repair Manual|4021617]]
> **Секции:** Section TT - Troubleshooting Symptoms (New Format)
> **Даты:** изменён 2008-03-20
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/116/116-t02-1074.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/claude/cummins-parts-knowledge-base-qa0n50/bulletins/procedures/116-t02-1074.pdf)
...
- SDU410 не будет выключать двигатель, если существует высокая температура охлаждающей жидкости.
...
|  | **STEP 2A.** Проверить температурный сигнал охлаждающей жидкости и провода возврата для открытого. | Менее 10 Ом? |
| ШАГ 3. | Проверьте OEM проводку жгут |  |
|  | **STEP 3A.** Проверить температурный сигнал охлаждающей жидкости и провода возврата для открытого. | Менее 10 Ом? |
...
#### ШАГ 2A. Проверьте температурный сигнал охлаждающей жидкости и верните провода для открытого.

| **Условия: ** Откройте окно клиентского интерфейса Отключить окно клиентского интерфейса к OEM проводах упряжки кабельного разъема C4 от окна клиентского интерфейса. Отключите OEM-проводку ремня 23-контактного разъема C2 от окна интерфейса клиента. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
...
#### ШАГ 3A. Проверьте температурный сигнал охлаждающей жидкости и верните провода для открытого.

| **Условия: ** Откройте окно интерфейса клиента. Отсоедините окно интерфейса клиента к OEM-проводах, подключите кабельный разъем C4 от окна интерфейса клиента. Отсоедините разъем OEM-проводов на разъеме OEM на двигателе. |  |  |
|---|---|---|
| **Действие** | ** Спецификация/ремонт** | ** Следующий шаг** |
| Проверьте сигнальный провод температуры охлаждающей жидкости на наличие открытого. Поместите один испытательный щуп на провод сигнала температуры охлаждающей жидкости на разъеме C4. Поместите другой испытательный щуп на провод сигнала температуры охлаждающей жидкости на разъеме C11. Поместите один испытательный щуп на провод возврата температуры охлаждающей жидкости на разъеме C4. Поместите другой испытательный щуп на провод возврата температуры охлаждающей жидкости на разъеме C11. См. соответствующую схему или схему проводов для идентификации соединительного штифта. | Менее 10 Ом? *Да** | Ремонт завершён |
...
> ### Symptoms
>
> - The SDU410 will **not** shut down the engine if high coolant temperature exists.
>
...
> |  | **STEP 2A.** Check coolant temperature signal and return wires for an open. | Less than 10 ohms? |
> | STEP 3. | Check the OEM wiring harness |  |
> |  | **STEP 3A.** Check coolant temperature signal and return wires for an open. | Less than 10 ohms? |
>
> ### STEP 1. Check customer interface box
>
...
> ### STEP 2. Check customer interface box wiring
>
> #### STEP 2A. Check the coolant temperature signal and return wires for an open.
>
> | **Conditions:** Open the customer interface box Disconnect customer interface box to OEM harness cable connector C4 from the customer interface box. Disconnect OEM harness 23-pin C2 connector from the customer interface box. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
...
> ### STEP 3. Check the OEM wiring harness
>
> #### STEP 3A. Check the coolant temperature signal and return wires for an open.
>
> | **Conditions:** Open the customer interface box. Disconnect customer interface box to OEM harness cable connector C4 from the customer interface box. Disconnect the OEM harness connector at the OEM connector on engine. |  |  |
> |---|---|---|
> | **Action** | **Specification/Repair** | **Next Step** |
> | Check the coolant temperature signal wire for an open. Place one test lead on the coolant temperature signal wire at the C4 connector. Place the other test lead on the coolant temperature signal wire at the C11 connector. Place one test lead on the coolant temperature return wire at the C4 connector. Place the other test lead on the coolant temperature return wire at the C11 connector. Refer to the appropriate circuit diagram or wiring diagram for connection pin identification. | Less than 10 ohms? **YES** | Repair complete |
