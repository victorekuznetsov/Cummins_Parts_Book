...
|  | **STEP 1C.** Проверить источник подачи аналогового входного сигнала датчика судна и провода аналогового сигнала 4 датчика судна на короткое расстояние от провода к проводу. |  |
