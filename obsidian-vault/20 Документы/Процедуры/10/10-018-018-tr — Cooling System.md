...
source: "https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/10/10-018-018-tr.html"
pdf: "https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/10-018-018-tr.pdf"
tags:
  - "документ/процедура"
  - "двигатель/QSX15"
  - "группа/10"
...
> [!abstract] Процедура · `10-018-018-tr`
...
> **Даты:** изменён 2011-10-13
> **Источник:** [QuickServe](https://quickserve.cummins.com/qs3/pubsys2/xml/en/procedures/10/10-018-018-tr.html) · [PDF-оригинал](https://github.com/victorekuznetsov/Cummins_Parts_Book/raw/main/bulletins/procedures/10-018-018-tr.pdf)
...
| ISX CM871 (с EGR) | 434 кПа[63psi] |
|---|---|

| ISX CM870 (с EGR) | 400 кПа[38 psi] |
|---|---|

| ISX без EGR (без EGR) | 227 кПа[33 psi] |
|---|---|
...
| С EGR | 103 кПа[15 psi] |
|---|---|

| Без ЭКГ | 50 кПа[7 psi] |
|---|---|
...
| Только двигатель | 24 литра[25 квт] |
|---|---|
...
| Все рейтинги | 227 кПа[33 psi] |
|---|---|

#### Температура активации охлаждающей сигнализации

| Рейтинг ниже 565 лошадиных сил | 107°C[225°F] |
|---|---|

| Рейтинги 565/600 лошадиных сил | 110°C[230°F] |
|---|---|
...
| Электроэнергетика, резерв | 110°C[230°F] |
|---|---|

| Электроэнергетика, Prime | 104 °C[220°F] |
|---|---|
...
| Минимально допустимый скачок | 2,4 литра [2,5 квт] или 10% емкости системы (в зависимости от того, что больше) |
|---|---|

#### Минимальный рекомендуемый предел давления радиатора

| промышленный | 103 кПа[15 psi] |
|---|---|

| Генерация электроэнергии | 69 кПа[10 psi] |
|---|---|
...
| температура | 95°C[203°F] |
|---|---|

#### Температура воздуха вентилятора - только для промышленных целей

| температура | 88°C[190°F] |
|---|---|

#### Температура открытия затвора - только промышленное исполнение

| охлаждающий | 85°C[185°F] |
|---|---|

| принимать | 60°C[140°F] |
|---|---|
...
>
> | ISX CM871 (with EGR) | 434 kPa \[63psi\] |
> |---|---|
>
> | ISX CM870 (with EGR) | 400 kPa \[38 psi\] |
> |---|---|
>
> | ISX Without EGR (without EGR) | 227 kPa \[33 psi\] |
> |---|---|
>
...
> |---|---|
>
> #### Fan-on Intake Air Temperature - Industrial Only
>
