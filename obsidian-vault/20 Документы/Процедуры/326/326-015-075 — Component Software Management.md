...
Для получения обновлений программного обеспечения, пожалуйста, свяжитесь с авторизованным местом ремонта Cummins®.
...
Файлы программного обеспечения Cummins® Marine Controls загружаются с помощью набора инструментов загрузки программного обеспечения компонентов. Используйте следующую процедуру для более подробной информации о процессе загрузки и инструмента.[[326-015-074 — Component Software Download Tool|См. процедуру 015-074 в разделе 15.]]

Обновления прошивки для морской панели - веб-страница Cummins® Inboard Joystick (https://quickserve.cummins.com/qs3/qsol/service/marine/mpf\_joystick.html) содержит лист отслеживания программного обеспечения и файлы программного обеспечения.
...
Обновления прошивки морской панели - веб-страница Cummins® Inboard Joystick содержит файлы и таблицу отслеживания с информацией о каждом файле, которая помогает выбрать правильный уровень файла и уровня редактирования для компонента. Ссылка на папку имени компонента для необходимого файла.

> [!note] Примечание
> Группа Cummins® Marine Application Engineering отправляет электронное письмо на адрес joystick@cummins.com для обновления веб-страницы Cummins® Inboard Joystick с именем файла, версией и описанием компонента, для которого она предназначена.

Формат имени файла программного обеспечения: «AAA-xxx.pj2»

Где:

AAA = название продукта

- JST - бортовой джойстик
- CH2 = станция управления рычагом, две кнопки
- CH4 - станция управления рычагом, четыре кнопки
- TIM - модуль с жестким интерфейсом
- CP3 - модуль процессора управления дроссельной заслонки, EEC3
- CP4 - модуль процессора управления дроссельной заслонки, EEC4
...
«.pj2» — расширение файла программного обеспечения

После загрузки программного обеспечения Inboard Joystick, Lever Control Station или Throttle Control Processor Module используйте следующую процедуру для получения информации о настройке и конфигурации компонентов.[[326-015-054 — Vessel Configuration|См. процедуру 015-054 в разделе 15.]]

После загрузки программного обеспечения Inboard Joystick необходимо будет подтвердить, что личность судна работает правильно и является подходящей личностью для приложения. Используйте следующую процедуру для получения информации об управлении персоналом судна.[[326-015-044 — Managing Vessel Personalities|См. процедуру 015-044 в разделе 15.]]

Все функции управления Cummins® Marine Controls должны быть протестированы перед выходом из дока после служебного мероприятия. См. процедуру 015-046 в разделе 15.

После загрузки файла программного обеспечения, если есть новый код тревоги или жалоба на производительность, следуйте коду тревоги или соответствующему дереву симптомов устранения неполадок, чтобы понять, работает ли программное обеспечение должным образом.

Если есть подозрение, что файл личности программного обеспечения или сосуда работает неправильно, убедитесь, что соответствующий файл был загружен для двигателя, оборудования и приложения.

> [!note] Примечание
> Таблица личных файлов в обновлении микропрограммной программы Marine Panel - Cummins® Inboard Joystick предоставляет информацию, касающуюся изменений, внесенных в файл программного обеспечения. Эта информация может быть использована для установления, существует ли общность между изменениями, внесенными в программное обеспечение, и наблюдаемыми симптомами.
