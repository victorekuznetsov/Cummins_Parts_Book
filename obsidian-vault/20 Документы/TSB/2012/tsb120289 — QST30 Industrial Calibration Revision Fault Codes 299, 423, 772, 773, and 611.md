...
## QST30 Промышленная калибровка: Коды ошибок 299, 423, 772, 773 и 611
...
Код 423 неисправности вызван неправильными статическими временными характеристиками насоса, засоренными топливными фильтрами или входным экраном, застрявшими рукавами синхронизации, воздухом в топливных линиях или ошибками калибровки. Логика была пересмотрена, чтобы сделать код ошибки более надежным для сигнального шума.

Коды 299 и 611 были добавлены к этим калибровкам. Код 299 неисправности предназначен для горячего выключения выключателя, которое происходит, когда двигатель выключен без выключателя зажигания, когда двигатель не успел должным образом остыть. Код 611 неисправности запустится, когда двигатель будет выключен, не позволяя нормально остыть.

Двигатели, построенные 19 ноября 2012 года, имеют обновленную 5.1.0.5 фазу калибровки.

Новые калибровки были установлены в серийных двигателях, построенных 19 ноября 2012 года.

| Таблица 1: Предыдущие и пересмотренные калибровки |  |
|---|---|
