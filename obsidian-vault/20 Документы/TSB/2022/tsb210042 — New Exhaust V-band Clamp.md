---
aliases:
  - "Новый V-образный хомут выпускной системы"
type: "TSB"
doc: "tsb210042"
title_en: "New Exhaust V-band Clamp"
title_ru: "Новый V-образный хомут выпускной системы"
released: "2022-04-06"
modified: "2022-04-06"
...
- Доступен альтернативный зажим V-диапазона, который использует болт большего диаметра и улучшенный материал болта.
- Новый зажимный болт V-диапазона использует материал A286 по сравнению с 410SS в существующей конструкции, который менее подвержен коррозии и растрескиванию при повышенных нагрузках.

**Причина изменения**

V-диапазонные болты разрываются, что приводит к утечкам выхлопных газов.
...
| Выхлоп V-диапазона Clamp | 3089765 | Нет | Да | [[4936174]] |

**Идентификация детали**

Альтернативный зажим V-диапазона имеет больший вырез в ремешке, как показано, и имеет другой номер детали, проштампованный на ремешке.

![[17r00828.png]]

Рисунок 1 - Новый и старый V-диапазонный зажим.
...
| 33223962 | 5 февраля 2021 | Давентри |
| 85012063 | 22 марта 2022 | CPG Индия |
...
| Руководство по обслуживанию | QSK60 CM2350 K121 | 4388645 | См. процедуру 011-007 | 11 |
| Руководство по обслуживанию | QSK60 CM2350 K135 | 5504626 | См. процедуру 011-007 | 11 |
| Руководство по обслуживанию | QSK60 CM2350 K136 | 5504631 | См. процедуру 011-007 | 11 |
...
>
> - An alternative V-band clamp is available which utilizes a larger diameter bolt and improved bolt material.
> - The new V-band clamp bolt uses A286 material compared to 410SS in the existing design which is less susceptible to corrosion and cracking under increased loads.
>
> **Reason for Change**
>
> V-band bolts have been fracturing, leading to exhaust leaks.
>
...
> **Part Identification**
>
> The alternate V-band clamp has a larger cut out in the strap as shown and has a different part number stamped on the strap.
>
> Figure 1, New and Old V-band Clamp.
>
> **Production Status**
>
...
> | 33223962 | 5 February 2021 | Daventry |
> | 85012063 | 22 March 2022 | CPG India |
>
...
> | Service Manual | QSK60 CM2350 K121 | 4388645 | Refer to Procedure 011-007 | 11 |
> | Service Manual | QSK60 CM2350 K135 | 5504626 | Refer to Procedure 011-007 | 11 |
> | Service Manual | QSK60 CM2350 K136 | 5504631 | Refer to Procedure 011-007 | 11 |
>
> ### Document History
