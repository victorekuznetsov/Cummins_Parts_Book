...
1. Откалиброванный ECM будет требовать другой адрес источника SAE J1939, как описано в руководствах по обслуживанию. Например, первичная ECM-система от многомодуля (переключается на «PRIM» на прикрепленной многомодулевой проводах) обычно утверждает адрес источника SAE J1939 00. В сети CEN с той же настройкой заявленный исходный адрес SAE J1939 равен 01 (что одинаково для вторичной ECM в общедоступной сети J1939).
