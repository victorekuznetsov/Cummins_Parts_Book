...
type: "TSB"
doc: "tsb070020"
title_en: "Piston Skirt Scuffing"
title_ru: "Задиры юбки поршня"
released: "2020-03-02"
modified: "2020-03-02"
...
Цель этого раннего уведомления о месторождении состоит в том, чтобы сообщить полю, что двигатели QST30 и QSK23,45,60,78 с поршнями Ferrite Cast Iron Ductile (FCD) подвержены поршневой юбке при запуске после длительных периодов остановки в очень холодных условиях окружающей среды. Данные полевых исследований показывают, что двигатель наиболее уязвим при запуске с температурой масла и охлаждающей жидкости ниже −12 ° C \[10 ° F \].

### Подтверждение

Двигатели QST30, QSK23, QSK45, QSK60 и QSK78
...
Для уменьшения потенциала поршневой помойки рекомендуется предварительно прогреть охлаждающую жидкость и масло до температуры −4°C[25°F].

Дистрибьюторы Cummins® должны работать со своими конечными клиентами и / или OEM-дилерами для поддержки этой меры.
