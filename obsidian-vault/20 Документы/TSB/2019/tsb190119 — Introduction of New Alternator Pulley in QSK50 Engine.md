---
aliases:
  - "Новый шкив генератора на двигателе QSK50"
type: "TSB"
doc: "tsb190119"
title_en: "Introduction of New Alternator Pulley in QSK50 Engine"
title_ru: "Новый шкив генератора на двигателе QSK50"
released: "2019-07-09"
modified: "2019-07-26"
...
В этом документе объявлено о введении нового шкива генератора переменного тока в модель двигателя QSK50 CM2150 MCRS.

**Причина изменения**

­

Было замечено, что шкив прижимался к валу и влиял на перемещение шпонки древесного дерева, что вызвало отказ генератора переменного тока.
...
> **Product Affected**
>
> - QSK50 CM2150 MCRS **(Industrial Only)Description of Change**
>
> ­
>
> This document announces an introduction of new alternator pulley in QSK50 CM2150 MCRS engine model.
>
> **Reason for Change**
>
> ­
>
> It was observed that the pulley was press fitted on the shaft and affected the key movement, which caused charging alternator failure.
>
...
> **Part Compatibility**
>
> This part cannot be mixed within the same engine because of modification done and this part is compatible as per Table 1 **only**.
>
> **Part Structure**
>
> The old part number should be replaced with the new part number.
>
> **Part Inventory Action**
>
> The old part numbers in stock should **not** be used.
>
> **Production Status**
>
...
> |---|---|---|
> | **Engine Seriel Number (ESN) First** | **Build Date\*** | **Plant** |
> | 25443943 | 22 February, 2019 | KCL, Cummins India LTD. |
