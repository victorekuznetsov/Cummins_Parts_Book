---
aliases:
  - "Новая крышка центрифуги, узел и фильтр для масляных фильтров Eliminator™"
type: "TSB"
doc: "tsb160036"
title_en: "New Centrifuge Cover, Eliminator™ Assembly, and Centrifugal Filter for Eliminator™ Oil Filters"
title_ru: "Новая крышка центрифуги, узел и фильтр для масляных фильтров Eliminator™"
released: "2017-05-05"
modified: "2020-02-10"
...
- QSK60 CM850 MCRS
- QSK60 G CM2358 K110
- QSK60 G Природный газ
- QSK78 Строительный МС500
- QSK78 Locomotive CM500

Природный газ - с системой природного газа

**Описание изменения**

Для системы фильтров EliminatorTM введен новый центробежный фильтр. Допуск к литью нового крышки центрифуги был скорректирован, и был введен новый полный номер сборочной части EliminatorTM, чтобы отразить эти изменения.

**Причина изменения**

Новый центробежный фильтр предотвратит более низкие сбои в втулке. Центрифужная крышка была изменена, чтобы позволить использовать новый центрифужный фильтр без контакта с центрифужной крышкой во время работы двигателя.
...
Рисунок 1 Доказательства контакта между крышкой центрифуги и фильтром центрифуги.
...
Новая крышка может быть идентифицирована по букве «V» на стороне корпуса. См. рисунок 2.

![[07r00081.png]]

Рисунок 2, Идентификационный знак на корпусе центрифуги.

**Статус в производстве**

| Таблица 2, Информация о производстве |  |  |  |
|---|---|---|---|
| Продукт | Серийный номер двигателя (ESN) | Постройте дату 1 | Машинный завод |
| QSK60 | 33207365 | 06 мая 2016 г. | Давентрийский моторный завод |
...
> - QSK60 G CM2358 K110
> - QSK60 G Natural Gas
> - QSK78 Construction CM500
> - QSK78 Locomotive CM500
>
> Natural Gas – with Natural Gas Fuel System
>
> **Description of Change**
>
> A new centrifugal filter has been introduced for the Eliminator™ filter system. The casting tolerance of the new centrifuge cover has been adjusted and a new complete Eliminator™ assembly part number has been introduced to reflect these changes.
>
> **Reason for Change**
>
> The new centrifugal filter will prevent lower bushing malfunctions. The centrifuge cover has been changed to allow the new centrifuge filter to be used without contacting the centrifuge cover during engine operation.
>
...
> **Part Compatibility**
>
> The new part numbers are backwards compatible and can be mixed with existing part numbers.
>
> **Note · Примечание**
...
> **Recommendation**
>
> Replace the centrifuge every 1000 hours with at least one inspection interval after 500 hours to assess bush wear if present.
>
> **Part Identification**
>
> The new cover can be identified by ‘V' on the side of the housing. See Figure 2.
>
> Figure 2, Identification Mark on Centrifuge Housing.
>
> **Production Status**
>
> | Table 2, Production Information |  |  |  |
> |---|---|---|---|
> | Product | Engine Serial Number (ESN) First | Build Date 1 | Engine Plant |
> | QSK60 | 33207365 | 06 May 2016 | Daventry Engine Plant |
