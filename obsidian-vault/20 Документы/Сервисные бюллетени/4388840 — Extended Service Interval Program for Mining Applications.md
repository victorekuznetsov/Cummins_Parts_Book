...
Для двигателей с модульной общей системой рельсового топлива (MCRS) (кроме CM2350) модернизируйте фильтрацию стадии 1 до топливных фильтров IndustrialPro. Справочные инструкции по установке, включенные в коробку с фильтрами.
...
| Радиальная уплотнение | первичный | AF27698 | AF25149NF + SP1307 Обслуживание* |
...
| Таблица 16, Пределы параметров анализа масла |  |
|---|---|
