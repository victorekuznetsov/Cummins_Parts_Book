...
Данный сервисный бюллетень является дополнением к сервисному бюллетеню 4022060 «Техника анализа масла для дизельных двигателей большой мощности». В нем содержатся дополнительные рекомендации по анализу результатов анализа проб масла, полученных с использованием методов, описанных в Service Bulletin 4022060 для двигателей QSK45, QSK60 и QSK78.

Процедуры исследования и эксплуатации, рекомендованные в этой процедуре, должны проводиться в соответствии с методами анализа масла для сбора образца масла, установления пределов флага анализа масла, а также для выявления и принятия соответствующих корректирующих действий; на основе результатов анализа масла, изложенных в служебном бюллетене 4022060.
...
## Руководство по анализу результатов анализа образцов масла
...
Все данные о свинце в течение всего срока службы подшипников должны использоваться для третьего квартильного расчета.
...
|---|---|---|---|
| Третий квартиль для ppm свинца в анализе масла | указание | Меры | Комментарий |
...
|---|---|---|---|
| **Третий квартиль для ppm свинца в масляном анализе** | **Указание** | **Действие** | **Комментарий** |
...
В связи с обнаружением неисправностей в приведенных ниже районах следует провести исследование, поскольку содержание свинца в таблице, озаглавленной «Уровень свинцовых частей на миллион (УПП), превышает критический предел, установленный на основе результатов масляных лабораторий или компании Cummins Inc. "в следующем служебном бюллетене". См. Методы анализа масла для дизельных двигателей высокой мощности, бюллетень службы[[4022060 — Oil Analysis Techniques for High Horsepower Diesel Engines|4022060]].
...
|  | Убедитесь, что Centinel работает правильно. | Проверяйте, добавляйте записи о масла и проверяйте, что добавленная масло составляет 0,3% сгоревшего топлива. |
...
|  | Подтвердить спецификацию масла отвечает Cummins Inc. Рекомендации. | Ссылка на рекомендации по анализу моторного масла и масла Cummins®, бюллетень службы[[3810340 — Cummins® Engine Oil and Oil Analysis Recommendations\|3810340]]. |
